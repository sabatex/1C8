...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class КадровыйПереводПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.КадровыйПеревод ВладелецФайла {get; set;}
        ...
        public List<КадровыйПереводПрисоединенныеФайлы_ЭлектронныеПодписи> КадровыйПереводПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<КадровыйПереводПрисоединенныеФайлы_СертификатыШифрования> КадровыйПереводПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("KadrovyiPerevodPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class КадровыйПереводПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("KadrovyiPerevodPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class КадровыйПереводПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
