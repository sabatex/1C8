...
namespace sabatex.V1C8.AccountingUkrCorp.PostgreSQLDbContext
{
    public class V1C8DbContext:DbContext
    {
        ...
        public DbSet<Models.Catalogs.АвансовыйОтчет> АвансовыйОтчет { get; set; }
        public DbSet<Models.Catalogs.АвансовыйОтчет_ВыданныеАвансы> АвансовыйОтчет_ВыданныеАвансы { get; set; }
        public DbSet<Models.Catalogs.АвансовыйОтчет_Товары> АвансовыйОтчет_Товары { get; set; }
        public DbSet<Models.Catalogs.АвансовыйОтчет_ВозвратнаяТара> АвансовыйОтчет_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.АвансовыйОтчет_ОплатаПоставщикам> АвансовыйОтчет_ОплатаПоставщикам { get; set; }
        public DbSet<Models.Catalogs.АвансовыйОтчет_Прочее> АвансовыйОтчет_Прочее { get; set; }
        public DbSet<Models.Catalogs.АктОбОказанииПроизводственныхУслуг> АктОбОказанииПроизводственныхУслуг { get; set; }
        public DbSet<Models.Catalogs.АктОбОказанииПроизводственныхУслуг_Услуги> АктОбОказанииПроизводственныхУслуг_Услуги { get; set; }
        public DbSet<Models.Catalogs.АктПриемкиВыполненныхРаботОказанныхУслуг> АктПриемкиВыполненныхРаботОказанныхУслуг { get; set; }
        public DbSet<Models.Catalogs.АктПриемкиВыполненныхРаботОказанныхУслуг_ДополнительныеРеквизиты> АктПриемкиВыполненныхРаботОказанныхУслуг_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.АктПроверкиСтраховыхВзносов> АктПроверкиСтраховыхВзносов { get; set; }
        public DbSet<Models.Catalogs.АктПроверкиСтраховыхВзносов_ВзносыФОТ> АктПроверкиСтраховыхВзносов_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.АктПроверкиСтраховыхВзносов_ФизическиеЛица> АктПроверкиСтраховыхВзносов_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.АктПроверкиСтраховыхВзносов_Взносы> АктПроверкиСтраховыхВзносов_Взносы { get; set; }
        public DbSet<Models.Catalogs.АктСверкиВзаиморасчетов> АктСверкиВзаиморасчетов { get; set; }
        public DbSet<Models.Catalogs.АктСверкиВзаиморасчетов_ПоДаннымОрганизации> АктСверкиВзаиморасчетов_ПоДаннымОрганизации { get; set; }
        public DbSet<Models.Catalogs.АктСверкиВзаиморасчетов_ПоДаннымКонтрагента> АктСверкиВзаиморасчетов_ПоДаннымКонтрагента { get; set; }
        public DbSet<Models.Catalogs.АктСверкиВзаиморасчетов_СписокСчетов> АктСверкиВзаиморасчетов_СписокСчетов { get; set; }
        public DbSet<Models.Catalogs.АттестацияРабочихМестДляУчетаСпецстажа> АттестацияРабочихМестДляУчетаСпецстажа { get; set; }
        public DbSet<Models.Catalogs.АттестацияРабочихМестДляУчетаСпецстажа_ШтатныеЕдиницы> АттестацияРабочихМестДляУчетаСпецстажа_ШтатныеЕдиницы { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист> БольничныйЛист { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_Начисления> БольничныйЛист_Начисления { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_НачисленияПерерасчет> БольничныйЛист_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_НДФЛ> БольничныйЛист_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_ОтработанноеВремяДляСреднегоФСС> БольничныйЛист_ОтработанноеВремяДляСреднегоФСС { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_ПогашениеЗаймов> БольничныйЛист_ПогашениеЗаймов { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_Показатели> БольничныйЛист_Показатели { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_РаспределениеРезультатовНачислений> БольничныйЛист_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_РаспределениеРезультатовУдержаний> БольничныйЛист_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_СреднийЗаработокДанныеСтрахователей> БольничныйЛист_СреднийЗаработокДанныеСтрахователей { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_СреднийЗаработокФСС> БольничныйЛист_СреднийЗаработокФСС { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_Удержания> БольничныйЛист_Удержания { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_РаспределениеПоТерриториямУсловиямТруда> БольничныйЛист_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_ПериодыБолезниУходаЗаДетьми> БольничныйЛист_ПериодыБолезниУходаЗаДетьми { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_ДенежноеСодержание> БольничныйЛист_ДенежноеСодержание { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_ДенежноеСодержаниеФактическиеНачисления> БольничныйЛист_ДенежноеСодержаниеФактическиеНачисления { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_ДополнительныеРеквизиты> БольничныйЛист_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_ВзносыФОТ> БольничныйЛист_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.БольничныйЛист_Взносы> БольничныйЛист_Взносы { get; set; }
        public DbSet<Models.Catalogs.БронированиеГражданПребывающихВЗапасе> БронированиеГражданПребывающихВЗапасе { get; set; }
        public DbSet<Models.Catalogs.БронированиеГражданПребывающихВЗапасе_Сотрудники> БронированиеГражданПребывающихВЗапасе_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ВводВЭксплуатациюОС> ВводВЭксплуатациюОС { get; set; }
        public DbSet<Models.Catalogs.ВводВЭксплуатациюОС_ОС> ВводВЭксплуатациюОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатков> ВводНачальныхОстатков { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатков_ОС> ВводНачальныхОстатков_ОС { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатков_ЗапасыВсе> ВводНачальныхОстатков_ЗапасыВсе { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатков_МалоценныеАктивы> ВводНачальныхОстатков_МалоценныеАктивы { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатков_НМА> ВводНачальныхОстатков_НМА { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатков_РасчетыСКонтрагентами> ВводНачальныхОстатков_РасчетыСКонтрагентами { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатков_РасчетыПоЗаработнойПлате> ВводНачальныхОстатков_РасчетыПоЗаработнойПлате { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатков_БухСправка> ВводНачальныхОстатков_БухСправка { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатков_РасходыБудущихПериодов> ВводНачальныхОстатков_РасходыБудущихПериодов { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатков_ТоварыПоПродажнойЦене> ВводНачальныхОстатков_ТоварыПоПродажнойЦене { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатков_Затраты> ВводНачальныхОстатков_Затраты { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатковОтпусков> ВводНачальныхОстатковОтпусков { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатковОтпусков_ЕжегодныеОтпуска> ВводНачальныхОстатковОтпусков_ЕжегодныеОтпуска { get; set; }
        public DbSet<Models.Catalogs.ВводНачальныхОстатковОтпусков_ОстаткиОтпусковПоРабочимГодам> ВводНачальныхОстатковОтпусков_ОстаткиОтпусковПоРабочимГодам { get; set; }
        public DbSet<Models.Catalogs.ВводСведенийДляРасчетаСтраховогоСтажа> ВводСведенийДляРасчетаСтраховогоСтажа { get; set; }
        public DbSet<Models.Catalogs.ВводСведенийДляРасчетаСтраховогоСтажа_СтраховойСтаж> ВводСведенийДляРасчетаСтраховогоСтажа_СтраховойСтаж { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВБанк> ВедомостьНаВыплатуЗарплатыВБанк { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВБанк_Состав> ВедомостьНаВыплатуЗарплатыВБанк_Состав { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВБанк_Зарплата> ВедомостьНаВыплатуЗарплатыВБанк_Зарплата { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВБанк_Основания> ВедомостьНаВыплатуЗарплатыВБанк_Основания { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВБанк_НДФЛ> ВедомостьНаВыплатуЗарплатыВБанк_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВБанк_ФизическиеЛица> ВедомостьНаВыплатуЗарплатыВБанк_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВБанк_ВзносыФОТ> ВедомостьНаВыплатуЗарплатыВБанк_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВКассу> ВедомостьНаВыплатуЗарплатыВКассу { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВКассу_Состав> ВедомостьНаВыплатуЗарплатыВКассу_Состав { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВКассу_Зарплата> ВедомостьНаВыплатуЗарплатыВКассу_Зарплата { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВКассу_Основания> ВедомостьНаВыплатуЗарплатыВКассу_Основания { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВКассу_НДФЛ> ВедомостьНаВыплатуЗарплатыВКассу_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВКассу_ФизическиеЛица> ВедомостьНаВыплатуЗарплатыВКассу_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыВКассу_ВзносыФОТ> ВедомостьНаВыплатуЗарплатыВКассу_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыПеречислением> ВедомостьНаВыплатуЗарплатыПеречислением { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыПеречислением_Состав> ВедомостьНаВыплатуЗарплатыПеречислением_Состав { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыПеречислением_Зарплата> ВедомостьНаВыплатуЗарплатыПеречислением_Зарплата { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыПеречислением_Основания> ВедомостьНаВыплатуЗарплатыПеречислением_Основания { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыПеречислением_НДФЛ> ВедомостьНаВыплатуЗарплатыПеречислением_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыПеречислением_ФизическиеЛица> ВедомостьНаВыплатуЗарплатыПеречислением_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыПеречислением_ВзносыФОТ> ВедомостьНаВыплатуЗарплатыПеречислением_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыРаздатчиком> ВедомостьНаВыплатуЗарплатыРаздатчиком { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыРаздатчиком_Состав> ВедомостьНаВыплатуЗарплатыРаздатчиком_Состав { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыРаздатчиком_Зарплата> ВедомостьНаВыплатуЗарплатыРаздатчиком_Зарплата { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыРаздатчиком_Основания> ВедомостьНаВыплатуЗарплатыРаздатчиком_Основания { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыРаздатчиком_НДФЛ> ВедомостьНаВыплатуЗарплатыРаздатчиком_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыРаздатчиком_ФизическиеЛица> ВедомостьНаВыплатуЗарплатыРаздатчиком_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ВедомостьНаВыплатуЗарплатыРаздатчиком_ВзносыФОТ> ВедомостьНаВыплатуЗарплатыРаздатчиком_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.ВозвратИзОтпускаПоУходуЗаРебенком> ВозвратИзОтпускаПоУходуЗаРебенком { get; set; }
        public DbSet<Models.Catalogs.ВозвратИзОтпускаПоУходуЗаРебенком_Начисления> ВозвратИзОтпускаПоУходуЗаРебенком_Начисления { get; set; }
        public DbSet<Models.Catalogs.ВозвратИзОтпускаПоУходуЗаРебенком_Показатели> ВозвратИзОтпускаПоУходуЗаРебенком_Показатели { get; set; }
        public DbSet<Models.Catalogs.ВозвратИзОтпускаПоУходуЗаРебенком_Авансы> ВозвратИзОтпускаПоУходуЗаРебенком_Авансы { get; set; }
        public DbSet<Models.Catalogs.ВозвратИзОтпускаПоУходуЗаРебенком_ПересчетТарифныхСтавок> ВозвратИзОтпускаПоУходуЗаРебенком_ПересчетТарифныхСтавок { get; set; }
        public DbSet<Models.Catalogs.ВозвратИзОтпускаПоУходуЗаРебенком_Льготы> ВозвратИзОтпускаПоУходуЗаРебенком_Льготы { get; set; }
        public DbSet<Models.Catalogs.ВозвратТоваровОтПокупателя> ВозвратТоваровОтПокупателя { get; set; }
        public DbSet<Models.Catalogs.ВозвратТоваровОтПокупателя_Товары> ВозвратТоваровОтПокупателя_Товары { get; set; }
        public DbSet<Models.Catalogs.ВозвратТоваровОтПокупателя_ВозвратнаяТара> ВозвратТоваровОтПокупателя_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.ВозвратТоваровПоставщику> ВозвратТоваровПоставщику { get; set; }
        public DbSet<Models.Catalogs.ВозвратТоваровПоставщику_Товары> ВозвратТоваровПоставщику_Товары { get; set; }
        public DbSet<Models.Catalogs.ВозвратТоваровПоставщику_ВозвратнаяТара> ВозвратТоваровПоставщику_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.ВходящаяСправкаОЗаработкеДляРасчетаПособий> ВходящаяСправкаОЗаработкеДляРасчетаПособий { get; set; }
        public DbSet<Models.Catalogs.ВходящаяСправкаОЗаработкеДляРасчетаПособий_ДанныеОЗаработке> ВходящаяСправкаОЗаработкеДляРасчетаПособий_ДанныеОЗаработке { get; set; }
        public DbSet<Models.Catalogs.ВходящаяСправкаОРасчетеБольничного> ВходящаяСправкаОРасчетеБольничного { get; set; }
        public DbSet<Models.Catalogs.ВходящаяСправкаОРасчетеБольничного_ДанныеОЗаработке> ВходящаяСправкаОРасчетеБольничного_ДанныеОЗаработке { get; set; }
        public DbSet<Models.Catalogs.ВыгрузкаРегламентированныхОтчетов> ВыгрузкаРегламентированныхОтчетов { get; set; }
        public DbSet<Models.Catalogs.ВыгрузкаРегламентированныхОтчетов_Выгрузки> ВыгрузкаРегламентированныхОтчетов_Выгрузки { get; set; }
        public DbSet<Models.Catalogs.ВыплатаБывшимСотрудникам> ВыплатаБывшимСотрудникам { get; set; }
        public DbSet<Models.Catalogs.ВыплатаБывшимСотрудникам_НачисленияУдержанияВзносы> ВыплатаБывшимСотрудникам_НачисленияУдержанияВзносы { get; set; }
        public DbSet<Models.Catalogs.ВыплатаБывшимСотрудникам_НДФЛ> ВыплатаБывшимСотрудникам_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.ВыплатаБывшимСотрудникам_ВзносыФОТ> ВыплатаБывшимСотрудникам_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.ВыплатаБывшимСотрудникам_Взносы> ВыплатаБывшимСотрудникам_Взносы { get; set; }
        public DbSet<Models.Catalogs.ВыработкаНМА> ВыработкаНМА { get; set; }
        public DbSet<Models.Catalogs.ВыработкаНМА_НМА> ВыработкаНМА_НМА { get; set; }
        public DbSet<Models.Catalogs.ВыработкаОС> ВыработкаОС { get; set; }
        public DbSet<Models.Catalogs.ВыработкаОС_ОС> ВыработкаОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ГрафикОтпусков> ГрафикОтпусков { get; set; }
        public DbSet<Models.Catalogs.ГрафикОтпусков_Сотрудники> ГрафикОтпусков_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ГТДИмпорт> ГТДИмпорт { get; set; }
        public DbSet<Models.Catalogs.ГТДИмпорт_Разделы> ГТДИмпорт_Разделы { get; set; }
        public DbSet<Models.Catalogs.ГТДИмпорт_Оборудование> ГТДИмпорт_Оборудование { get; set; }
        public DbSet<Models.Catalogs.ГТДИмпорт_Товары> ГТДИмпорт_Товары { get; set; }
        public DbSet<Models.Catalogs.ДанныеДляРасчетаЗарплаты> ДанныеДляРасчетаЗарплаты { get; set; }
        public DbSet<Models.Catalogs.ДанныеДляРасчетаЗарплаты_ЗначенияПоказателей> ДанныеДляРасчетаЗарплаты_ЗначенияПоказателей { get; set; }
        public DbSet<Models.Catalogs.ДанныеДляРасчетаЗарплаты_ДанныеОВремениСводно> ДанныеДляРасчетаЗарплаты_ДанныеОВремениСводно { get; set; }
        public DbSet<Models.Catalogs.ДанныеДляРасчетаЗарплаты_ДанныеОВремениДетально> ДанныеДляРасчетаЗарплаты_ДанныеОВремениДетально { get; set; }
        public DbSet<Models.Catalogs.ДанныеДляРасчетаЗарплаты_ВыполненныеРаботы> ДанныеДляРасчетаЗарплаты_ВыполненныеРаботы { get; set; }
        public DbSet<Models.Catalogs.ДанныеДляРасчетаЗарплаты_ФизическиеЛица> ДанныеДляРасчетаЗарплаты_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ДепонированиеЗарплаты> ДепонированиеЗарплаты { get; set; }
        public DbSet<Models.Catalogs.ДепонированиеЗарплаты_Депоненты> ДепонированиеЗарплаты_Депоненты { get; set; }
        public DbSet<Models.Catalogs.Доверенность> Доверенность { get; set; }
        public DbSet<Models.Catalogs.Доверенность_Товары> Доверенность_Товары { get; set; }
        public DbSet<Models.Catalogs.ДоговорАвторскогоЗаказа> ДоговорАвторскогоЗаказа { get; set; }
        public DbSet<Models.Catalogs.ДоговорАвторскогоЗаказа_ДополнительныеРеквизиты> ДоговорАвторскогоЗаказа_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.ДоговорЗаймаСотруднику> ДоговорЗаймаСотруднику { get; set; }
        public DbSet<Models.Catalogs.ДоговорЗаймаСотруднику_ТраншиЗайма> ДоговорЗаймаСотруднику_ТраншиЗайма { get; set; }
        public DbSet<Models.Catalogs.ДоговорРаботыУслуги> ДоговорРаботыУслуги { get; set; }
        public DbSet<Models.Catalogs.ДоговорРаботыУслуги_ДополнительныеРеквизиты> ДоговорРаботыУслуги_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.ДокументРасчетовСКонтрагентом> ДокументРасчетовСКонтрагентом { get; set; }
        public DbSet<Models.Catalogs.ДоходВНатуральнойФорме> ДоходВНатуральнойФорме { get; set; }
        public DbSet<Models.Catalogs.ДоходВНатуральнойФорме_Начисления> ДоходВНатуральнойФорме_Начисления { get; set; }
        public DbSet<Models.Catalogs.ДоходВНатуральнойФорме_ФизическиеЛица> ДоходВНатуральнойФорме_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ДоходВНатуральнойФорме_НачисленияПерерасчет> ДоходВНатуральнойФорме_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.ДоходВНатуральнойФорме_НДФЛ> ДоходВНатуральнойФорме_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.ДоходВНатуральнойФорме_Показатели> ДоходВНатуральнойФорме_Показатели { get; set; }
        public DbSet<Models.Catalogs.ДоходВНатуральнойФорме_РаспределениеРезультатовНачислений> ДоходВНатуральнойФорме_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.ДоходВНатуральнойФорме_РаспределениеРезультатовУдержаний> ДоходВНатуральнойФорме_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.ДоходВНатуральнойФорме_РаспределениеПоТерриториямУсловиямТруда> ДоходВНатуральнойФорме_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.ДоходВНатуральнойФорме_ВзносыФОТ> ДоходВНатуральнойФорме_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.ДоходВНатуральнойФорме_Взносы> ДоходВНатуральнойФорме_Взносы { get; set; }
        public DbSet<Models.Catalogs.ЕдиновременноеПособиеЗаСчетФСС> ЕдиновременноеПособиеЗаСчетФСС { get; set; }
        public DbSet<Models.Catalogs.ЗакрытиеМесяца> ЗакрытиеМесяца { get; set; }
        public DbSet<Models.Catalogs.ЗаявкаНаЗакрытиеЛицевыхСчетовСотрудников> ЗаявкаНаЗакрытиеЛицевыхСчетовСотрудников { get; set; }
        public DbSet<Models.Catalogs.ЗаявкаНаЗакрытиеЛицевыхСчетовСотрудников_Сотрудники> ЗаявкаНаЗакрытиеЛицевыхСчетовСотрудников_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ЗаявкаНаЗакрытиеЛицевыхСчетовСотрудников_ФиксацияИзменений> ЗаявкаНаЗакрытиеЛицевыхСчетовСотрудников_ФиксацияИзменений { get; set; }
        public DbSet<Models.Catalogs.ЗаявкаНаОткрытиеЛицевыхСчетовСотрудников> ЗаявкаНаОткрытиеЛицевыхСчетовСотрудников { get; set; }
        public DbSet<Models.Catalogs.ЗаявкаНаОткрытиеЛицевыхСчетовСотрудников_Сотрудники> ЗаявкаНаОткрытиеЛицевыхСчетовСотрудников_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ЗаявкаНаОткрытиеЛицевыхСчетовСотрудников_ФиксацияИзменений> ЗаявкаНаОткрытиеЛицевыхСчетовСотрудников_ФиксацияИзменений { get; set; }
        public DbSet<Models.Catalogs.ЗаявкаНаПокупкуПродажуВалюты> ЗаявкаНаПокупкуПродажуВалюты { get; set; }
        public DbSet<Models.Catalogs.ЗаявлениеНаПредоставлениеЛьготыПоНДФЛ> ЗаявлениеНаПредоставлениеЛьготыПоНДФЛ { get; set; }
        public DbSet<Models.Catalogs.ЗаявлениеНаПредоставлениеЛьготыПоНДФЛ_ЛьготыНаДетей> ЗаявлениеНаПредоставлениеЛьготыПоНДФЛ_ЛьготыНаДетей { get; set; }
        public DbSet<Models.Catalogs.ЗаявлениеНаПредоставлениеЛьготыПоНДФЛ_ЛичныеЛьготы> ЗаявлениеНаПредоставлениеЛьготыПоНДФЛ_ЛичныеЛьготы { get; set; }
        public DbSet<Models.Catalogs.ЗаявлениеРасчетВФСС> ЗаявлениеРасчетВФСС { get; set; }
        public DbSet<Models.Catalogs.ЗаявлениеРасчетВФСС_Оплаты> ЗаявлениеРасчетВФСС_Оплаты { get; set; }
        public DbSet<Models.Catalogs.ЗаявлениеРасчетВФСС_ФиксацияИзменений> ЗаявлениеРасчетВФСС_ФиксацияИзменений { get; set; }
        public DbSet<Models.Catalogs.ЗаявлениеРасчетВФСС_ФизическиеЛица> ЗаявлениеРасчетВФСС_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ЗаявлениеРасчетВФСС_ПособияНаПогребение> ЗаявлениеРасчетВФСС_ПособияНаПогребение { get; set; }
        public DbSet<Models.Catalogs.ИзменениеАванса> ИзменениеАванса { get; set; }
        public DbSet<Models.Catalogs.ИзменениеАванса_АвансыСотрудников> ИзменениеАванса_АвансыСотрудников { get; set; }
        public DbSet<Models.Catalogs.ИзменениеАванса_ФизическиеЛица> ИзменениеАванса_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ИзменениеГрафикаРаботыСписком> ИзменениеГрафикаРаботыСписком { get; set; }
        public DbSet<Models.Catalogs.ИзменениеГрафикаРаботыСписком_Сотрудники> ИзменениеГрафикаРаботыСписком_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ИзменениеГрафикаРаботыСписком_ФизическиеЛица> ИзменениеГрафикаРаботыСписком_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ИзменениеГрафикаРаботыСписком_НачисленияСотрудников> ИзменениеГрафикаРаботыСписком_НачисленияСотрудников { get; set; }
        public DbSet<Models.Catalogs.ИзменениеГрафикаРаботыСписком_ПересчетТарифныхСтавок> ИзменениеГрафикаРаботыСписком_ПересчетТарифныхСтавок { get; set; }
        public DbSet<Models.Catalogs.ИзменениеГрафиковАмортизацииОС> ИзменениеГрафиковАмортизацииОС { get; set; }
        public DbSet<Models.Catalogs.ИзменениеГрафиковАмортизацииОС_ОС> ИзменениеГрафиковАмортизацииОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ИзменениеКвалификационногоРазряда> ИзменениеКвалификационногоРазряда { get; set; }
        public DbSet<Models.Catalogs.ИзменениеКвалификационногоРазряда_Начисления> ИзменениеКвалификационногоРазряда_Начисления { get; set; }
        public DbSet<Models.Catalogs.ИзменениеМестРаботы> ИзменениеМестРаботы { get; set; }
        public DbSet<Models.Catalogs.ИзменениеМестРаботы_Сотрудники> ИзменениеМестРаботы_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ИзменениеМестРаботы_Начисления> ИзменениеМестРаботы_Начисления { get; set; }
        public DbSet<Models.Catalogs.ИзменениеМестРаботы_Показатели> ИзменениеМестРаботы_Показатели { get; set; }
        public DbSet<Models.Catalogs.ИзменениеНалоговогоНазначенияЗапасов> ИзменениеНалоговогоНазначенияЗапасов { get; set; }
        public DbSet<Models.Catalogs.ИзменениеНалоговогоНазначенияЗапасов_Товары> ИзменениеНалоговогоНазначенияЗапасов_Товары { get; set; }
        public DbSet<Models.Catalogs.ИзменениеНалоговогоНазначенияОС> ИзменениеНалоговогоНазначенияОС { get; set; }
        public DbSet<Models.Catalogs.ИзменениеНалоговогоНазначенияОС_ОС> ИзменениеНалоговогоНазначенияОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ИзменениеНалоговогоНазначенияТЗР> ИзменениеНалоговогоНазначенияТЗР { get; set; }
        public DbSet<Models.Catalogs.ИзменениеНалоговогоНазначенияТЗР_Затраты> ИзменениеНалоговогоНазначенияТЗР_Затраты { get; set; }
        public DbSet<Models.Catalogs.ИзменениеОплатыТруда> ИзменениеОплатыТруда { get; set; }
        public DbSet<Models.Catalogs.ИзменениеОплатыТруда_Начисления> ИзменениеОплатыТруда_Начисления { get; set; }
        public DbSet<Models.Catalogs.ИзменениеОплатыТруда_Показатели> ИзменениеОплатыТруда_Показатели { get; set; }
        public DbSet<Models.Catalogs.ИзменениеПараметровНачисленияАмортизацииНМА> ИзменениеПараметровНачисленияАмортизацииНМА { get; set; }
        public DbSet<Models.Catalogs.ИзменениеПараметровНачисленияАмортизацииНМА_НМА> ИзменениеПараметровНачисленияАмортизацииНМА_НМА { get; set; }
        public DbSet<Models.Catalogs.ИзменениеПараметровНачисленияАмортизацииОС> ИзменениеПараметровНачисленияАмортизацииОС { get; set; }
        public DbSet<Models.Catalogs.ИзменениеПараметровНачисленияАмортизацииОС_ОС> ИзменениеПараметровНачисленияАмортизацииОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ИзменениеПлановыхНачислений> ИзменениеПлановыхНачислений { get; set; }
        public DbSet<Models.Catalogs.ИзменениеПлановыхНачислений_Начисления> ИзменениеПлановыхНачислений_Начисления { get; set; }
        public DbSet<Models.Catalogs.ИзменениеПлановыхНачислений_Сотрудники> ИзменениеПлановыхНачислений_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ИзменениеПлановыхНачислений_НачисленияСотрудников> ИзменениеПлановыхНачислений_НачисленияСотрудников { get; set; }
        public DbSet<Models.Catalogs.ИзменениеПлановыхНачислений_ПоказателиСотрудников> ИзменениеПлановыхНачислений_ПоказателиСотрудников { get; set; }
        public DbSet<Models.Catalogs.ИзменениеПлановыхНачислений_ФизическиеЛица> ИзменениеПлановыхНачислений_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ИзменениеПлановыхНачислений_УдалитьПоказателиПозиции> ИзменениеПлановыхНачислений_УдалитьПоказателиПозиции { get; set; }
        public DbSet<Models.Catalogs.ИзменениеСостоянияОС> ИзменениеСостоянияОС { get; set; }
        public DbSet<Models.Catalogs.ИзменениеСостоянияОС_ОС> ИзменениеСостоянияОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ИзменениеСпособовОтраженияРасходовПоАмортизацииНМА> ИзменениеСпособовОтраженияРасходовПоАмортизацииНМА { get; set; }
        public DbSet<Models.Catalogs.ИзменениеСпособовОтраженияРасходовПоАмортизацииНМА_НМА> ИзменениеСпособовОтраженияРасходовПоАмортизацииНМА_НМА { get; set; }
        public DbSet<Models.Catalogs.ИзменениеСпособовОтраженияРасходовПоАмортизацииОС> ИзменениеСпособовОтраженияРасходовПоАмортизацииОС { get; set; }
        public DbSet<Models.Catalogs.ИзменениеСпособовОтраженияРасходовПоАмортизацииОС_ОС> ИзменениеСпособовОтраженияРасходовПоАмортизацииОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ИзменениеУсловийДоговораЗаймаСотруднику> ИзменениеУсловийДоговораЗаймаСотруднику { get; set; }
        public DbSet<Models.Catalogs.ИзменениеУсловийДоговораЗаймаСотруднику_ТраншиЗайма> ИзменениеУсловийДоговораЗаймаСотруднику_ТраншиЗайма { get; set; }
        public DbSet<Models.Catalogs.ИзменениеУсловийИсполнительногоЛиста> ИзменениеУсловийИсполнительногоЛиста { get; set; }
        public DbSet<Models.Catalogs.ИзменениеУсловийИсполнительногоЛиста_ДополнительныеРеквизиты> ИзменениеУсловийИсполнительногоЛиста_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.ИзменениеУсловийИсполнительногоЛиста_Дети> ИзменениеУсловийИсполнительногоЛиста_Дети { get; set; }
        public DbSet<Models.Catalogs.ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком> ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком { get; set; }
        public DbSet<Models.Catalogs.ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком_Начисления> ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком_Начисления { get; set; }
        public DbSet<Models.Catalogs.ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком_Показатели> ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком_Показатели { get; set; }
        public DbSet<Models.Catalogs.ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком_Авансы> ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком_Авансы { get; set; }
        public DbSet<Models.Catalogs.ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком_ПрименениеПлановыхНачислений> ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком_ПрименениеПлановыхНачислений { get; set; }
        public DbSet<Models.Catalogs.ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком_ПересчетТарифныхСтавок> ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком_ПересчетТарифныхСтавок { get; set; }
        public DbSet<Models.Catalogs.ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком_Льготы> ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком_Льготы { get; set; }
        public DbSet<Models.Catalogs.ИзменениеШтатногоРасписания> ИзменениеШтатногоРасписания { get; set; }
        public DbSet<Models.Catalogs.ИзменениеШтатногоРасписания_Позиции> ИзменениеШтатногоРасписания_Позиции { get; set; }
        public DbSet<Models.Catalogs.ИзменениеШтатногоРасписания_Начисления> ИзменениеШтатногоРасписания_Начисления { get; set; }
        public DbSet<Models.Catalogs.ИзменениеШтатногоРасписания_Показатели> ИзменениеШтатногоРасписания_Показатели { get; set; }
        public DbSet<Models.Catalogs.ИзменениеШтатногоРасписания_ЕжегодныеОтпуска> ИзменениеШтатногоРасписания_ЕжегодныеОтпуска { get; set; }
        public DbSet<Models.Catalogs.ИзменениеШтатногоРасписания_Специальности> ИзменениеШтатногоРасписания_Специальности { get; set; }
        public DbSet<Models.Catalogs.ИнвентаризацияНЗП> ИнвентаризацияНЗП { get; set; }
        public DbSet<Models.Catalogs.ИнвентаризацияНЗП_Состав> ИнвентаризацияНЗП_Состав { get; set; }
        public DbSet<Models.Catalogs.ИнвентаризацияНМА> ИнвентаризацияНМА { get; set; }
        public DbSet<Models.Catalogs.ИнвентаризацияНМА_НематериальныеАктивы> ИнвентаризацияНМА_НематериальныеАктивы { get; set; }
        public DbSet<Models.Catalogs.ИнвентаризацияОС> ИнвентаризацияОС { get; set; }
        public DbSet<Models.Catalogs.ИнвентаризацияОС_ОС> ИнвентаризацияОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ИнвентаризацияРасчетовСКонтрагентами> ИнвентаризацияРасчетовСКонтрагентами { get; set; }
        public DbSet<Models.Catalogs.ИнвентаризацияРасчетовСКонтрагентами_Контрагенты> ИнвентаризацияРасчетовСКонтрагентами_Контрагенты { get; set; }
        public DbSet<Models.Catalogs.ИнвентаризацияРасчетовСКонтрагентами_СчетаРасчетов> ИнвентаризацияРасчетовСКонтрагентами_СчетаРасчетов { get; set; }
        public DbSet<Models.Catalogs.ИнвентаризацияТоваровНаСкладе> ИнвентаризацияТоваровНаСкладе { get; set; }
        public DbSet<Models.Catalogs.ИнвентаризацияТоваровНаСкладе_Товары> ИнвентаризацияТоваровНаСкладе_Товары { get; set; }
        public DbSet<Models.Catalogs.ИндексацияЗаработка> ИндексацияЗаработка { get; set; }
        public DbSet<Models.Catalogs.ИндексацияЗаработка_Сотрудники> ИндексацияЗаработка_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ИндексацияЗаработка_ФизическиеЛица> ИндексацияЗаработка_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ИндексацияЗаработка_Показатели> ИндексацияЗаработка_Показатели { get; set; }
        public DbSet<Models.Catalogs.ИндексацияЗаработка_ЗначенияПоказателей> ИндексацияЗаработка_ЗначенияПоказателей { get; set; }
        public DbSet<Models.Catalogs.ИндексацияЗаработка_НачисленияСотрудников> ИндексацияЗаработка_НачисленияСотрудников { get; set; }
        public DbSet<Models.Catalogs.ИндексацияЗаработка_ПересчетТарифныхСтавок> ИндексацияЗаработка_ПересчетТарифныхСтавок { get; set; }
        public DbSet<Models.Catalogs.ИндексацияОС> ИндексацияОС { get; set; }
        public DbSet<Models.Catalogs.ИндексацияОС_ОС> ИндексацияОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ИндексацияШтатногоРасписания> ИндексацияШтатногоРасписания { get; set; }
        public DbSet<Models.Catalogs.ИндексацияШтатногоРасписания_ИндексируемыеПоказатели> ИндексацияШтатногоРасписания_ИндексируемыеПоказатели { get; set; }
        public DbSet<Models.Catalogs.ИндексацияШтатногоРасписания_Позиции> ИндексацияШтатногоРасписания_Позиции { get; set; }
        public DbSet<Models.Catalogs.ИндексацияШтатногоРасписания_Начисления> ИндексацияШтатногоРасписания_Начисления { get; set; }
        public DbSet<Models.Catalogs.ИндексацияШтатногоРасписания_Показатели> ИндексацияШтатногоРасписания_Показатели { get; set; }
        public DbSet<Models.Catalogs.ИндивидуальныйГрафик> ИндивидуальныйГрафик { get; set; }
        public DbSet<Models.Catalogs.ИндивидуальныйГрафик_ДанныеОВремени> ИндивидуальныйГрафик_ДанныеОВремени { get; set; }
        public DbSet<Models.Catalogs.ИндивидуальныйГрафик_СотрудникиСИсправлениями> ИндивидуальныйГрафик_СотрудникиСИсправлениями { get; set; }
        public DbSet<Models.Catalogs.ИндивидуальныйГрафик_ФизическиеЛица> ИндивидуальныйГрафик_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ИсполнительныйЛист> ИсполнительныйЛист { get; set; }
        public DbSet<Models.Catalogs.ИсполнительныйЛист_ДополнительныеРеквизиты> ИсполнительныйЛист_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.ИсполнительныйЛист_Дети> ИсполнительныйЛист_Дети { get; set; }
        public DbSet<Models.Catalogs.КадровыйПеревод> КадровыйПеревод { get; set; }
        public DbSet<Models.Catalogs.КадровыйПеревод_Начисления> КадровыйПеревод_Начисления { get; set; }
        public DbSet<Models.Catalogs.КадровыйПеревод_Показатели> КадровыйПеревод_Показатели { get; set; }
        public DbSet<Models.Catalogs.КадровыйПеревод_ЕжегодныеОтпуска> КадровыйПеревод_ЕжегодныеОтпуска { get; set; }
        public DbSet<Models.Catalogs.КадровыйПеревод_Льготы> КадровыйПеревод_Льготы { get; set; }
        public DbSet<Models.Catalogs.КадровыйПеревод_КадровыйРезерв> КадровыйПеревод_КадровыйРезерв { get; set; }
        public DbSet<Models.Catalogs.КадровыйПеревод_ДополнительныеРеквизиты> КадровыйПеревод_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.КадровыйПереводСписком> КадровыйПереводСписком { get; set; }
        public DbSet<Models.Catalogs.КадровыйПереводСписком_Сотрудники> КадровыйПереводСписком_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.КадровыйПереводСписком_Начисления> КадровыйПереводСписком_Начисления { get; set; }
        public DbSet<Models.Catalogs.КадровыйПереводСписком_Показатели> КадровыйПереводСписком_Показатели { get; set; }
        public DbSet<Models.Catalogs.КадровыйПереводСписком_ЕжегодныеОтпуска> КадровыйПереводСписком_ЕжегодныеОтпуска { get; set; }
        public DbSet<Models.Catalogs.КадровыйПереводСписком_Льготы> КадровыйПереводСписком_Льготы { get; set; }
        public DbSet<Models.Catalogs.КадровыйПереводСписком_КадровыйРезерв> КадровыйПереводСписком_КадровыйРезерв { get; set; }
        public DbSet<Models.Catalogs.КадровыйПереводСписком_ДополнительныеРеквизиты> КадровыйПереводСписком_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.Командировка> Командировка { get; set; }
        public DbSet<Models.Catalogs.Командировка_ДанныеОбИндексации> Командировка_ДанныеОбИндексации { get; set; }
        public DbSet<Models.Catalogs.Командировка_Начисления> Командировка_Начисления { get; set; }
        public DbSet<Models.Catalogs.Командировка_НачисленияПерерасчет> Командировка_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.Командировка_НДФЛ> Командировка_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.Командировка_ОтработанноеВремяДляСреднегоОбщий> Командировка_ОтработанноеВремяДляСреднегоОбщий { get; set; }
        public DbSet<Models.Catalogs.Командировка_Показатели> Командировка_Показатели { get; set; }
        public DbSet<Models.Catalogs.Командировка_РаспределениеРезультатовНачислений> Командировка_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.Командировка_РаспределениеРезультатовУдержаний> Командировка_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.Командировка_СреднийЗаработокОбщий> Командировка_СреднийЗаработокОбщий { get; set; }
        public DbSet<Models.Catalogs.Командировка_Удержания> Командировка_Удержания { get; set; }
        public DbSet<Models.Catalogs.Командировка_ДенежноеСодержание> Командировка_ДенежноеСодержание { get; set; }
        public DbSet<Models.Catalogs.Командировка_ДенежноеСодержаниеФактическиеНачисления> Командировка_ДенежноеСодержаниеФактическиеНачисления { get; set; }
        public DbSet<Models.Catalogs.Командировка_РаспределениеПоТерриториямУсловиямТруда> Командировка_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.Командировка_ДополнительныеРеквизиты> Командировка_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.Командировка_ВзносыФОТ> Командировка_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.Командировка_Взносы> Командировка_Взносы { get; set; }
        public DbSet<Models.Catalogs.Командировка_РасшифровкаСоставаФОТ> Командировка_РасшифровкаСоставаФОТ { get; set; }
        public DbSet<Models.Catalogs.КомандировкиСотрудников> КомандировкиСотрудников { get; set; }
        public DbSet<Models.Catalogs.КомандировкиСотрудников_Сотрудники> КомандировкиСотрудников_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.КомпенсацияЗаЗадержкуЗарплаты> КомпенсацияЗаЗадержкуЗарплаты { get; set; }
        public DbSet<Models.Catalogs.КомпенсацияЗаЗадержкуЗарплаты_Начисления> КомпенсацияЗаЗадержкуЗарплаты_Начисления { get; set; }
        public DbSet<Models.Catalogs.КомпенсацияЗаЗадержкуЗарплаты_ФизическиеЛица> КомпенсацияЗаЗадержкуЗарплаты_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.КомплектацияНоменклатуры> КомплектацияНоменклатуры { get; set; }
        public DbSet<Models.Catalogs.КомплектацияНоменклатуры_Комплектующие> КомплектацияНоменклатуры_Комплектующие { get; set; }
        public DbSet<Models.Catalogs.КорректировкаДолга> КорректировкаДолга { get; set; }
        public DbSet<Models.Catalogs.КорректировкаДолга_СуммыДолга> КорректировкаДолга_СуммыДолга { get; set; }
        public DbSet<Models.Catalogs.КорректировкаЗаписейРегистров> КорректировкаЗаписейРегистров { get; set; }
        public DbSet<Models.Catalogs.КорректировкаЗаписейРегистров_ТаблицаРегистровНакопления> КорректировкаЗаписейРегистров_ТаблицаРегистровНакопления { get; set; }
        public DbSet<Models.Catalogs.КорректировкаЗаписейРегистров_ТаблицаРегистровСведений> КорректировкаЗаписейРегистров_ТаблицаРегистровСведений { get; set; }
        public DbSet<Models.Catalogs.КорректировкаЗаписейРегистров_ТаблицаРегистровБухгалтерии> КорректировкаЗаписейРегистров_ТаблицаРегистровБухгалтерии { get; set; }
        public DbSet<Models.Catalogs.КорректировкаЗаписейРегистров_ТаблицаРегистровРасчета> КорректировкаЗаписейРегистров_ТаблицаРегистровРасчета { get; set; }
        public DbSet<Models.Catalogs.КорректировкаЗаписейРегистров_ЗаполнениеДвижений> КорректировкаЗаписейРегистров_ЗаполнениеДвижений { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОжидаемогоИПодтвержденногоНДС> КорректировкаОжидаемогоИПодтвержденногоНДС { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОжидаемогоИПодтвержденногоНДС_ПриобретенияПодтвержденный> КорректировкаОжидаемогоИПодтвержденногоНДС_ПриобретенияПодтвержденный { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОжидаемогоИПодтвержденногоНДС_ПриобретенияОжидаемый> КорректировкаОжидаемогоИПодтвержденногоНДС_ПриобретенияОжидаемый { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОжидаемогоИПодтвержденногоНДС_ПродажиПодтвержденный> КорректировкаОжидаемогоИПодтвержденногоНДС_ПродажиПодтвержденный { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОжидаемогоИПодтвержденногоНДС_ПродажиОжидаемый> КорректировкаОжидаемогоИПодтвержденногоНДС_ПродажиОжидаемый { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОстатковНКУна01042011> КорректировкаОстатковНКУна01042011 { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОстатковНКУна01042011_БухСправка> КорректировкаОстатковНКУна01042011_БухСправка { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОстатковНКУна01042011_ОС> КорректировкаОстатковНКУна01042011_ОС { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОстатковНКУна01042011_НМА> КорректировкаОстатковНКУна01042011_НМА { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОстатковНКУна01042011_ЗапасыВсе> КорректировкаОстатковНКУна01042011_ЗапасыВсе { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОстатковНКУна01042011_ТоварыПоПродажнойЦенеАТТ> КорректировкаОстатковНКУна01042011_ТоварыПоПродажнойЦенеАТТ { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОстатковНКУна01042011_ТоварыПоПродажнойЦенеНТТ> КорректировкаОстатковНКУна01042011_ТоварыПоПродажнойЦенеНТТ { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОстатковНКУна01042011_Затраты> КорректировкаОстатковНКУна01042011_Затраты { get; set; }
        public DbSet<Models.Catalogs.КорректировкаОстатковНКУна01042011_РасходыБудущихПериодов> КорректировкаОстатковНКУна01042011_РасходыБудущихПериодов { get; set; }
        public DbSet<Models.Catalogs.ЛистокСообщенияДляВоенкомата> ЛистокСообщенияДляВоенкомата { get; set; }
        public DbSet<Models.Catalogs.ЛистокСообщенияДляВоенкомата_ФиксацияИзменений> ЛистокСообщенияДляВоенкомата_ФиксацияИзменений { get; set; }
        public DbSet<Models.Catalogs.МатериальнаяПомощь> МатериальнаяПомощь { get; set; }
        public DbSet<Models.Catalogs.МатериальнаяПомощь_Начисления> МатериальнаяПомощь_Начисления { get; set; }
        public DbSet<Models.Catalogs.МатериальнаяПомощь_НачисленияПерерасчет> МатериальнаяПомощь_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.МатериальнаяПомощь_НДФЛ> МатериальнаяПомощь_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.МатериальнаяПомощь_Показатели> МатериальнаяПомощь_Показатели { get; set; }
        public DbSet<Models.Catalogs.МатериальнаяПомощь_Удержания> МатериальнаяПомощь_Удержания { get; set; }
        public DbSet<Models.Catalogs.МатериальнаяПомощь_ФизическиеЛица> МатериальнаяПомощь_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.МатериальнаяПомощь_РаспределениеРезультатовНачислений> МатериальнаяПомощь_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.МатериальнаяПомощь_РаспределениеРезультатовУдержаний> МатериальнаяПомощь_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.МатериальнаяПомощь_РаспределениеПоТерриториямУсловиямТруда> МатериальнаяПомощь_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.МатериальнаяПомощь_ВзносыФОТ> МатериальнаяПомощь_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.МатериальнаяПомощь_Взносы> МатериальнаяПомощь_Взносы { get; set; }
        public DbSet<Models.Catalogs.МодернизацияНМА> МодернизацияНМА { get; set; }
        public DbSet<Models.Catalogs.МодернизацияНМА_НМА> МодернизацияНМА_НМА { get; set; }
        public DbSet<Models.Catalogs.МодернизацияОС> МодернизацияОС { get; set; }
        public DbSet<Models.Catalogs.МодернизацияОС_ОС> МодернизацияОС_ОС { get; set; }
        public DbSet<Models.Catalogs.НазначениеПлановогоНачисления> НазначениеПлановогоНачисления { get; set; }
        public DbSet<Models.Catalogs.НазначениеПлановогоНачисления_Сотрудники> НазначениеПлановогоНачисления_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.НазначениеПлановогоНачисления_ПоказателиСотрудников> НазначениеПлановогоНачисления_ПоказателиСотрудников { get; set; }
        public DbSet<Models.Catalogs.НазначениеПлановогоНачисления_ФизическиеЛица> НазначениеПлановогоНачисления_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.НазначениеПодработки> НазначениеПодработки { get; set; }
        public DbSet<Models.Catalogs.НазначениеПодработки_Начисления> НазначениеПодработки_Начисления { get; set; }
        public DbSet<Models.Catalogs.НазначениеПодработки_Показатели> НазначениеПодработки_Показатели { get; set; }
        public DbSet<Models.Catalogs.НазначениеПодработки_ФизическиеЛица> НазначениеПодработки_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.НазначениеПодработки_ДополнительныеРеквизиты> НазначениеПодработки_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.НалоговаяНакладная> НалоговаяНакладная { get; set; }
        public DbSet<Models.Catalogs.НалоговаяНакладная_Товары> НалоговаяНакладная_Товары { get; set; }
        public DbSet<Models.Catalogs.НалоговаяНакладная_Услуги> НалоговаяНакладная_Услуги { get; set; }
        public DbSet<Models.Catalogs.НалоговаяНакладная_ОС> НалоговаяНакладная_ОС { get; set; }
        public DbSet<Models.Catalogs.НалоговаяНакладная_НМА> НалоговаяНакладная_НМА { get; set; }
        public DbSet<Models.Catalogs.НалоговаяНакладная_ВозвратнаяТара> НалоговаяНакладная_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.НачальнаяЗадолженностьПоЗарплате> НачальнаяЗадолженностьПоЗарплате { get; set; }
        public DbSet<Models.Catalogs.НачальнаяЗадолженностьПоЗарплате_ЗадолженностьПоЗарплате> НачальнаяЗадолженностьПоЗарплате_ЗадолженностьПоЗарплате { get; set; }
        public DbSet<Models.Catalogs.НачальнаяЗадолженностьПоЗарплате_ФизическиеЛица> НачальнаяЗадолженностьПоЗарплате_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.НачальнаяШтатнаяРасстановка> НачальнаяШтатнаяРасстановка { get; set; }
        public DbSet<Models.Catalogs.НачальнаяШтатнаяРасстановка_Сотрудники> НачальнаяШтатнаяРасстановка_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.НачальнаяШтатнаяРасстановка_Начисления> НачальнаяШтатнаяРасстановка_Начисления { get; set; }
        public DbSet<Models.Catalogs.НачальнаяШтатнаяРасстановка_Показатели> НачальнаяШтатнаяРасстановка_Показатели { get; set; }
        public DbSet<Models.Catalogs.НачальнаяШтатнаяРасстановка_ЕжегодныеОтпуска> НачальнаяШтатнаяРасстановка_ЕжегодныеОтпуска { get; set; }
        public DbSet<Models.Catalogs.НачальнаяШтатнаяРасстановка_ФизическиеЛица> НачальнаяШтатнаяРасстановка_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.НачальнаяШтатнаяРасстановка_Льготы> НачальнаяШтатнаяРасстановка_Льготы { get; set; }
        public DbSet<Models.Catalogs.НачальнаяШтатнаяРасстановка_ОстаткиОтпусковПоРабочимГодам> НачальнаяШтатнаяРасстановка_ОстаткиОтпусковПоРабочимГодам { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца> НачислениеЗаПервуюПоловинуМесяца { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца_Начисления> НачислениеЗаПервуюПоловинуМесяца_Начисления { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца_НДФЛ> НачислениеЗаПервуюПоловинуМесяца_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца_Показатели> НачислениеЗаПервуюПоловинуМесяца_Показатели { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца_УдалитьПособия> НачислениеЗаПервуюПоловинуМесяца_УдалитьПособия { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца_ПримененныеВычетыНаДетейИИмущественные> НачислениеЗаПервуюПоловинуМесяца_ПримененныеВычетыНаДетейИИмущественные { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца_Удержания> НачислениеЗаПервуюПоловинуМесяца_Удержания { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца_ФизическиеЛица> НачислениеЗаПервуюПоловинуМесяца_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца_РаспределениеРезультатовНачислений> НачислениеЗаПервуюПоловинуМесяца_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца_РаспределениеРезультатовУдержаний> НачислениеЗаПервуюПоловинуМесяца_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца_РаспределениеПоТерриториямУсловиямТруда> НачислениеЗаПервуюПоловинуМесяца_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца_ВзносыФОТ> НачислениеЗаПервуюПоловинуМесяца_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗаПервуюПоловинуМесяца_Взносы> НачислениеЗаПервуюПоловинуМесяца_Взносы { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты> НачислениеЗарплаты { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_Взносы> НачислениеЗарплаты_Взносы { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_Начисления> НачислениеЗарплаты_Начисления { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_НачисленияПерерасчет> НачислениеЗарплаты_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_НачисленияПоДоговорам> НачислениеЗарплаты_НачисленияПоДоговорам { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_НДФЛ> НачислениеЗарплаты_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_ПогашениеЗаймов> НачислениеЗарплаты_ПогашениеЗаймов { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_Показатели> НачислениеЗарплаты_Показатели { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_Пособия> НачислениеЗарплаты_Пособия { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_Удержания> НачислениеЗарплаты_Удержания { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_ФизическиеЛица> НачислениеЗарплаты_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_РаспределениеРезультатовНачислений> НачислениеЗарплаты_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_РаспределениеРезультатовУдержаний> НачислениеЗарплаты_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_ПредставлениеРаспределенияРезультатовРасчета> НачислениеЗарплаты_ПредставлениеРаспределенияРезультатовРасчета { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_Льготы> НачислениеЗарплаты_Льготы { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_РаспределениеПоТерриториямУсловиямТруда> НачислениеЗарплаты_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_ПособияПерерасчет> НачислениеЗарплаты_ПособияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.НачислениеЗарплаты_ВзносыФОТ> НачислениеЗарплаты_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.НачислениеОценочныхОбязательствПоОтпускам> НачислениеОценочныхОбязательствПоОтпускам { get; set; }
        public DbSet<Models.Catalogs.НачислениеОценочныхОбязательствПоОтпускам_РасчетРезерваОтпусков> НачислениеОценочныхОбязательствПоОтпускам_РасчетРезерваОтпусков { get; set; }
        public DbSet<Models.Catalogs.НачислениеОценочныхОбязательствПоОтпускам_ОценочныеОбязательстваПоВознаграждениямРаботникам> НачислениеОценочныхОбязательствПоОтпускам_ОценочныеОбязательстваПоВознаграждениямРаботникам { get; set; }
        public DbSet<Models.Catalogs.НачислениеОценочныхОбязательствПоОтпускам_ОценочныеОбязательства> НачислениеОценочныхОбязательствПоОтпускам_ОценочныеОбязательства { get; set; }
        public DbSet<Models.Catalogs.НачислениеОценочныхОбязательствПоОтпускам_ФизическиеЛица> НачислениеОценочныхОбязательствПоОтпускам_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.НормированиеРасходовПоНалогуНаПрибыль> НормированиеРасходовПоНалогуНаПрибыль { get; set; }
        public DbSet<Models.Catalogs.НормированиеРасходовПоНалогуНаПрибыль_Статьи> НормированиеРасходовПоНалогуНаПрибыль_Статьи { get; set; }
        public DbSet<Models.Catalogs.ОперацияБух> ОперацияБух { get; set; }
        public DbSet<Models.Catalogs.ОперацияБух_ЗаполнениеДвижений> ОперацияБух_ЗаполнениеДвижений { get; set; }
        public DbSet<Models.Catalogs.ОперацияБух_ЗапрашиваемыеПараметры> ОперацияБух_ЗапрашиваемыеПараметры { get; set; }
        public DbSet<Models.Catalogs.ОперацияБух_ТаблицаРегистровНакопления> ОперацияБух_ТаблицаРегистровНакопления { get; set; }
        public DbSet<Models.Catalogs.ОперацияБух_ТаблицаРегистровРасчета> ОперацияБух_ТаблицаРегистровРасчета { get; set; }
        public DbSet<Models.Catalogs.ОперацияБух_ТаблицаРегистровСведений> ОперацияБух_ТаблицаРегистровСведений { get; set; }
        public DbSet<Models.Catalogs.ОперацияНалоговогоУчетаПоНДФЛ> ОперацияНалоговогоУчетаПоНДФЛ { get; set; }
        public DbSet<Models.Catalogs.ОперацияНалоговогоУчетаПоНДФЛ_СведенияОДоходах> ОперацияНалоговогоУчетаПоНДФЛ_СведенияОДоходах { get; set; }
        public DbSet<Models.Catalogs.ОперацияНалоговогоУчетаПоНДФЛ_НДФЛИсчисленный> ОперацияНалоговогоУчетаПоНДФЛ_НДФЛИсчисленный { get; set; }
        public DbSet<Models.Catalogs.ОперацияНалоговогоУчетаПоНДФЛ_НДФЛУдержанный> ОперацияНалоговогоУчетаПоНДФЛ_НДФЛУдержанный { get; set; }
        public DbSet<Models.Catalogs.ОперацияУчетаПоСтраховымВзносам> ОперацияУчетаПоСтраховымВзносам { get; set; }
        public DbSet<Models.Catalogs.ОперацияУчетаПоСтраховымВзносам_СведенияОДоходах> ОперацияУчетаПоСтраховымВзносам_СведенияОДоходах { get; set; }
        public DbSet<Models.Catalogs.ОперацияУчетаПоСтраховымВзносам_ПособияПоСоциальномуСтрахованию> ОперацияУчетаПоСтраховымВзносам_ПособияПоСоциальномуСтрахованию { get; set; }
        public DbSet<Models.Catalogs.ОперацияУчетаПоСтраховымВзносам_ПособияПоУходуЗаРебенком> ОперацияУчетаПоСтраховымВзносам_ПособияПоУходуЗаРебенком { get; set; }
        public DbSet<Models.Catalogs.ОперацияУчетаПоСтраховымВзносам_ВзносыФОТ> ОперацияУчетаПоСтраховымВзносам_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.ОперацияУчетаПоСтраховымВзносам_Взносы> ОперацияУчетаПоСтраховымВзносам_Взносы { get; set; }
        public DbSet<Models.Catalogs.ОперацияУчетаПоСтраховымВзносам_РасчетыСФондами> ОперацияУчетаПоСтраховымВзносам_РасчетыСФондами { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку> ОплатаПоСреднемуЗаработку { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_ДанныеОбИндексации> ОплатаПоСреднемуЗаработку_ДанныеОбИндексации { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_Начисления> ОплатаПоСреднемуЗаработку_Начисления { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_НачисленияПерерасчет> ОплатаПоСреднемуЗаработку_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_НДФЛ> ОплатаПоСреднемуЗаработку_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_ОтработанноеВремяДляСреднегоОбщий> ОплатаПоСреднемуЗаработку_ОтработанноеВремяДляСреднегоОбщий { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_Показатели> ОплатаПоСреднемуЗаработку_Показатели { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_РаспределениеРезультатовНачислений> ОплатаПоСреднемуЗаработку_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_РаспределениеРезультатовУдержаний> ОплатаПоСреднемуЗаработку_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_СреднийЗаработокОбщий> ОплатаПоСреднемуЗаработку_СреднийЗаработокОбщий { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_Удержания> ОплатаПоСреднемуЗаработку_Удержания { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_ДенежноеСодержание> ОплатаПоСреднемуЗаработку_ДенежноеСодержание { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_ДенежноеСодержаниеФактическиеНачисления> ОплатаПоСреднемуЗаработку_ДенежноеСодержаниеФактическиеНачисления { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_РаспределениеПоТерриториямУсловиямТруда> ОплатаПоСреднемуЗаработку_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_ДополнительныеРеквизиты> ОплатаПоСреднемуЗаработку_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_ВзносыФОТ> ОплатаПоСреднемуЗаработку_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.ОплатаПоСреднемуЗаработку_Взносы> ОплатаПоСреднемуЗаработку_Взносы { get; set; }
        public DbSet<Models.Catalogs.ОпределениеФинансовыхРезультатов> ОпределениеФинансовыхРезультатов { get; set; }
        public DbSet<Models.Catalogs.ОприходованиеТоваров> ОприходованиеТоваров { get; set; }
        public DbSet<Models.Catalogs.ОприходованиеТоваров_Товары> ОприходованиеТоваров_Товары { get; set; }
        public DbSet<Models.Catalogs.ОприходованиеТоваров_БланкиСтрогогоУчета> ОприходованиеТоваров_БланкиСтрогогоУчета { get; set; }
        public DbSet<Models.Catalogs.Отгул> Отгул { get; set; }
        public DbSet<Models.Catalogs.Отгул_Начисления> Отгул_Начисления { get; set; }
        public DbSet<Models.Catalogs.Отгул_НачисленияПерерасчет> Отгул_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.Отгул_Показатели> Отгул_Показатели { get; set; }
        public DbSet<Models.Catalogs.Отгул_РаспределениеРезультатовНачислений> Отгул_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.Отгул_РаспределениеПоТерриториямУсловиямТруда> Отгул_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.ОтменаБронированияГражданПребывающихВЗапасе> ОтменаБронированияГражданПребывающихВЗапасе { get; set; }
        public DbSet<Models.Catalogs.ОтменаБронированияГражданПребывающихВЗапасе_Сотрудники> ОтменаБронированияГражданПребывающихВЗапасе_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ОтменаДоплатыДоСреднегоЗаработка> ОтменаДоплатыДоСреднегоЗаработка { get; set; }
        public DbSet<Models.Catalogs.ОтменаДоплатыДоСреднегоЗаработка_НачисленияСотрудника> ОтменаДоплатыДоСреднегоЗаработка_НачисленияСотрудника { get; set; }
        public DbSet<Models.Catalogs.ОтменаСовмещения> ОтменаСовмещения { get; set; }
        public DbSet<Models.Catalogs.ОтменаСовмещения_НачисленияСотрудника> ОтменаСовмещения_НачисленияСотрудника { get; set; }
        public DbSet<Models.Catalogs.ОтменаСовмещения_ДополнительныеРеквизиты> ОтменаСовмещения_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.Отпуск> Отпуск { get; set; }
        public DbSet<Models.Catalogs.Отпуск_ДанныеОбИндексации> Отпуск_ДанныеОбИндексации { get; set; }
        public DbSet<Models.Catalogs.Отпуск_ДополнительныеОтпуска> Отпуск_ДополнительныеОтпуска { get; set; }
        public DbSet<Models.Catalogs.Отпуск_Начисления> Отпуск_Начисления { get; set; }
        public DbSet<Models.Catalogs.Отпуск_НачисленияПерерасчет> Отпуск_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.Отпуск_НДФЛ> Отпуск_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.Отпуск_ОтработанноеВремяДляСреднегоОбщий> Отпуск_ОтработанноеВремяДляСреднегоОбщий { get; set; }
        public DbSet<Models.Catalogs.Отпуск_ПогашениеЗаймов> Отпуск_ПогашениеЗаймов { get; set; }
        public DbSet<Models.Catalogs.Отпуск_Показатели> Отпуск_Показатели { get; set; }
        public DbSet<Models.Catalogs.Отпуск_ПримененныеВычетыНаДетейИИмущественные> Отпуск_ПримененныеВычетыНаДетейИИмущественные { get; set; }
        public DbSet<Models.Catalogs.Отпуск_РаспределениеРезультатовНачислений> Отпуск_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.Отпуск_РаспределениеРезультатовУдержаний> Отпуск_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.Отпуск_СреднийЗаработокОбщий> Отпуск_СреднийЗаработокОбщий { get; set; }
        public DbSet<Models.Catalogs.Отпуск_Удержания> Отпуск_Удержания { get; set; }
        public DbSet<Models.Catalogs.Отпуск_ДенежноеСодержание> Отпуск_ДенежноеСодержание { get; set; }
        public DbSet<Models.Catalogs.Отпуск_ДенежноеСодержаниеФактическиеНачисления> Отпуск_ДенежноеСодержаниеФактическиеНачисления { get; set; }
        public DbSet<Models.Catalogs.Отпуск_РаспределениеПоТерриториямУсловиямТруда> Отпуск_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.Отпуск_ДополнительныеРеквизиты> Отпуск_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.Отпуск_ВзносыФОТ> Отпуск_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.Отпуск_Взносы> Отпуск_Взносы { get; set; }
        public DbSet<Models.Catalogs.ОтпускаСотрудников> ОтпускаСотрудников { get; set; }
        public DbSet<Models.Catalogs.ОтпускаСотрудников_Сотрудники> ОтпускаСотрудников_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ОтпускБезСохраненияОплаты> ОтпускБезСохраненияОплаты { get; set; }
        public DbSet<Models.Catalogs.ОтпускБезСохраненияОплаты_Начисления> ОтпускБезСохраненияОплаты_Начисления { get; set; }
        public DbSet<Models.Catalogs.ОтпускБезСохраненияОплаты_НачисленияПерерасчет> ОтпускБезСохраненияОплаты_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.ОтпускБезСохраненияОплаты_Показатели> ОтпускБезСохраненияОплаты_Показатели { get; set; }
        public DbSet<Models.Catalogs.ОтпускБезСохраненияОплаты_РаспределениеРезультатовНачислений> ОтпускБезСохраненияОплаты_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.ОтпускБезСохраненияОплаты_РаспределениеПоТерриториямУсловиямТруда> ОтпускБезСохраненияОплаты_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.ОтпускБезСохраненияОплаты_ДополнительныеРеквизиты> ОтпускБезСохраненияОплаты_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком> ОтпускПоУходуЗаРебенком { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_Начисления> ОтпускПоУходуЗаРебенком_Начисления { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_Показатели> ОтпускПоУходуЗаРебенком_Показатели { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_ПересчетТарифныхСтавок> ОтпускПоУходуЗаРебенком_ПересчетТарифныхСтавок { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_ОплатаТруда> ОтпускПоУходуЗаРебенком_ОплатаТруда { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_НДФЛ> ОтпускПоУходуЗаРебенком_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_ПогашениеЗаймов> ОтпускПоУходуЗаРебенком_ПогашениеЗаймов { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_Удержания> ОтпускПоУходуЗаРебенком_Удержания { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_РаспределениеРезультатовНачислений> ОтпускПоУходуЗаРебенком_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_РаспределениеРезультатовУдержаний> ОтпускПоУходуЗаРебенком_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_Льготы> ОтпускПоУходуЗаРебенком_Льготы { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_ОплатаЛьгот> ОтпускПоУходуЗаРебенком_ОплатаЛьгот { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_ПериодыБолезниУходаЗаДетьми> ОтпускПоУходуЗаРебенком_ПериодыБолезниУходаЗаДетьми { get; set; }
        public DbSet<Models.Catalogs.ОтпускПоУходуЗаРебенком_РаспределениеПоТерриториямУсловиямТруда> ОтпускПоУходуЗаРебенком_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.ОтражениеЗарплатыВФинансовомУчете> ОтражениеЗарплатыВФинансовомУчете { get; set; }
        public DbSet<Models.Catalogs.ОтражениеЗарплатыВФинансовомУчете_НачисленнаяЗарплатаИВзносы> ОтражениеЗарплатыВФинансовомУчете_НачисленнаяЗарплатаИВзносы { get; set; }
        public DbSet<Models.Catalogs.ОтражениеЗарплатыВФинансовомУчете_НачисленнаяЗарплатаИВзносыПоФизлицам> ОтражениеЗарплатыВФинансовомУчете_НачисленнаяЗарплатаИВзносыПоФизлицам { get; set; }
        public DbSet<Models.Catalogs.ОтражениеЗарплатыВФинансовомУчете_НачисленныйНДФЛ> ОтражениеЗарплатыВФинансовомУчете_НачисленныйНДФЛ { get; set; }
        public DbSet<Models.Catalogs.ОтражениеЗарплатыВФинансовомУчете_УдержаннаяЗарплата> ОтражениеЗарплатыВФинансовомУчете_УдержаннаяЗарплата { get; set; }
        public DbSet<Models.Catalogs.ОтражениеЗарплатыВФинансовомУчете_ФизическиеЛица> ОтражениеЗарплатыВФинансовомУчете_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ОтражениеЗарплатыВФинансовомУчете_НачисленныеПроцентыПоЗаймам> ОтражениеЗарплатыВФинансовомУчете_НачисленныеПроцентыПоЗаймам { get; set; }
        public DbSet<Models.Catalogs.ОтчетКомиссионераОПродажах> ОтчетКомиссионераОПродажах { get; set; }
        public DbSet<Models.Catalogs.ОтчетКомиссионераОПродажах_Товары> ОтчетКомиссионераОПродажах_Товары { get; set; }
        public DbSet<Models.Catalogs.ОтчетКомитентуОПродажах> ОтчетКомитентуОПродажах { get; set; }
        public DbSet<Models.Catalogs.ОтчетКомитентуОПродажах_Товары> ОтчетКомитентуОПродажах_Товары { get; set; }
        public DbSet<Models.Catalogs.ОтчетОРозничныхПродажах> ОтчетОРозничныхПродажах { get; set; }
        public DbSet<Models.Catalogs.ОтчетОРозничныхПродажах_Товары> ОтчетОРозничныхПродажах_Товары { get; set; }
        public DbSet<Models.Catalogs.ОтчетОРозничныхПродажах_Оплата> ОтчетОРозничныхПродажах_Оплата { get; set; }
        public DbSet<Models.Catalogs.ОтчетПроизводстваЗаСмену> ОтчетПроизводстваЗаСмену { get; set; }
        public DbSet<Models.Catalogs.ОтчетПроизводстваЗаСмену_Продукция> ОтчетПроизводстваЗаСмену_Продукция { get; set; }
        public DbSet<Models.Catalogs.ОтчетПроизводстваЗаСмену_Услуги> ОтчетПроизводстваЗаСмену_Услуги { get; set; }
        public DbSet<Models.Catalogs.ОтчетПроизводстваЗаСмену_ВозвратныеОтходы> ОтчетПроизводстваЗаСмену_ВозвратныеОтходы { get; set; }
        public DbSet<Models.Catalogs.ОтчетПроизводстваЗаСмену_Материалы> ОтчетПроизводстваЗаСмену_Материалы { get; set; }
        public DbSet<Models.Catalogs.Партия> Партия { get; set; }
        public DbSet<Models.Catalogs.ПартияМалоценныхАктивовВЭксплуатации> ПартияМалоценныхАктивовВЭксплуатации { get; set; }
        public DbSet<Models.Catalogs.ПереводКДругомуРаботодателю> ПереводКДругомуРаботодателю { get; set; }
        public DbSet<Models.Catalogs.ПереводКДругомуРаботодателю_ДанныеОДоходах> ПереводКДругомуРаботодателю_ДанныеОДоходах { get; set; }
        public DbSet<Models.Catalogs.ПереводКДругомуРаботодателю_ДанныеОЗаработкеДляРасчетаПособий> ПереводКДругомуРаботодателю_ДанныеОЗаработкеДляРасчетаПособий { get; set; }
        public DbSet<Models.Catalogs.ПереводКДругомуРаботодателю_Начисления> ПереводКДругомуРаботодателю_Начисления { get; set; }
        public DbSet<Models.Catalogs.ПереводКДругомуРаботодателю_Показатели> ПереводКДругомуРаботодателю_Показатели { get; set; }
        public DbSet<Models.Catalogs.ПередачаМалоценныхАктивовВЭксплуатацию> ПередачаМалоценныхАктивовВЭксплуатацию { get; set; }
        public DbSet<Models.Catalogs.ПередачаМалоценныхАктивовВЭксплуатацию_МалоценныеАктивы> ПередачаМалоценныхАктивовВЭксплуатацию_МалоценныеАктивы { get; set; }
        public DbSet<Models.Catalogs.ПередачаНМА> ПередачаНМА { get; set; }
        public DbSet<Models.Catalogs.ПередачаНМА_НМА> ПередачаНМА_НМА { get; set; }
        public DbSet<Models.Catalogs.ПередачаОборудованияВМонтаж> ПередачаОборудованияВМонтаж { get; set; }
        public DbSet<Models.Catalogs.ПередачаОборудованияВМонтаж_Оборудование> ПередачаОборудованияВМонтаж_Оборудование { get; set; }
        public DbSet<Models.Catalogs.ПередачаОС> ПередачаОС { get; set; }
        public DbSet<Models.Catalogs.ПередачаОС_ОС> ПередачаОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ПередачаТоваров> ПередачаТоваров { get; set; }
        public DbSet<Models.Catalogs.ПередачаТоваров_Товары> ПередачаТоваров_Товары { get; set; }
        public DbSet<Models.Catalogs.ПередачаТоваров_ВозвратнаяТара> ПередачаТоваров_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеВДругоеПодразделение> ПеремещениеВДругоеПодразделение { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеВДругоеПодразделение_Сотрудники> ПеремещениеВДругоеПодразделение_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеВДругоеПодразделение_ФизическиеЛица> ПеремещениеВДругоеПодразделение_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеМалоценныхАктивовВЭксплуатации> ПеремещениеМалоценныхАктивовВЭксплуатации { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеМалоценныхАктивовВЭксплуатации_МалоценныеАктивы> ПеремещениеМалоценныхАктивовВЭксплуатации_МалоценныеАктивы { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеМеждуТерриториями> ПеремещениеМеждуТерриториями { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеМеждуТерриториями_Сотрудники> ПеремещениеМеждуТерриториями_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеНМА> ПеремещениеНМА { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеНМА_НематериальныеАктивы> ПеремещениеНМА_НематериальныеАктивы { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеОС> ПеремещениеОС { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеОС_ОС> ПеремещениеОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеТоваров> ПеремещениеТоваров { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеТоваров_Товары> ПеремещениеТоваров_Товары { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеТоваров_ТоварыНаКомиссии> ПеремещениеТоваров_ТоварыНаКомиссии { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеТоваров_ВозвратнаяТара> ПеремещениеТоваров_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.ПеремещениеТоваров_БланкиСтрогогоУчета> ПеремещениеТоваров_БланкиСтрогогоУчета { get; set; }
        public DbSet<Models.Catalogs.ПереносДанных> ПереносДанных { get; set; }
        public DbSet<Models.Catalogs.ПереносДанных_ТаблицаРегистров> ПереносДанных_ТаблицаРегистров { get; set; }
        public DbSet<Models.Catalogs.ПереносОтпуска> ПереносОтпуска { get; set; }
        public DbSet<Models.Catalogs.ПереоценкаОС> ПереоценкаОС { get; set; }
        public DbSet<Models.Catalogs.ПереоценкаОС_ОС> ПереоценкаОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ПереоценкаТоваровВРознице> ПереоценкаТоваровВРознице { get; set; }
        public DbSet<Models.Catalogs.ПереоценкаТоваровВРознице_Товары> ПереоценкаТоваровВРознице_Товары { get; set; }
        public DbSet<Models.Catalogs.ПерерасчетНДФЛ> ПерерасчетНДФЛ { get; set; }
        public DbSet<Models.Catalogs.ПерерасчетНДФЛ_Сотрудники> ПерерасчетНДФЛ_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ПерерасчетПропорциональногоНДСпоТоварамИОС> ПерерасчетПропорциональногоНДСпоТоварамИОС { get; set; }
        public DbSet<Models.Catalogs.ПерерасчетПропорциональногоНДСпоТоварамИОС_АвансыПоставщикам> ПерерасчетПропорциональногоНДСпоТоварамИОС_АвансыПоставщикам { get; set; }
        public DbSet<Models.Catalogs.ПерерасчетПропорциональногоНДСпоТоварамИОС_ПараметрыПерерасчетаОС> ПерерасчетПропорциональногоНДСпоТоварамИОС_ПараметрыПерерасчетаОС { get; set; }
        public DbSet<Models.Catalogs.ПерерасчетПропорциональногоНДСпоТоварамИОС_Остатки15Счета> ПерерасчетПропорциональногоНДСпоТоварамИОС_Остатки15Счета { get; set; }
        public DbSet<Models.Catalogs.ПерерасчетПропорциональногоНДСпоТоварамИОС_НалоговыеДокументы> ПерерасчетПропорциональногоНДСпоТоварамИОС_НалоговыеДокументы { get; set; }
        public DbSet<Models.Catalogs.ПериодыОплаченныеДоНачалаЭксплуатации> ПериодыОплаченныеДоНачалаЭксплуатации { get; set; }
        public DbSet<Models.Catalogs.ПериодыОплаченныеДоНачалаЭксплуатации_Начисления> ПериодыОплаченныеДоНачалаЭксплуатации_Начисления { get; set; }
        public DbSet<Models.Catalogs.ПериодыОплаченныеДоНачалаЭксплуатации_ФизическиеЛица> ПериодыОплаченныеДоНачалаЭксплуатации_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ПлатежноеПоручение> ПлатежноеПоручение { get; set; }
        public DbSet<Models.Catalogs.ПлатежныйОрдерПоступлениеДенежныхСредств> ПлатежныйОрдерПоступлениеДенежныхСредств { get; set; }
        public DbSet<Models.Catalogs.ПлатежныйОрдерПоступлениеДенежныхСредств_РасшифровкаПлатежа> ПлатежныйОрдерПоступлениеДенежныхСредств_РасшифровкаПлатежа { get; set; }
        public DbSet<Models.Catalogs.ПлатежныйОрдерПоступлениеДенежныхСредств_РеквизитыКонтрагента> ПлатежныйОрдерПоступлениеДенежныхСредств_РеквизитыКонтрагента { get; set; }
        public DbSet<Models.Catalogs.ПлатежныйОрдерСписаниеДенежныхСредств> ПлатежныйОрдерСписаниеДенежныхСредств { get; set; }
        public DbSet<Models.Catalogs.ПлатежныйОрдерСписаниеДенежныхСредств_РасшифровкаПлатежа> ПлатежныйОрдерСписаниеДенежныхСредств_РасшифровкаПлатежа { get; set; }
        public DbSet<Models.Catalogs.ПлатежныйОрдерСписаниеДенежныхСредств_ВыплатаЗаработнойПлаты> ПлатежныйОрдерСписаниеДенежныхСредств_ВыплатаЗаработнойПлаты { get; set; }
        public DbSet<Models.Catalogs.ПлатежныйОрдерСписаниеДенежныхСредств_ПеречислениеНалогов> ПлатежныйОрдерСписаниеДенежныхСредств_ПеречислениеНалогов { get; set; }
        public DbSet<Models.Catalogs.ПлатежныйОрдерСписаниеДенежныхСредств_РеквизитыКонтрагента> ПлатежныйОрдерСписаниеДенежныхСредств_РеквизитыКонтрагента { get; set; }
        public DbSet<Models.Catalogs.ПодготовкаКПередачеОС> ПодготовкаКПередачеОС { get; set; }
        public DbSet<Models.Catalogs.ПодготовкаКПередачеОС_ОС> ПодготовкаКПередачеОС_ОС { get; set; }
        public DbSet<Models.Catalogs.ПодтверждениеВыплатЗаСчетФСС> ПодтверждениеВыплатЗаСчетФСС { get; set; }
        public DbSet<Models.Catalogs.ПодтверждениеВыплатЗаСчетФСС_Выплаты> ПодтверждениеВыплатЗаСчетФСС_Выплаты { get; set; }
        public DbSet<Models.Catalogs.ПодтверждениеВыплатЗаСчетФСС_ФизическиеЛица> ПодтверждениеВыплатЗаСчетФСС_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ПодтверждениеЗачисленияЗарплаты> ПодтверждениеЗачисленияЗарплаты { get; set; }
        public DbSet<Models.Catalogs.ПодтверждениеЗачисленияЗарплаты_Сотрудники> ПодтверждениеЗачисленияЗарплаты_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ПодтверждениеОплатыЗаявленияРасчетаВФСС> ПодтверждениеОплатыЗаявленияРасчетаВФСС { get; set; }
        public DbSet<Models.Catalogs.ПодтверждениеОплатыЗаявленияРасчетаВФСС_РасчетыСФондами> ПодтверждениеОплатыЗаявленияРасчетаВФСС_РасчетыСФондами { get; set; }
        public DbSet<Models.Catalogs.ПодтверждениеОплатыЗаявленияРасчетаВФСС_ФизическиеЛица> ПодтверждениеОплатыЗаявленияРасчетаВФСС_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ПодтверждениеОткрытияЛицевыхСчетовСотрудников> ПодтверждениеОткрытияЛицевыхСчетовСотрудников { get; set; }
        public DbSet<Models.Catalogs.ПодтверждениеОткрытияЛицевыхСчетовСотрудников_Сотрудники> ПодтверждениеОткрытияЛицевыхСчетовСотрудников_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ПокупкаПродажаВалюты> ПокупкаПродажаВалюты { get; set; }
        public DbSet<Models.Catalogs.ПостоянноеУдержаниеВПользуТретьихЛиц> ПостоянноеУдержаниеВПользуТретьихЛиц { get; set; }
        public DbSet<Models.Catalogs.ПостоянноеУдержаниеВПользуТретьихЛиц_Удержания> ПостоянноеУдержаниеВПользуТретьихЛиц_Удержания { get; set; }
        public DbSet<Models.Catalogs.ПостоянноеУдержаниеВПользуТретьихЛиц_Показатели> ПостоянноеУдержаниеВПользуТретьихЛиц_Показатели { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеДопРасходов> ПоступлениеДопРасходов { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеДопРасходов_Товары> ПоступлениеДопРасходов_Товары { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеДопРасходов_Оборудование> ПоступлениеДопРасходов_Оборудование { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеИзПереработки> ПоступлениеИзПереработки { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеИзПереработки_Продукция> ПоступлениеИзПереработки_Продукция { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеИзПереработки_Услуги> ПоступлениеИзПереработки_Услуги { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеИзПереработки_ИспользованныеМатериалы> ПоступлениеИзПереработки_ИспользованныеМатериалы { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеИзПереработки_ВозвращенныеМатериалы> ПоступлениеИзПереработки_ВозвращенныеМатериалы { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеИзПереработки_ВозвратнаяТара> ПоступлениеИзПереработки_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеНаРасчетныйСчет> ПоступлениеНаРасчетныйСчет { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеНаРасчетныйСчет_РасшифровкаПлатежа> ПоступлениеНаРасчетныйСчет_РасшифровкаПлатежа { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеНаРасчетныйСчет_РеквизитыКонтрагента> ПоступлениеНаРасчетныйСчет_РеквизитыКонтрагента { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеНМА> ПоступлениеНМА { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеНМА_НМА> ПоступлениеНМА_НМА { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеТоваровУслуг> ПоступлениеТоваровУслуг { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеТоваровУслуг_Оборудование> ПоступлениеТоваровУслуг_Оборудование { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеТоваровУслуг_ОбъектыСтроительства> ПоступлениеТоваровУслуг_ОбъектыСтроительства { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеТоваровУслуг_Товары> ПоступлениеТоваровУслуг_Товары { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеТоваровУслуг_Услуги> ПоступлениеТоваровУслуг_Услуги { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеТоваровУслуг_ВозвратнаяТара> ПоступлениеТоваровУслуг_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.ПоступлениеТоваровУслуг_БланкиСтрогогоУчета> ПоступлениеТоваровУслуг_БланкиСтрогогоУчета { get; set; }
        public DbSet<Models.Catalogs.ПрекращениеЛьготПоНДФЛ> ПрекращениеЛьготПоНДФЛ { get; set; }
        public DbSet<Models.Catalogs.ПрекращениеПлановогоНачисления> ПрекращениеПлановогоНачисления { get; set; }
        public DbSet<Models.Catalogs.ПрекращениеПлановогоНачисления_Сотрудники> ПрекращениеПлановогоНачисления_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ПрекращениеПлановогоНачисления_ФизическиеЛица> ПрекращениеПлановогоНачисления_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ПрекращениеПодработки> ПрекращениеПодработки { get; set; }
        public DbSet<Models.Catalogs.ПрекращениеПодработки_ДополнительныеРеквизиты> ПрекращениеПодработки_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.Премия> Премия { get; set; }
        public DbSet<Models.Catalogs.Премия_Начисления> Премия_Начисления { get; set; }
        public DbSet<Models.Catalogs.Премия_НачисленияПерерасчет> Премия_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.Премия_НДФЛ> Премия_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.Премия_Показатели> Премия_Показатели { get; set; }
        public DbSet<Models.Catalogs.Премия_Удержания> Премия_Удержания { get; set; }
        public DbSet<Models.Catalogs.Премия_ФизическиеЛица> Премия_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.Премия_РаспределениеРезультатовНачислений> Премия_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.Премия_РаспределениеРезультатовУдержаний> Премия_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.Премия_РаспределениеПоТерриториямУсловиямТруда> Премия_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.Премия_ВзносыФОТ> Премия_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.Премия_Взносы> Премия_Взносы { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботу> ПриемНаРаботу { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботу_Начисления> ПриемНаРаботу_Начисления { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботу_Показатели> ПриемНаРаботу_Показатели { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботу_ЕжегодныеОтпуска> ПриемНаРаботу_ЕжегодныеОтпуска { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботу_Льготы> ПриемНаРаботу_Льготы { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботу_ДополнительныеРеквизиты> ПриемНаРаботу_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботуСписком> ПриемНаРаботуСписком { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботуСписком_Сотрудники> ПриемНаРаботуСписком_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботуСписком_Начисления> ПриемНаРаботуСписком_Начисления { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботуСписком_Показатели> ПриемНаРаботуСписком_Показатели { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботуСписком_ЕжегодныеОтпуска> ПриемНаРаботуСписком_ЕжегодныеОтпуска { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботуСписком_Льготы> ПриемНаРаботуСписком_Льготы { get; set; }
        public DbSet<Models.Catalogs.ПриемНаРаботуСписком_ДополнительныеРеквизиты> ПриемНаРаботуСписком_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.ПризПодарок> ПризПодарок { get; set; }
        public DbSet<Models.Catalogs.ПризПодарок_Начисления> ПризПодарок_Начисления { get; set; }
        public DbSet<Models.Catalogs.ПризПодарок_ФизическиеЛица> ПризПодарок_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ПризПодарок_НачисленияПерерасчет> ПризПодарок_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.ПриказНаДоплатуДоСреднегоЗаработка> ПриказНаДоплатуДоСреднегоЗаработка { get; set; }
        public DbSet<Models.Catalogs.ПриказНаДоплатуДоСреднегоЗаработка_НачисленияСотрудника> ПриказНаДоплатуДоСреднегоЗаработка_НачисленияСотрудника { get; set; }
        public DbSet<Models.Catalogs.Приложение1КНалоговойНакладной> Приложение1КНалоговойНакладной { get; set; }
        public DbSet<Models.Catalogs.Приложение1КНалоговойНакладной_Товары> Приложение1КНалоговойНакладной_Товары { get; set; }
        public DbSet<Models.Catalogs.Приложение1КНалоговойНакладной_Услуги> Приложение1КНалоговойНакладной_Услуги { get; set; }
        public DbSet<Models.Catalogs.Приложение1КНалоговойНакладной_ОС> Приложение1КНалоговойНакладной_ОС { get; set; }
        public DbSet<Models.Catalogs.Приложение1КНалоговойНакладной_НМА> Приложение1КНалоговойНакладной_НМА { get; set; }
        public DbSet<Models.Catalogs.Приложение2КНалоговойНакладной> Приложение2КНалоговойНакладной { get; set; }
        public DbSet<Models.Catalogs.Приложение2КНалоговойНакладной_Товары> Приложение2КНалоговойНакладной_Товары { get; set; }
        public DbSet<Models.Catalogs.Приложение2КНалоговойНакладной_Услуги> Приложение2КНалоговойНакладной_Услуги { get; set; }
        public DbSet<Models.Catalogs.Приложение2КНалоговойНакладной_ОС> Приложение2КНалоговойНакладной_ОС { get; set; }
        public DbSet<Models.Catalogs.Приложение2КНалоговойНакладной_ВозвратнаяТара> Приложение2КНалоговойНакладной_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.Приложение2КНалоговойНакладной_НМА> Приложение2КНалоговойНакладной_НМА { get; set; }
        public DbSet<Models.Catalogs.ПринятиеКУчетуНМА> ПринятиеКУчетуНМА { get; set; }
        public DbSet<Models.Catalogs.ПриходныйКассовыйОрдер> ПриходныйКассовыйОрдер { get; set; }
        public DbSet<Models.Catalogs.ПриходныйКассовыйОрдер_РасшифровкаПлатежа> ПриходныйКассовыйОрдер_РасшифровкаПлатежа { get; set; }
        public DbSet<Models.Catalogs.ПриходныйКассовыйОрдер_ПриемРозничнойВыручки> ПриходныйКассовыйОрдер_ПриемРозничнойВыручки { get; set; }
        public DbSet<Models.Catalogs.ПриходныйКассовыйОрдер_Оплата> ПриходныйКассовыйОрдер_Оплата { get; set; }
        public DbSet<Models.Catalogs.ПрогулНеявка> ПрогулНеявка { get; set; }
        public DbSet<Models.Catalogs.ПрогулНеявка_Начисления> ПрогулНеявка_Начисления { get; set; }
        public DbSet<Models.Catalogs.ПрогулНеявка_НачисленияПерерасчет> ПрогулНеявка_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.ПрогулНеявка_Показатели> ПрогулНеявка_Показатели { get; set; }
        public DbSet<Models.Catalogs.ПрогулНеявка_РаспределениеРезультатовНачислений> ПрогулНеявка_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.ПрогулНеявка_РаспределениеПоТерриториямУсловиямТруда> ПрогулНеявка_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.ПродлениеКонтрактаДоговора> ПродлениеКонтрактаДоговора { get; set; }
        public DbSet<Models.Catalogs.ПростойСотрудников> ПростойСотрудников { get; set; }
        public DbSet<Models.Catalogs.ПростойСотрудников_Начисления> ПростойСотрудников_Начисления { get; set; }
        public DbSet<Models.Catalogs.ПростойСотрудников_НачисленияПерерасчет> ПростойСотрудников_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.ПростойСотрудников_НДФЛ> ПростойСотрудников_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.ПростойСотрудников_Показатели> ПростойСотрудников_Показатели { get; set; }
        public DbSet<Models.Catalogs.ПростойСотрудников_ПримененныеВычетыНаДетейИИмущественные> ПростойСотрудников_ПримененныеВычетыНаДетейИИмущественные { get; set; }
        public DbSet<Models.Catalogs.ПростойСотрудников_Удержания> ПростойСотрудников_Удержания { get; set; }
        public DbSet<Models.Catalogs.ПростойСотрудников_ФизическиеЛица> ПростойСотрудников_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ПростойСотрудников_РаспределениеРезультатовНачислений> ПростойСотрудников_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.ПростойСотрудников_РаспределениеРезультатовУдержаний> ПростойСотрудников_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.ПростойСотрудников_РаспределениеПоТерриториямУсловиямТруда> ПростойСотрудников_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.РаботаВВыходныеИПраздничныеДни> РаботаВВыходныеИПраздничныеДни { get; set; }
        public DbSet<Models.Catalogs.РаботаВВыходныеИПраздничныеДни_Сотрудники> РаботаВВыходныеИПраздничныеДни_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.РаботаВВыходныеИПраздничныеДни_ФизическиеЛица> РаботаВВыходныеИПраздничныеДни_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.РаботаСверхурочно> РаботаСверхурочно { get; set; }
        public DbSet<Models.Catalogs.РаботаСверхурочно_Сотрудники> РаботаСверхурочно_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.РаботаСверхурочно_ФизическиеЛица> РаботаСверхурочно_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление> РазовоеНачисление { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление_Начисления> РазовоеНачисление_Начисления { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление_НачисленияПерерасчет> РазовоеНачисление_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление_НДФЛ> РазовоеНачисление_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление_Показатели> РазовоеНачисление_Показатели { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление_Удержания> РазовоеНачисление_Удержания { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление_ФизическиеЛица> РазовоеНачисление_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление_РаспределениеРезультатовНачислений> РазовоеНачисление_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление_РаспределениеРезультатовУдержаний> РазовоеНачисление_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление_РаспределениеПоТерриториямУсловиямТруда> РазовоеНачисление_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление_ДополнительныеРеквизиты> РазовоеНачисление_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление_ВзносыФОТ> РазовоеНачисление_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.РазовоеНачисление_Взносы> РазовоеНачисление_Взносы { get; set; }
        public DbSet<Models.Catalogs.РаспределениеОсновногоЗаработка> РаспределениеОсновногоЗаработка { get; set; }
        public DbSet<Models.Catalogs.РаспределениеОсновногоЗаработка_РаспределениеОсновногоЗаработка> РаспределениеОсновногоЗаработка_РаспределениеОсновногоЗаработка { get; set; }
        public DbSet<Models.Catalogs.РасходныйКассовыйОрдер> РасходныйКассовыйОрдер { get; set; }
        public DbSet<Models.Catalogs.РасходныйКассовыйОрдер_РасшифровкаПлатежа> РасходныйКассовыйОрдер_РасшифровкаПлатежа { get; set; }
        public DbSet<Models.Catalogs.РасходныйКассовыйОрдер_ВыплатаЗаработнойПлаты> РасходныйКассовыйОрдер_ВыплатаЗаработнойПлаты { get; set; }
        public DbSet<Models.Catalogs.РасчетКоэффициентовДляЗаполненияПриложенияСВДекларацииПоПрибыли> РасчетКоэффициентовДляЗаполненияПриложенияСВДекларацииПоПрибыли { get; set; }
        public DbSet<Models.Catalogs.РасчетКоэффициентовДляЗаполненияПриложенияСВДекларацииПоПрибыли_Статьи> РасчетКоэффициентовДляЗаполненияПриложенияСВДекларацииПоПрибыли_Статьи { get; set; }
        public DbSet<Models.Catalogs.РасчетСпецстажаСотрудников> РасчетСпецстажаСотрудников { get; set; }
        public DbSet<Models.Catalogs.РасчетСпецстажаСотрудников_Спецстаж> РасчетСпецстажаСотрудников_Спецстаж { get; set; }
        public DbSet<Models.Catalogs.РасчетСпецстажаСотрудников_ФизическиеЛица> РасчетСпецстажаСотрудников_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.РасчетыПоНалогуНаПрибыль> РасчетыПоНалогуНаПрибыль { get; set; }
        public DbSet<Models.Catalogs.РасчетыПоНалогуНаПрибыль_Статьи> РасчетыПоНалогуНаПрибыль_Статьи { get; set; }
        public DbSet<Models.Catalogs.РеализацияТоваровУслуг> РеализацияТоваровУслуг { get; set; }
        public DbSet<Models.Catalogs.РеализацияТоваровУслуг_Товары> РеализацияТоваровУслуг_Товары { get; set; }
        public DbSet<Models.Catalogs.РеализацияТоваровУслуг_ВозвратнаяТара> РеализацияТоваровУслуг_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.РеализацияТоваровУслуг_Услуги> РеализацияТоваровУслуг_Услуги { get; set; }
        public DbSet<Models.Catalogs.РеализацияУслугПоПереработке> РеализацияУслугПоПереработке { get; set; }
        public DbSet<Models.Catalogs.РеализацияУслугПоПереработке_Услуги> РеализацияУслугПоПереработке_Услуги { get; set; }
        public DbSet<Models.Catalogs.РеализацияУслугПоПереработке_МатериалыЗаказчика> РеализацияУслугПоПереработке_МатериалыЗаказчика { get; set; }
        public DbSet<Models.Catalogs.РегистрацияАвансовВНалоговомУчете> РегистрацияАвансовВНалоговомУчете { get; set; }
        public DbSet<Models.Catalogs.РегистрацияАвансовВНалоговомУчете_Приобретения> РегистрацияАвансовВНалоговомУчете_Приобретения { get; set; }
        public DbSet<Models.Catalogs.РегистрацияАвансовВНалоговомУчете_Продажи> РегистрацияАвансовВНалоговомУчете_Продажи { get; set; }
        public DbSet<Models.Catalogs.РегистрацияАвансовВНалоговомУчете_Возвраты> РегистрацияАвансовВНалоговомУчете_Возвраты { get; set; }
        public DbSet<Models.Catalogs.РегистрацияВходящегоНалоговогоДокумента> РегистрацияВходящегоНалоговогоДокумента { get; set; }
        public DbSet<Models.Catalogs.РегистрацияВходящегоНалоговогоДокумента_Товары> РегистрацияВходящегоНалоговогоДокумента_Товары { get; set; }
        public DbSet<Models.Catalogs.РегистрацияПереработок> РегистрацияПереработок { get; set; }
        public DbSet<Models.Catalogs.РегистрацияПереработок_Сотрудники> РегистрацияПереработок_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.РегистрацияПереработок_ФизическиеЛица> РегистрацияПереработок_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.РегистрацияПрочихДоходов> РегистрацияПрочихДоходов { get; set; }
        public DbSet<Models.Catalogs.РегистрацияПрочихДоходов_НачисленияУдержанияВзносы> РегистрацияПрочихДоходов_НачисленияУдержанияВзносы { get; set; }
        public DbSet<Models.Catalogs.РегистрацияПрочихДоходов_НДФЛ> РегистрацияПрочихДоходов_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.РегистрацияСтоимостиПриобретенияОСПропорциональноОблагаемыхНДС> РегистрацияСтоимостиПриобретенияОСПропорциональноОблагаемыхНДС { get; set; }
        public DbSet<Models.Catalogs.РегистрацияСтоимостиПриобретенияОСПропорциональноОблагаемыхНДС_ОС> РегистрацияСтоимостиПриобретенияОСПропорциональноОблагаемыхНДС_ОС { get; set; }
        public DbSet<Models.Catalogs.РегистрУчета> РегистрУчета { get; set; }
        public DbSet<Models.Catalogs.РегламентированныйОтчет> РегламентированныйОтчет { get; set; }
        public DbSet<Models.Catalogs.Совмещение> Совмещение { get; set; }
        public DbSet<Models.Catalogs.Совмещение_ФОТСовмещаемый> Совмещение_ФОТСовмещаемый { get; set; }
        public DbSet<Models.Catalogs.Совмещение_ФОТСовмещающегоСотрудника> Совмещение_ФОТСовмещающегоСотрудника { get; set; }
        public DbSet<Models.Catalogs.Совмещение_НачисленияСотрудника> Совмещение_НачисленияСотрудника { get; set; }
        public DbSet<Models.Catalogs.Совмещение_Показатели> Совмещение_Показатели { get; set; }
        public DbSet<Models.Catalogs.Совмещение_ФизическиеЛица> Совмещение_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.Совмещение_ДополнительныеРеквизиты> Совмещение_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.СписаниеМалоценныхАктивовИзЭксплуатации> СписаниеМалоценныхАктивовИзЭксплуатации { get; set; }
        public DbSet<Models.Catalogs.СписаниеМалоценныхАктивовИзЭксплуатации_МалоценныеАктивы> СписаниеМалоценныхАктивовИзЭксплуатации_МалоценныеАктивы { get; set; }
        public DbSet<Models.Catalogs.СписаниеНМА> СписаниеНМА { get; set; }
        public DbSet<Models.Catalogs.СписаниеНМА_НМА> СписаниеНМА_НМА { get; set; }
        public DbSet<Models.Catalogs.СписаниеОС> СписаниеОС { get; set; }
        public DbSet<Models.Catalogs.СписаниеОС_ОС> СписаниеОС_ОС { get; set; }
        public DbSet<Models.Catalogs.СписаниеСРасчетногоСчета> СписаниеСРасчетногоСчета { get; set; }
        public DbSet<Models.Catalogs.СписаниеСРасчетногоСчета_ВыплатаЗаработнойПлаты> СписаниеСРасчетногоСчета_ВыплатаЗаработнойПлаты { get; set; }
        public DbSet<Models.Catalogs.СписаниеСРасчетногоСчета_РасшифровкаПлатежа> СписаниеСРасчетногоСчета_РасшифровкаПлатежа { get; set; }
        public DbSet<Models.Catalogs.СписаниеСРасчетногоСчета_ПеречислениеНалогов> СписаниеСРасчетногоСчета_ПеречислениеНалогов { get; set; }
        public DbSet<Models.Catalogs.СписаниеСРасчетногоСчета_РеквизитыКонтрагента> СписаниеСРасчетногоСчета_РеквизитыКонтрагента { get; set; }
        public DbSet<Models.Catalogs.СписаниеТоваров> СписаниеТоваров { get; set; }
        public DbSet<Models.Catalogs.СписаниеТоваров_Товары> СписаниеТоваров_Товары { get; set; }
        public DbSet<Models.Catalogs.СписаниеТоваров_ВозвратнаяТара> СписаниеТоваров_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.СписаниеТоваров_БланкиСтрогогоУчета> СписаниеТоваров_БланкиСтрогогоУчета { get; set; }
        public DbSet<Models.Catalogs.СправкаОДоходах> СправкаОДоходах { get; set; }
        public DbSet<Models.Catalogs.СправкаОДоходах_Доходы> СправкаОДоходах_Доходы { get; set; }
        public DbSet<Models.Catalogs.СторнированиеНачислений> СторнированиеНачислений { get; set; }
        public DbSet<Models.Catalogs.СторнированиеНачислений_ДоначисленияИПерерасчеты> СторнированиеНачислений_ДоначисленияИПерерасчеты { get; set; }
        public DbSet<Models.Catalogs.СторнированиеНачислений_Показатели> СторнированиеНачислений_Показатели { get; set; }
        public DbSet<Models.Catalogs.СторнированиеНачислений_Сторнировано> СторнированиеНачислений_Сторнировано { get; set; }
        public DbSet<Models.Catalogs.СторнированиеНачислений_РаспределениеРезультатовНачислений> СторнированиеНачислений_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.СторнированиеНачислений_РаспределениеПоТерриториямУсловиямТруда> СторнированиеНачислений_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.СчетНаОплатуПокупателю> СчетНаОплатуПокупателю { get; set; }
        public DbSet<Models.Catalogs.СчетНаОплатуПокупателю_Товары> СчетНаОплатуПокупателю_Товары { get; set; }
        public DbSet<Models.Catalogs.СчетНаОплатуПокупателю_ВозвратнаяТара> СчетНаОплатуПокупателю_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.СчетНаОплатуПокупателю_Услуги> СчетНаОплатуПокупателю_Услуги { get; set; }
        public DbSet<Models.Catalogs.СчетНаОплатуПоставщика> СчетНаОплатуПоставщика { get; set; }
        public DbSet<Models.Catalogs.СчетНаОплатуПоставщика_Товары> СчетНаОплатуПоставщика_Товары { get; set; }
        public DbSet<Models.Catalogs.СчетНаОплатуПоставщика_ВозвратнаяТара> СчетНаОплатуПоставщика_ВозвратнаяТара { get; set; }
        public DbSet<Models.Catalogs.СчетНаОплатуПоставщика_Услуги> СчетНаОплатуПоставщика_Услуги { get; set; }
        public DbSet<Models.Catalogs.СчетНаОплатуПоставщика_Оборудование> СчетНаОплатуПоставщика_Оборудование { get; set; }
        public DbSet<Models.Catalogs.СчетНаОплатуПоставщика_ОбъектыСтроительства> СчетНаОплатуПоставщика_ОбъектыСтроительства { get; set; }
        public DbSet<Models.Catalogs.СчетНаОплатуПоставщика_НематериальныеАктивы> СчетНаОплатуПоставщика_НематериальныеАктивы { get; set; }
        public DbSet<Models.Catalogs.ТабельУчетаРабочегоВремени> ТабельУчетаРабочегоВремени { get; set; }
        public DbSet<Models.Catalogs.ТабельУчетаРабочегоВремени_ДанныеОВремени> ТабельУчетаРабочегоВремени_ДанныеОВремени { get; set; }
        public DbSet<Models.Catalogs.ТабельУчетаРабочегоВремени_СотрудникиСИсправлениями> ТабельУчетаРабочегоВремени_СотрудникиСИсправлениями { get; set; }
        public DbSet<Models.Catalogs.ТабельУчетаРабочегоВремени_ФизическиеЛица> ТабельУчетаРабочегоВремени_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.ТребованиеНакладная> ТребованиеНакладная { get; set; }
        public DbSet<Models.Catalogs.ТребованиеНакладная_Материалы> ТребованиеНакладная_Материалы { get; set; }
        public DbSet<Models.Catalogs.ТребованиеНакладная_МатериалыЗаказчика> ТребованиеНакладная_МатериалыЗаказчика { get; set; }
        public DbSet<Models.Catalogs.Увольнение> Увольнение { get; set; }
        public DbSet<Models.Catalogs.Увольнение_ДанныеОбИндексации> Увольнение_ДанныеОбИндексации { get; set; }
        public DbSet<Models.Catalogs.Увольнение_ДополнительныеОтпуска> Увольнение_ДополнительныеОтпуска { get; set; }
        public DbSet<Models.Catalogs.Увольнение_Взносы> Увольнение_Взносы { get; set; }
        public DbSet<Models.Catalogs.Увольнение_НДФЛ> Увольнение_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.Увольнение_Начисления> Увольнение_Начисления { get; set; }
        public DbSet<Models.Catalogs.Увольнение_НачисленияПерерасчет> Увольнение_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.Увольнение_ОтработанноеВремяДляСреднегоОбщий> Увольнение_ОтработанноеВремяДляСреднегоОбщий { get; set; }
        public DbSet<Models.Catalogs.Увольнение_ПогашениеЗаймов> Увольнение_ПогашениеЗаймов { get; set; }
        public DbSet<Models.Catalogs.Увольнение_Показатели> Увольнение_Показатели { get; set; }
        public DbSet<Models.Catalogs.Увольнение_Пособия> Увольнение_Пособия { get; set; }
        public DbSet<Models.Catalogs.Увольнение_ПособияПерерасчет> Увольнение_ПособияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.Увольнение_СреднийЗаработокОбщий> Увольнение_СреднийЗаработокОбщий { get; set; }
        public DbSet<Models.Catalogs.Увольнение_Удержания> Увольнение_Удержания { get; set; }
        public DbSet<Models.Catalogs.Увольнение_РаспределениеРезультатовНачислений> Увольнение_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.Увольнение_РаспределениеРезультатовУдержаний> Увольнение_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.Увольнение_ДенежноеСодержание> Увольнение_ДенежноеСодержание { get; set; }
        public DbSet<Models.Catalogs.Увольнение_ДенежноеСодержаниеФактическиеНачисления> Увольнение_ДенежноеСодержаниеФактическиеНачисления { get; set; }
        public DbSet<Models.Catalogs.Увольнение_Льготы> Увольнение_Льготы { get; set; }
        public DbSet<Models.Catalogs.Увольнение_КадровыйРезерв> Увольнение_КадровыйРезерв { get; set; }
        public DbSet<Models.Catalogs.Увольнение_РаспределениеПоТерриториямУсловиямТруда> Увольнение_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.Увольнение_ДополнительныеРеквизиты> Увольнение_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.Увольнение_ОтработанноеВремяДляСреднегоДляВыходногоПособия> Увольнение_ОтработанноеВремяДляСреднегоДляВыходногоПособия { get; set; }
        public DbSet<Models.Catalogs.Увольнение_СреднийЗаработокДляВыходногоПособия> Увольнение_СреднийЗаработокДляВыходногоПособия { get; set; }
        public DbSet<Models.Catalogs.Увольнение_ДанныеОбИндексацииДляВыходногоПособия> Увольнение_ДанныеОбИндексацииДляВыходногоПособия { get; set; }
        public DbSet<Models.Catalogs.Увольнение_ВзносыФОТ> Увольнение_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком> УвольнениеСписком { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_Сотрудники> УвольнениеСписком_Сотрудники { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_ДанныеОбИндексации> УвольнениеСписком_ДанныеОбИндексации { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_ДополнительныеОтпуска> УвольнениеСписком_ДополнительныеОтпуска { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_Взносы> УвольнениеСписком_Взносы { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_НДФЛ> УвольнениеСписком_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_Начисления> УвольнениеСписком_Начисления { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_НачисленияПерерасчет> УвольнениеСписком_НачисленияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_ОтработанноеВремяДляСреднегоОбщий> УвольнениеСписком_ОтработанноеВремяДляСреднегоОбщий { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_ПогашениеЗаймов> УвольнениеСписком_ПогашениеЗаймов { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_Показатели> УвольнениеСписком_Показатели { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_Пособия> УвольнениеСписком_Пособия { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_ПособияПерерасчет> УвольнениеСписком_ПособияПерерасчет { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_СреднийЗаработокОбщий> УвольнениеСписком_СреднийЗаработокОбщий { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_Удержания> УвольнениеСписком_Удержания { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_РаспределениеРезультатовНачислений> УвольнениеСписком_РаспределениеРезультатовНачислений { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_РаспределениеРезультатовУдержаний> УвольнениеСписком_РаспределениеРезультатовУдержаний { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_ДенежноеСодержание> УвольнениеСписком_ДенежноеСодержание { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_ДенежноеСодержаниеФактическиеНачисления> УвольнениеСписком_ДенежноеСодержаниеФактическиеНачисления { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_Льготы> УвольнениеСписком_Льготы { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_КадровыйРезерв> УвольнениеСписком_КадровыйРезерв { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_РаспределениеПоТерриториямУсловиямТруда> УвольнениеСписком_РаспределениеПоТерриториямУсловиямТруда { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_ДополнительныеРеквизиты> УвольнениеСписком_ДополнительныеРеквизиты { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_ОтработанноеВремяДляСреднегоДляВыходногоПособия> УвольнениеСписком_ОтработанноеВремяДляСреднегоДляВыходногоПособия { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_СреднийЗаработокДляВыходногоПособия> УвольнениеСписком_СреднийЗаработокДляВыходногоПособия { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_ДанныеОбИндексацииДляВыходногоПособия> УвольнениеСписком_ДанныеОбИндексацииДляВыходногоПособия { get; set; }
        public DbSet<Models.Catalogs.УвольнениеСписком_ВзносыФОТ> УвольнениеСписком_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводНачальныхОстатковМалоценныхАктивовВЭксплуатации> УдалитьВводНачальныхОстатковМалоценныхАктивовВЭксплуатации { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводНачальныхОстатковМалоценныхАктивовВЭксплуатации_МалоценныеАктивы> УдалитьВводНачальныхОстатковМалоценныхАктивовВЭксплуатации_МалоценныеАктивы { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводНачальныхОстатковОС> УдалитьВводНачальныхОстатковОС { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводНачальныхОстатковОС_ОС> УдалитьВводНачальныхОстатковОС_ОС { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводНачальныхОстатковПоЗарплате> УдалитьВводНачальныхОстатковПоЗарплате { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводНачальныхОстатковПоЗарплате_РаботникиОрганизации> УдалитьВводНачальныхОстатковПоЗарплате_РаботникиОрганизации { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводНачальныхОстатковПоЗарплате_ОтражениеВУчете> УдалитьВводНачальныхОстатковПоЗарплате_ОтражениеВУчете { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводНачальныхОстатковПоЗарплате_Начисления> УдалитьВводНачальныхОстатковПоЗарплате_Начисления { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводНачальныхОстатковПоЗарплате_Взносы> УдалитьВводНачальныхОстатковПоЗарплате_Взносы { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводНачальныхОстатковПоЗарплате_НДФЛ> УдалитьВводНачальныхОстатковПоЗарплате_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводСведенийОБанковскихКарточкахРаботников> УдалитьВводСведенийОБанковскихКарточкахРаботников { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводСведенийОБанковскихКарточкахРаботников_РаботникиОрганизации> УдалитьВводСведенийОБанковскихКарточкахРаботников_РаботникиОрганизации { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций> УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций_ОсновныеНачисления> УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций_ОсновныеНачисления { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций_Взносы> УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций_Взносы { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций_ВзносыФОТ> УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций_НачисленияДо> УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций_НачисленияДо { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций_НачисленияПосле> УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций_НачисленияПосле { get; set; }
        public DbSet<Models.Catalogs.УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций_ПараметрыРасчетаИндексации> УдалитьВводСведенийОПлановыхНачисленияхРаботниковОрганизаций_ПараметрыРасчетаИндексации { get; set; }
        public DbSet<Models.Catalogs.УдалитьКадровоеПеремещениеОрганизаций> УдалитьКадровоеПеремещениеОрганизаций { get; set; }
        public DbSet<Models.Catalogs.УдалитьКадровоеПеремещениеОрганизаций_РаботникиОрганизации> УдалитьКадровоеПеремещениеОрганизаций_РаботникиОрганизации { get; set; }
        public DbSet<Models.Catalogs.УдалитьКадровоеПеремещениеОрганизаций_ОсновныеНачисления> УдалитьКадровоеПеремещениеОрганизаций_ОсновныеНачисления { get; set; }
        public DbSet<Models.Catalogs.УдалитьКадровоеПеремещениеОрганизаций_Взносы> УдалитьКадровоеПеремещениеОрганизаций_Взносы { get; set; }
        public DbSet<Models.Catalogs.УдалитьКадровоеПеремещениеОрганизаций_ВзносыФОТ> УдалитьКадровоеПеремещениеОрганизаций_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.УдалитьКадровоеПеремещениеОрганизаций_Удержания> УдалитьКадровоеПеремещениеОрганизаций_Удержания { get; set; }
        public DbSet<Models.Catalogs.УдалитьКадровоеПеремещениеОрганизаций_НачисленияДо> УдалитьКадровоеПеремещениеОрганизаций_НачисленияДо { get; set; }
        public DbSet<Models.Catalogs.УдалитьКадровоеПеремещениеОрганизаций_НачисленияПосле> УдалитьКадровоеПеремещениеОрганизаций_НачисленияПосле { get; set; }
        public DbSet<Models.Catalogs.УдалитьНачислениеКоммунальногоНалога> УдалитьНачислениеКоммунальногоНалога { get; set; }
        public DbSet<Models.Catalogs.УдалитьНачислениеКоммунальногоНалога_ОтражениеВУчете> УдалитьНачислениеКоммунальногоНалога_ОтражениеВУчете { get; set; }
        public DbSet<Models.Catalogs.УдалитьОтражениеЗарплатыВРеглУчете> УдалитьОтражениеЗарплатыВРеглУчете { get; set; }
        public DbSet<Models.Catalogs.УдалитьОтражениеЗарплатыВРеглУчете_РаботникиОрганизации> УдалитьОтражениеЗарплатыВРеглУчете_РаботникиОрганизации { get; set; }
        public DbSet<Models.Catalogs.УдалитьОтражениеЗарплатыВРеглУчете_ОтражениеВУчете> УдалитьОтражениеЗарплатыВРеглУчете_ОтражениеВУчете { get; set; }
        public DbSet<Models.Catalogs.УдалитьОтражениеЗарплатыВРеглУчете_Начисления> УдалитьОтражениеЗарплатыВРеглУчете_Начисления { get; set; }
        public DbSet<Models.Catalogs.УдалитьОтражениеЗарплатыВРеглУчете_Удержания> УдалитьОтражениеЗарплатыВРеглУчете_Удержания { get; set; }
        public DbSet<Models.Catalogs.УдалитьОтражениеЗарплатыВРеглУчете_Взносы> УдалитьОтражениеЗарплатыВРеглУчете_Взносы { get; set; }
        public DbSet<Models.Catalogs.УдалитьОтражениеЗарплатыВРеглУчете_ВзносыФОТ> УдалитьОтражениеЗарплатыВРеглУчете_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.УдалитьОтражениеЗарплатыВРеглУчете_НДФЛ> УдалитьОтражениеЗарплатыВРеглУчете_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.УдалитьПодтверждениеУплатыНалоговПоЗарплате> УдалитьПодтверждениеУплатыНалоговПоЗарплате { get; set; }
        public DbSet<Models.Catalogs.УдалитьПодтверждениеУплатыНалоговПоЗарплате_Начисления> УдалитьПодтверждениеУплатыНалоговПоЗарплате_Начисления { get; set; }
        public DbSet<Models.Catalogs.УдалитьПодтверждениеУплатыНалоговПоЗарплате_Взносы> УдалитьПодтверждениеУплатыНалоговПоЗарплате_Взносы { get; set; }
        public DbSet<Models.Catalogs.УдалитьПодтверждениеУплатыНалоговПоЗарплате_НДФЛ> УдалитьПодтверждениеУплатыНалоговПоЗарплате_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.УдалитьПодтверждениеУплатыНалоговПоЗарплате_РаботникиОрганизации> УдалитьПодтверждениеУплатыНалоговПоЗарплате_РаботникиОрганизации { get; set; }
        public DbSet<Models.Catalogs.УдалитьПодтверждениеУплатыНалоговПоЗарплате_ПлатежиПоВзносам> УдалитьПодтверждениеУплатыНалоговПоЗарплате_ПлатежиПоВзносам { get; set; }
        public DbSet<Models.Catalogs.УдалитьПриемНаРаботуВОрганизацию> УдалитьПриемНаРаботуВОрганизацию { get; set; }
        public DbSet<Models.Catalogs.УдалитьПриемНаРаботуВОрганизацию_РаботникиОрганизации> УдалитьПриемНаРаботуВОрганизацию_РаботникиОрганизации { get; set; }
        public DbSet<Models.Catalogs.УдалитьПриемНаРаботуВОрганизацию_ОсновныеНачисления> УдалитьПриемНаРаботуВОрганизацию_ОсновныеНачисления { get; set; }
        public DbSet<Models.Catalogs.УдалитьПриемНаРаботуВОрганизацию_Взносы> УдалитьПриемНаРаботуВОрганизацию_Взносы { get; set; }
        public DbSet<Models.Catalogs.УдалитьПриемНаРаботуВОрганизацию_ВзносыФОТ> УдалитьПриемНаРаботуВОрганизацию_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.УдалитьПриемНаРаботуВОрганизацию_Удержания> УдалитьПриемНаРаботуВОрганизацию_Удержания { get; set; }
        public DbSet<Models.Catalogs.УдалитьРемонтОС> УдалитьРемонтОС { get; set; }
        public DbSet<Models.Catalogs.УдалитьРемонтОС_ОС> УдалитьРемонтОС_ОС { get; set; }
        public DbSet<Models.Catalogs.УдалитьУвольнениеИзОрганизаций> УдалитьУвольнениеИзОрганизаций { get; set; }
        public DbSet<Models.Catalogs.УдалитьУвольнениеИзОрганизаций_РаботникиОрганизации> УдалитьУвольнениеИзОрганизаций_РаботникиОрганизации { get; set; }
        public DbSet<Models.Catalogs.УдержаниеВСчетРасчетовПоПрочимОперациям> УдержаниеВСчетРасчетовПоПрочимОперациям { get; set; }
        public DbSet<Models.Catalogs.УдержаниеВСчетРасчетовПоПрочимОперациям_Показатели> УдержаниеВСчетРасчетовПоПрочимОперациям_Показатели { get; set; }
        public DbSet<Models.Catalogs.УдержаниеПрофсоюзныхВзносов> УдержаниеПрофсоюзныхВзносов { get; set; }
        public DbSet<Models.Catalogs.УдержаниеПрофсоюзныхВзносов_Удержания> УдержаниеПрофсоюзныхВзносов_Удержания { get; set; }
        public DbSet<Models.Catalogs.УдержаниеПрофсоюзныхВзносов_Показатели> УдержаниеПрофсоюзныхВзносов_Показатели { get; set; }
        public DbSet<Models.Catalogs.УстановкаГарантийныхСроковНалоговыйУчет> УстановкаГарантийныхСроковНалоговыйУчет { get; set; }
        public DbSet<Models.Catalogs.УстановкаГарантийныхСроковНалоговыйУчет_ГарантийныеСроки> УстановкаГарантийныхСроковНалоговыйУчет_ГарантийныеСроки { get; set; }
        public DbSet<Models.Catalogs.УстановкаКоэффициентаПропорциональногоОтнесенияНДСНаКредит> УстановкаКоэффициентаПропорциональногоОтнесенияНДСНаКредит { get; set; }
        public DbSet<Models.Catalogs.УстановкаПорядкаЗакрытияПодразделений> УстановкаПорядкаЗакрытияПодразделений { get; set; }
        public DbSet<Models.Catalogs.УстановкаПорядкаЗакрытияПодразделений_ПорядокЗакрытия> УстановкаПорядкаЗакрытияПодразделений_ПорядокЗакрытия { get; set; }
        public DbSet<Models.Catalogs.УстановкаЦенНоменклатуры> УстановкаЦенНоменклатуры { get; set; }
        public DbSet<Models.Catalogs.УстановкаЦенНоменклатуры_Товары> УстановкаЦенНоменклатуры_Товары { get; set; }
        public DbSet<Models.Catalogs.УстарелоВводСведенийОбИндексированномДоходе> УстарелоВводСведенийОбИндексированномДоходе { get; set; }
        public DbSet<Models.Catalogs.УстарелоВводСведенийОбИндексированномДоходе_Работники> УстарелоВводСведенийОбИндексированномДоходе_Работники { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплаты> УстарелоВедомостьНаВыплатуЗарплаты { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплаты_РаботникиОрганизации> УстарелоВедомостьНаВыплатуЗарплаты_РаботникиОрганизации { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплаты_ПараметрыОплаты> УстарелоВедомостьНаВыплатуЗарплаты_ПараметрыОплаты { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплаты_Взносы> УстарелоВедомостьНаВыплатуЗарплаты_Взносы { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплаты_НДФЛ> УстарелоВедомостьНаВыплатуЗарплаты_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплаты_ВзносыФОТ> УстарелоВедомостьНаВыплатуЗарплаты_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплаты_УдалитьЗарплата> УстарелоВедомостьНаВыплатуЗарплаты_УдалитьЗарплата { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВБанк> УстарелоВедомостьНаВыплатуЗарплатыВБанк { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВБанк_Зарплата> УстарелоВедомостьНаВыплатуЗарплатыВБанк_Зарплата { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВБанк_ЗарплатаПодробно> УстарелоВедомостьНаВыплатуЗарплатыВБанк_ЗарплатаПодробно { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВБанк_НДФЛ> УстарелоВедомостьНаВыплатуЗарплатыВБанк_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВБанк_Взносы> УстарелоВедомостьНаВыплатуЗарплатыВБанк_Взносы { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВБанк_ВзносыФОТ> УстарелоВедомостьНаВыплатуЗарплатыВБанк_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВБанк_ФизическиеЛица> УстарелоВедомостьНаВыплатуЗарплатыВБанк_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВКассу> УстарелоВедомостьНаВыплатуЗарплатыВКассу { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВКассу_Зарплата> УстарелоВедомостьНаВыплатуЗарплатыВКассу_Зарплата { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВКассу_ЗарплатаПодробно> УстарелоВедомостьНаВыплатуЗарплатыВКассу_ЗарплатаПодробно { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВКассу_НДФЛ> УстарелоВедомостьНаВыплатуЗарплатыВКассу_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВКассу_Взносы> УстарелоВедомостьНаВыплатуЗарплатыВКассу_Взносы { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВКассу_ВзносыФОТ> УстарелоВедомостьНаВыплатуЗарплатыВКассу_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.УстарелоВедомостьНаВыплатуЗарплатыВКассу_ФизическиеЛица> УстарелоВедомостьНаВыплатуЗарплатыВКассу_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.УстарелоЗаявлениеНаПрименениеЛьготы> УстарелоЗаявлениеНаПрименениеЛьготы { get; set; }
        public DbSet<Models.Catalogs.УстарелоЗаявлениеНаПрименениеЛьготы_Работники> УстарелоЗаявлениеНаПрименениеЛьготы_Работники { get; set; }
        public DbSet<Models.Catalogs.УстарелоИзменениеПараметровРасчетаИндексации> УстарелоИзменениеПараметровРасчетаИндексации { get; set; }
        public DbSet<Models.Catalogs.УстарелоИзменениеПараметровРасчетаИндексации_НачисленияДо> УстарелоИзменениеПараметровРасчетаИндексации_НачисленияДо { get; set; }
        public DbSet<Models.Catalogs.УстарелоИзменениеПараметровРасчетаИндексации_НачисленияПосле> УстарелоИзменениеПараметровРасчетаИндексации_НачисленияПосле { get; set; }
        public DbSet<Models.Catalogs.УстарелоИзменениеПараметровРасчетаИндексацииПоДолжностям> УстарелоИзменениеПараметровРасчетаИндексацииПоДолжностям { get; set; }
        public DbSet<Models.Catalogs.УстарелоИзменениеПараметровРасчетаИндексацииПоДолжностям_ШтатныеЕдиницы> УстарелоИзменениеПараметровРасчетаИндексацииПоДолжностям_ШтатныеЕдиницы { get; set; }
        public DbSet<Models.Catalogs.УстарелоКадровыйПеревод> УстарелоКадровыйПеревод { get; set; }
        public DbSet<Models.Catalogs.УстарелоКадровыйПеревод_Начисления> УстарелоКадровыйПеревод_Начисления { get; set; }
        public DbSet<Models.Catalogs.УстарелоКадровыйПеревод_Удержания> УстарелоКадровыйПеревод_Удержания { get; set; }
        public DbSet<Models.Catalogs.УстарелоКомандировкиОрганизаций> УстарелоКомандировкиОрганизаций { get; set; }
        public DbSet<Models.Catalogs.УстарелоКомандировкиОрганизаций_РаботникиОрганизации> УстарелоКомандировкиОрганизаций_РаботникиОрганизации { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты> УстарелоНачислениеЗарплаты { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_ФизическиеЛица> УстарелоНачислениеЗарплаты_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_Начисления> УстарелоНачислениеЗарплаты_Начисления { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_Взносы> УстарелоНачислениеЗарплаты_Взносы { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_Удержания> УстарелоНачислениеЗарплаты_Удержания { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_ВзносыФОТ> УстарелоНачислениеЗарплаты_ВзносыФОТ { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_НДФЛ> УстарелоНачислениеЗарплаты_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_УДАЛИТЬОтражениеВУчете> УстарелоНачислениеЗарплаты_УДАЛИТЬОтражениеВУчете { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_УДАЛИТЬНачисленияПроводки> УстарелоНачислениеЗарплаты_УДАЛИТЬНачисленияПроводки { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_УДАЛИТЬУдержанияПроводки> УстарелоНачислениеЗарплаты_УДАЛИТЬУдержанияПроводки { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_УДАЛИТЬВзносыПроводки> УстарелоНачислениеЗарплаты_УДАЛИТЬВзносыПроводки { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_УДАЛИТЬВзносыФОТПроводки> УстарелоНачислениеЗарплаты_УДАЛИТЬВзносыФОТПроводки { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_УДАЛИТЬНДФЛПроводки> УстарелоНачислениеЗарплаты_УДАЛИТЬНДФЛПроводки { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_УпрощенныйУчет> УстарелоНачислениеЗарплаты_УпрощенныйУчет { get; set; }
        public DbSet<Models.Catalogs.УстарелоНачислениеЗарплаты_СтруктураКолонокУпрощенногоУчета> УстарелоНачислениеЗарплаты_СтруктураКолонокУпрощенногоУчета { get; set; }
        public DbSet<Models.Catalogs.УстарелоОтражениеВзаиморасчетовСКонтрагентамиВ1ДФ> УстарелоОтражениеВзаиморасчетовСКонтрагентамиВ1ДФ { get; set; }
        public DbSet<Models.Catalogs.УстарелоОтражениеВзаиморасчетовСКонтрагентамиВ1ДФ_Контрагенты> УстарелоОтражениеВзаиморасчетовСКонтрагентамиВ1ДФ_Контрагенты { get; set; }
        public DbSet<Models.Catalogs.УстарелоОтражениеВзаиморасчетовСКонтрагентамиВ1ДФ_НДФЛ> УстарелоОтражениеВзаиморасчетовСКонтрагентамиВ1ДФ_НДФЛ { get; set; }
        public DbSet<Models.Catalogs.УстарелоОтражениеЗарплатыВБухучете> УстарелоОтражениеЗарплатыВБухучете { get; set; }
        public DbSet<Models.Catalogs.УстарелоОтражениеЗарплатыВБухучете_НачисленнаяЗарплатаИВзносы> УстарелоОтражениеЗарплатыВБухучете_НачисленнаяЗарплатаИВзносы { get; set; }
        public DbSet<Models.Catalogs.УстарелоОтражениеЗарплатыВБухучете_УдержаннаяЗарплата> УстарелоОтражениеЗарплатыВБухучете_УдержаннаяЗарплата { get; set; }
        public DbSet<Models.Catalogs.УстарелоОтражениеЗарплатыВБухучете_УдержанныйЕСВ> УстарелоОтражениеЗарплатыВБухучете_УдержанныйЕСВ { get; set; }
        public DbSet<Models.Catalogs.УстарелоОтражениеЗарплатыВБухучете_УдержанныйНДФЛ> УстарелоОтражениеЗарплатыВБухучете_УдержанныйНДФЛ { get; set; }
        public DbSet<Models.Catalogs.УстарелоОтражениеЗарплатыВБухучете_ФизическиеЛица> УстарелоОтражениеЗарплатыВБухучете_ФизическиеЛица { get; set; }
        public DbSet<Models.Catalogs.УстарелоОтражениеЗарплатыВУчете> УстарелоОтражениеЗарплатыВУчете { get; set; }
        public DbSet<Models.Catalogs.УстарелоОтражениеЗарплатыВУчете_ОтражениеВУчете> УстарелоОтражениеЗарплатыВУчете_ОтражениеВУчете { get; set; }
        public DbSet<Models.Catalogs.УстарелоПриемНаРаботу> УстарелоПриемНаРаботу { get; set; }
        public DbSet<Models.Catalogs.УстарелоПриемНаРаботу_Начисления> УстарелоПриемНаРаботу_Начисления { get; set; }
        public DbSet<Models.Catalogs.УстарелоПриемНаРаботу_Удержания> УстарелоПриемНаРаботу_Удержания { get; set; }
        public DbSet<Models.Catalogs.УстарелоСписаниеДепонентовВДоходыОрганизаций> УстарелоСписаниеДепонентовВДоходыОрганизаций { get; set; }
        public DbSet<Models.Catalogs.УстарелоСписаниеДепонентовВДоходыОрганизаций_Работники> УстарелоСписаниеДепонентовВДоходыОрганизаций_Работники { get; set; }
        public DbSet<Models.Catalogs.УстарелоСправкаОДоходах> УстарелоСправкаОДоходах { get; set; }
        public DbSet<Models.Catalogs.УстарелоСправкаОДоходах_Доходы> УстарелоСправкаОДоходах_Доходы { get; set; }
        public DbSet<Models.Catalogs.УстарелоУвольнение> УстарелоУвольнение { get; set; }
        public DbSet<Models.Catalogs.УтверждениеТарифнойСетки> УтверждениеТарифнойСетки { get; set; }
        public DbSet<Models.Catalogs.УтверждениеТарифнойСетки_Тарифы> УтверждениеТарифнойСетки_Тарифы { get; set; }
        public DbSet<Models.Catalogs.УтверждениеТарифнойСетки_УдалитьНачисленияСотрудников> УтверждениеТарифнойСетки_УдалитьНачисленияСотрудников { get; set; }
        public DbSet<Models.Catalogs.УтверждениеТарифнойСетки_УдалитьПоказатели> УтверждениеТарифнойСетки_УдалитьПоказатели { get; set; }
        public DbSet<Models.Catalogs.УтверждениеТарифнойСетки_УдалитьШтатноеРасписание> УтверждениеТарифнойСетки_УдалитьШтатноеРасписание { get; set; }
        public DbSet<Models.Catalogs.УтверждениеТарифнойСетки_УдалитьПересчетТарифныхСтавок> УтверждениеТарифнойСетки_УдалитьПересчетТарифныхСтавок { get; set; }
        public DbSet<Models.Catalogs.УтверждениеШтатногоРасписания> УтверждениеШтатногоРасписания { get; set; }
        public DbSet<Models.Catalogs.УтверждениеШтатногоРасписания_Позиции> УтверждениеШтатногоРасписания_Позиции { get; set; }
        public DbSet<Models.Catalogs.УтверждениеШтатногоРасписания_Начисления> УтверждениеШтатногоРасписания_Начисления { get; set; }
        public DbSet<Models.Catalogs.УтверждениеШтатногоРасписания_Показатели> УтверждениеШтатногоРасписания_Показатели { get; set; }
        public DbSet<Models.Catalogs.УтверждениеШтатногоРасписания_ЕжегодныеОтпуска> УтверждениеШтатногоРасписания_ЕжегодныеОтпуска { get; set; }
        public DbSet<Models.Catalogs.УтверждениеШтатногоРасписания_Специальности> УтверждениеШтатногоРасписания_Специальности { get; set; }
