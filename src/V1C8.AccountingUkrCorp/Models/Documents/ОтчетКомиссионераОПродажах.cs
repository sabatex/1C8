...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Documents
{
    ...
    public class ОтчетКомиссионераОПродажах:DocumentItem
    {
        ...
        public Documents.ПлатежныйОрдерСписаниеДенежныхСредств СделкаПоПриобретению {get; set;}
        [Description1C8(Name = "СделкаПоРеализации", Comment = "", Synonym = "Документ расчетов по реализации")]
        public Documents.ПлатежныйОрдерСписаниеДенежныхСредств СделкаПоРеализации {get; set;}
