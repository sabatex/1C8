...
{
    [Table("PryzPodarokPrysoedynennyeFaily")]
    [Description1C8(Name = "ПризПодарокПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Приз, подарок)")]
    public class ПризПодарокПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.ПризПодарок ВладелецФайла {get; set;}
        ...
        public List<ПризПодарокПрисоединенныеФайлы_ЭлектронныеПодписи> ПризПодарокПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<ПризПодарокПрисоединенныеФайлы_СертификатыШифрования> ПризПодарокПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("PryzPodarokPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class ПризПодарокПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("PryzPodarokPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class ПризПодарокПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
