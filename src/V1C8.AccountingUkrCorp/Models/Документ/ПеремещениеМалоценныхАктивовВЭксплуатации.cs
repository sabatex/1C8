...
{
    [Table("PeremeshchenyeMalotsennykhAktyvovVЕkspluatatsyy")]
    [Description1C8(Name = "ПеремещениеМалоценныхАктивовВЭксплуатации", Comment = "(Общ)", Synonym = "Перемещение малоценных активов в эксплуатации")]
    public class ПеремещениеМалоценныхАктивовВЭксплуатации:DocumentItem
    {
        #region реквізити
        ...
        [Description1C8(Name = "ФизЛицоКуда", Comment = "(Общ)", Synonym = "МОЛ (кому передается)")]
        public Catalogs.ФизическиеЛица ФизЛицоКуда {get; set;}
        ...
        public List<ПеремещениеМалоценныхАктивовВЭксплуатации_МалоценныеАктивы> ПеремещениеМалоценныхАктивовВЭксплуатацииМалоценныеАктивы {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "МалоценныеАктивы", Comment = "(Общ)", Synonym = "Малоценные активы")]
    [Table("PeremeshchenyeMalotsennykhAktyvovVЕkspluatatsyy_MalotsennyeAktyvy")]
    public class ПеремещениеМалоценныхАктивовВЭксплуатации_МалоценныеАктивы
    {
        ...
        public Документ.ПередачаМалоценныхАктивовВЭксплуатацию ПартияМалоценныхАктивовВЭксплуатации {get; set;}
        [Description1C8(Name = "НазначениеИспользованияНовое", Comment = "", Synonym = "Назначение использования новое")]
        public Catalogs.НазначенияИспользования НазначениеИспользованияНовое {get; set;}
