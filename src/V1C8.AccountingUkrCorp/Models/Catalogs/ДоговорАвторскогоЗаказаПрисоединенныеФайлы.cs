...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class ДоговорАвторскогоЗаказаПрисоединенныеФайлы:CatalogItem
    {
        ...
        public Documents.ДоговорАвторскогоЗаказа ВладелецФайла {get; set;}
        ...
        public List<ДоговорАвторскогоЗаказаПрисоединенныеФайлы_ЭлектронныеПодписи> ДоговорАвторскогоЗаказаПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<ДоговорАвторскогоЗаказаПрисоединенныеФайлы_СертификатыШифрования> ДоговорАвторскогоЗаказаПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("DohovorAvtorskohoZakazaPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class ДоговорАвторскогоЗаказаПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("DohovorAvtorskohoZakazaPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class ДоговорАвторскогоЗаказаПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
