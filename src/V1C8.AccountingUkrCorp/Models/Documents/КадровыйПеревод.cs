...
{
    [Table("KadrovyiPerevod")]
    [Description1C8(Name = "КадровыйПеревод", Comment = "", Synonym = "Кадровый перевод")]
    public class КадровыйПеревод:DocumentItem
    {
        #region реквізити
        ...
        public Documents.КадровыйПеревод ИсправленныйДокумент {get; set;}
        ...
        public List<КадровыйПеревод_Начисления> КадровыйПереводНачисления {get;set;}
        [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
        public List<КадровыйПеревод_Показатели> КадровыйПереводПоказатели {get;set;}
        [Description1C8(Name = "ЕжегодныеОтпуска", Comment = "", Synonym = "Ежегодные отпуска")]
        public List<КадровыйПеревод_ЕжегодныеОтпуска> КадровыйПереводЕжегодныеОтпуска {get;set;}
        [Description1C8(Name = "Льготы", Comment = "", Synonym = "Льготы")]
        public List<КадровыйПеревод_Льготы> КадровыйПереводЛьготы {get;set;}
        [Description1C8(Name = "КадровыйРезерв", Comment = "", Synonym = "Кадровый резерв")]
        public List<КадровыйПеревод_КадровыйРезерв> КадровыйПереводКадровыйРезерв {get;set;}
        [Description1C8(Name = "ДополнительныеРеквизиты", Comment = "", Synonym = "Дополнительные реквизиты")]
        public List<КадровыйПеревод_ДополнительныеРеквизиты> КадровыйПереводДополнительныеРеквизиты {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "Начисления", Comment = "", Synonym = "Начисления")]
    [Table("KadrovyiPerevod_Nachyslenyia")]
    public class КадровыйПеревод_Начисления
    {
    ...
    [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
    [Table("KadrovyiPerevod_Pokazately")]
    public class КадровыйПеревод_Показатели
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтрокиВидаРасчета", Comment = "", Synonym = "Идентификатор строки вида расчета")]
    ...
    [Description1C8(Name = "ЕжегодныеОтпуска", Comment = "", Synonym = "Ежегодные отпуска")]
    [Table("KadrovyiPerevod_EzhehodnyeOtpuska")]
    public class КадровыйПеревод_ЕжегодныеОтпуска
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Действие", Comment = "", Synonym = "Действие")]
    ...
    [Description1C8(Name = "Льготы", Comment = "", Synonym = "Льготы")]
    [Table("KadrovyiPerevod_Lhoty")]
    public class КадровыйПеревод_Льготы
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "КадровыйРезерв", Comment = "", Synonym = "Кадровый резерв")]
    [Table("KadrovyiPerevod_KadrovyiRezerv")]
    public class КадровыйПеревод_КадровыйРезерв
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "ДополнительныеРеквизиты", Comment = "", Synonym = "Дополнительные реквизиты")]
    [Table("KadrovyiPerevod_DopolnytelnyeRekvyzyty")]
    public class КадровыйПеревод_ДополнительныеРеквизиты
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
