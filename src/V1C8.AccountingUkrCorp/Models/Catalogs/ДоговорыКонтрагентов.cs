...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class ДоговорыКонтрагентов:CatalogItem
    {
        ...
        public List<ДоговорыКонтрагентов_ДополнительныеРеквизиты> ДоговорыКонтрагентовДополнительныеРеквизиты {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ДополнительныеРеквизиты", Comment = "", Synonym = "Дополнительные реквизиты")]
    [Table("DohovoryKontrahentov_DopolnytelnyeRekvyzyty")]
    public class ДоговорыКонтрагентов_ДополнительныеРеквизиты
    {
