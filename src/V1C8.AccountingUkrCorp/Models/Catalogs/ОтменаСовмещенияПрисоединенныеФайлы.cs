...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public List<ОтменаСовмещенияПрисоединенныеФайлы_ЭлектронныеПодписи> ОтменаСовмещенияПрисоединенныеФайлыЭлектронныеПодписи
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    public List<ОтменаСовмещенияПрисоединенныеФайлы_СертификатыШифрования> ОтменаСовмещенияПрисоединенныеФайлыСертификатыШифрования
    #endregion tables
    }
}
