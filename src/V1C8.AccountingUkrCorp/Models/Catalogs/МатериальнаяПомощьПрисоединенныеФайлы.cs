...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public List<МатериальнаяПомощьПрисоединенныеФайлы_ЭлектронныеПодписи> МатериальнаяПомощьПрисоединенныеФайлыЭлектронныеПодписи
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    public List<МатериальнаяПомощьПрисоединенныеФайлы_СертификатыШифрования> МатериальнаяПомощьПрисоединенныеФайлыСертификатыШифрования
    #endregion tables
    }
}
