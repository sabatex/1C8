...
{
    [Table("BolnychnyiLystPrysoedynennyeFaily")]
    [Description1C8(Name = "БольничныйЛистПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Больничный лист)")]
    public class БольничныйЛистПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.БольничныйЛист ВладелецФайла {get; set;}
        ...
        public List<БольничныйЛистПрисоединенныеФайлы_ЭлектронныеПодписи> БольничныйЛистПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<БольничныйЛистПрисоединенныеФайлы_СертификатыШифрования> БольничныйЛистПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("BolnychnyiLystPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class БольничныйЛистПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("BolnychnyiLystPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class БольничныйЛистПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
