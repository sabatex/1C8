...
{
    [Table("OplataPoSrednemuZarabotkuPrysoedynennyeFaily")]
    [Description1C8(Name = "ОплатаПоСреднемуЗаработкуПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Отсутствие с сохранением оплаты)")]
    public class ОплатаПоСреднемуЗаработкуПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.ОплатаПоСреднемуЗаработку ВладелецФайла {get; set;}
        ...
        public List<ОплатаПоСреднемуЗаработкуПрисоединенныеФайлы_ЭлектронныеПодписи> ОплатаПоСреднемуЗаработкуПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<ОплатаПоСреднемуЗаработкуПрисоединенныеФайлы_СертификатыШифрования> ОплатаПоСреднемуЗаработкуПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("OplataPoSrednemuZarabotkuPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class ОплатаПоСреднемуЗаработкуПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("OplataPoSrednemuZarabotkuPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class ОплатаПоСреднемуЗаработкуПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
