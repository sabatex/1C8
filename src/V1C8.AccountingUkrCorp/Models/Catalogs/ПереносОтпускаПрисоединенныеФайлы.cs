...
{
    [Table("PerenosOtpuskaPrysoedynennyeFaily")]
    [Description1C8(Name = "ПереносОтпускаПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Перенос отпуска)")]
    public class ПереносОтпускаПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.ПереносОтпуска ВладелецФайла {get; set;}
        ...
        public List<ПереносОтпускаПрисоединенныеФайлы_ЭлектронныеПодписи> ПереносОтпускаПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<ПереносОтпускаПрисоединенныеФайлы_СертификатыШифрования> ПереносОтпускаПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("PerenosOtpuskaPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class ПереносОтпускаПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("PerenosOtpuskaPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class ПереносОтпускаПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
