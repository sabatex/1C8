...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Enums
{
    ...
    public enum ВидыОперацийСписаниеБезналичныхДенежныхСредств
    {
        ...
        ОплатаПоставщику,
        [Description1C8(Name = "ВозвратДенежныхСредствПокупателю", Comment = "(Общ)", Synonym = "Возврат денежных средств покупателю")]
        ...
        ПеречислениеНалога,
        [Description1C8(Name = "РасчетыПоКредитамИЗаймам", Comment = "", Synonym = "Расчеты по кредитам и займам с контрагентами")]
        ...
        ПереводНаДругойСчет,
        [Description1C8(Name = "ПеречислениеДенежныхСредствПодотчетнику", Comment = "(Общ)", Synonym = "Перечисление денежных средств подотчетнику")]
        ...
        ПеречислениеЗП,
        [Description1C8(Name = "ПрочееСписаниеБезналичныхДенежныхСредств", Comment = "", Synonym = "Прочее списание безналичных денежных средств")]
