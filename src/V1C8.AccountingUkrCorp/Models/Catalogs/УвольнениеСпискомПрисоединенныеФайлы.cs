...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class УвольнениеСпискомПрисоединенныеФайлы:CatalogItem
    {
        ...
        public Documents.УвольнениеСписком ВладелецФайла {get; set;}
        ...
        public List<УвольнениеСпискомПрисоединенныеФайлы_ЭлектронныеПодписи> УвольнениеСпискомПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<УвольнениеСпискомПрисоединенныеФайлы_СертификатыШифрования> УвольнениеСпискомПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("UvolnenyeSpyskomPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class УвольнениеСпискомПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("UvolnenyeSpyskomPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class УвольнениеСпискомПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
