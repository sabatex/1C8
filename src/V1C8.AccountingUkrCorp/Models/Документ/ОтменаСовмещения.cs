...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class ОтменаСовмещения:CatalogItem
    {
        #region реквізити
        ...
        public Документ.Совмещение ДокументОснование {get; set;}
        ...
        public Документ.ОтменаСовмещения ИсправленныйДокумент {get; set;}
