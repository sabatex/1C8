...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Documents
{
    ...
    public class НалоговаяНакладная:DocumentItem
    {
        #region реквізити
        ...
        public Documents.СписаниеОС ДокументОснование {get; set;}
        ...
        public Documents.СписаниеОС ДокументВводаНаОсновании {get; set;}
        ...
        public Documents.НалоговаяНакладная НалоговаяДляРезерваНомераПриПродажаНижеОбычнойЦены {get; set;}
        ...
        public Documents.НалоговаяНакладная ОсновнаяНалоговаяПриРезервеНомераПриПродажаНижеОбычнойЦены {get; set;}
    ...
    public class НалоговаяНакладная_Товары
    {
        ...
        public Documents.НалоговаяНакладная ОсновнаяНН {get; set;}
