...
{
    [Table("PodtverzhdenyeZachyslenyiaZarplatyPrysoedynennyeFaily")]
    [Description1C8(Name = "ПодтверждениеЗачисленияЗарплатыПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Подтверждение зачисления зарплаты)")]
    public class ПодтверждениеЗачисленияЗарплатыПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.ПодтверждениеЗачисленияЗарплаты ВладелецФайла {get; set;}
        ...
        public List<ПодтверждениеЗачисленияЗарплатыПрисоединенныеФайлы_ЭлектронныеПодписи> ПодтверждениеЗачисленияЗарплатыПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<ПодтверждениеЗачисленияЗарплатыПрисоединенныеФайлы_СертификатыШифрования> ПодтверждениеЗачисленияЗарплатыПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
