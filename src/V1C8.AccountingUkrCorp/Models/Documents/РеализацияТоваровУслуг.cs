...
{
    [Table("RealyzatsyiaTovarovUsluh")]
    [Description1C8(Name = "РеализацияТоваровУслуг", Comment = "", Synonym = "Реализация товаров и услуг")]
    public class РеализацияТоваровУслуг:DocumentItem
    {
        #region реквізити
        [Description1C8(Name = "ВидОперации", Comment = "", Synonym = "Вид операции")]
        public Enums.ВидыОперацийРеализацияТоваров ВидОперации {get; set;}
        ...
        [Description1C8(Name = "БанковскийСчетОрганизации", Comment = "", Synonym = "Банковский счет организации")]
        public Catalogs.БанковскиеСчета БанковскийСчетОрганизации {get; set;}
        ...
        [Description1C8(Name = "ДоверенностьСерия", Comment = "", Synonym = "Серия доверенности")]
        [StringLength(3)]
        public string ДоверенностьСерия {get; set;}
        [Description1C8(Name = "РучнаяКорректировка", Comment = "", Synonym = "Ручная корректировка")]
        public bool РучнаяКорректировка {get; set;}
        [Description1C8(Name = "ДоверенностьНомер", Comment = "", Synonym = "Номер доверенности")]
        [StringLength(11)]
        ...
        [Description1C8(Name = "ДоверенностьДата", Comment = "", Synonym = "Дата доверенности")]
        ...
        public List<РеализацияТоваровУслуг_Товары> РеализацияТоваровУслугТовары {get;set;}
        [Description1C8(Name = "ВозвратнаяТара", Comment = "", Synonym = "Возвратная тара")]
        public List<РеализацияТоваровУслуг_ВозвратнаяТара> РеализацияТоваровУслугВозвратнаяТара {get;set;}
        [Description1C8(Name = "Услуги", Comment = "", Synonym = "Услуги")]
        public List<РеализацияТоваровУслуг_Услуги> РеализацияТоваровУслугУслуги {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "Товары", Comment = "", Synonym = "Товары")]
    [Table("RealyzatsyiaTovarovUsluh_Tovary")]
    public class РеализацияТоваровУслуг_Товары
    {
        ...
        public Documents.ОтчетПроизводстваЗаСмену ДокументОприходования {get; set;}
        [Description1C8(Name = "Себестоимость", Comment = "", Synonym = "Сумма списания")]
        // Format 15.2
        public decimal Себестоимость {get; set;}
        [Description1C8(Name = "СебестоимостьНУ", Comment = "", Synonym = "Сумма списания НУ")]
        // Format 15.2
    ...
    [Description1C8(Name = "ВозвратнаяТара", Comment = "", Synonym = "Возвратная тара")]
    [Table("RealyzatsyiaTovarovUsluh_VozvratnaiaTara")]
    public class РеализацияТоваровУслуг_ВозвратнаяТара
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Номенклатура", Comment = "", Synonym = "Номенклатура")]
    ...
    [Description1C8(Name = "Услуги", Comment = "", Synonym = "Услуги")]
    [Table("RealyzatsyiaTovarovUsluh_Usluhy")]
    public class РеализацияТоваровУслуг_Услуги
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Номенклатура", Comment = "", Synonym = "Номенклатура")]
