...
namespace sabatex.V1C8.AccountingUkrCorp.PostgreSQLDbContext
{
    public class V1C8DbContext:DbContext
    {
        ...
        public DbSet<Models.Enums.АвансовыйОтчетПрисоединенныеФайлы> АвансовыйОтчетПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.АктОбОказанииПроизводственныхУслугПрисоединенныеФайлы> АктОбОказанииПроизводственныхУслугПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.АктПриемкиВыполненныхРаботОказанныхУслугПрисоединенныеФайлы> АктПриемкиВыполненныхРаботОказанныхУслугПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.АктСверкиВзаиморасчетовПрисоединенныеФайлы> АктСверкиВзаиморасчетовПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.Банки> Банки { get; set; }
        public DbSet<Models.Enums.БанковскиеСчета> БанковскиеСчета { get; set; }
        public DbSet<Models.Enums.БиологическиеАктивы> БиологическиеАктивы { get; set; }
        public DbSet<Models.Enums.БольничныйЛистПрисоединенныеФайлы> БольничныйЛистПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.Валюты> Валюты { get; set; }
        public DbSet<Models.Enums.ВариантыОтчетов> ВариантыОтчетов { get; set; }
        public DbSet<Models.Enums.ВедомостьНаВыплатуЗарплатыВБанкПрисоединенныеФайлы> ВедомостьНаВыплатуЗарплатыВБанкПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ВерсииРасширений> ВерсииРасширений { get; set; }
        public DbSet<Models.Enums.ВерсииФайлов> ВерсииФайлов { get; set; }
        public DbSet<Models.Enums.ВидыВзаиморасчетов> ВидыВзаиморасчетов { get; set; }
        public DbSet<Models.Enums.ВидыВыплатБывшимСотрудникам> ВидыВыплатБывшимСотрудникам { get; set; }
        public DbSet<Models.Enums.ВидыДоговоровАвторскогоЗаказа> ВидыДоговоровАвторскогоЗаказа { get; set; }
        public DbSet<Models.Enums.ВидыДоговоровПоГК> ВидыДоговоровПоГК { get; set; }
        public DbSet<Models.Enums.ВидыДокументовВводДанныхДляРасчетаЗарплаты> ВидыДокументовВводДанныхДляРасчетаЗарплаты { get; set; }
        public DbSet<Models.Enums.ВидыДокументовОбОбразовании> ВидыДокументовОбОбразовании { get; set; }
        public DbSet<Models.Enums.ВидыДокументовФизическихЛиц> ВидыДокументовФизическихЛиц { get; set; }
        public DbSet<Models.Enums.ВидыДоходовНДФЛ> ВидыДоходовНДФЛ { get; set; }
        public DbSet<Models.Enums.ВидыИспользованияРабочегоВремени> ВидыИспользованияРабочегоВремени { get; set; }
        public DbSet<Models.Enums.ВидыКонтактнойИнформации> ВидыКонтактнойИнформации { get; set; }
        public DbSet<Models.Enums.ВидыЛьготПоНДФЛ> ВидыЛьготПоНДФЛ { get; set; }
        public DbSet<Models.Enums.ВидыНалоговойДеятельности> ВидыНалоговойДеятельности { get; set; }
        public DbSet<Models.Enums.ВидыОбразованияФизическихЛиц> ВидыОбразованияФизическихЛиц { get; set; }
        public DbSet<Models.Enums.ВидыОперацийРасчетаЗарплаты> ВидыОперацийРасчетаЗарплаты { get; set; }
        public DbSet<Models.Enums.ВидыОплатОрганизаций> ВидыОплатОрганизаций { get; set; }
        public DbSet<Models.Enums.ВидыОтпусков> ВидыОтпусков { get; set; }
        public DbSet<Models.Enums.ВидыПрочихДоходовФизическихЛиц> ВидыПрочихДоходовФизическихЛиц { get; set; }
        public DbSet<Models.Enums.ВидыРаботСотрудников> ВидыРаботСотрудников { get; set; }
        public DbSet<Models.Enums.ВидыРегистровУчета> ВидыРегистровУчета { get; set; }
        public DbSet<Models.Enums.ВидыСтажа> ВидыСтажа { get; set; }
        public DbSet<Models.Enums.ВнешниеКомпоненты> ВнешниеКомпоненты { get; set; }
        public DbSet<Models.Enums.ВнешниеПользователи> ВнешниеПользователи { get; set; }
        public DbSet<Models.Enums.Военкоматы> Военкоматы { get; set; }
        public DbSet<Models.Enums.ВозвратИзОтпускаПоУходуЗаРебенкомПрисоединенныеФайлы> ВозвратИзОтпускаПоУходуЗаРебенкомПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ВозвратТоваровОтПокупателяПрисоединенныеФайлы> ВозвратТоваровОтПокупателяПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ВозвратТоваровПоставщикуПрисоединенныеФайлы> ВозвратТоваровПоставщикуПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.Гарантии> Гарантии { get; set; }
        public DbSet<Models.Enums.ГодовыеГрафикиАмортизацииОС> ГодовыеГрафикиАмортизацииОС { get; set; }
        public DbSet<Models.Enums.ГрафикиРаботыСотрудников> ГрафикиРаботыСотрудников { get; set; }
        public DbSet<Models.Enums.ГруппыВнешнихПользователей> ГруппыВнешнихПользователей { get; set; }
        public DbSet<Models.Enums.ГруппыДоступа> ГруппыДоступа { get; set; }
        public DbSet<Models.Enums.ГруппыДоступаФизическихЛиц> ГруппыДоступаФизическихЛиц { get; set; }
        public DbSet<Models.Enums.ГруппыПользователей> ГруппыПользователей { get; set; }
        public DbSet<Models.Enums.ГруппыСотрудников> ГруппыСотрудников { get; set; }
        public DbSet<Models.Enums.ГруппыУчетаНачисленийИУдержаний> ГруппыУчетаНачисленийИУдержаний { get; set; }
        public DbSet<Models.Enums.ГТДИмпортПрисоединенныеФайлы> ГТДИмпортПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ДепонированиеЗарплатыПрисоединенныеФайлы> ДепонированиеЗарплатыПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ДоговорАвторскогоЗаказаПрисоединенныеФайлы> ДоговорАвторскогоЗаказаПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ДоговорЗаймаСотрудникуПрисоединенныеФайлы> ДоговорЗаймаСотрудникуПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ДоговорРаботыУслугиПрисоединенныеФайлы> ДоговорРаботыУслугиПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ДоговорыКонтрагентов> ДоговорыКонтрагентов { get; set; }
        public DbSet<Models.Enums.ДоговорыКонтрагентовПрисоединенныеФайлы> ДоговорыКонтрагентовПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.Должности> Должности { get; set; }
        public DbSet<Models.Enums.ДополнительныеГарантииВСодействииТрудоустройству> ДополнительныеГарантииВСодействииТрудоустройству { get; set; }
        public DbSet<Models.Enums.ДополнительныеОбработчикиОчередиЗаданий> ДополнительныеОбработчикиОчередиЗаданий { get; set; }
        public DbSet<Models.Enums.ДополнительныеОтчетыИОбработки> ДополнительныеОтчетыИОбработки { get; set; }
        public DbSet<Models.Enums.ДоходыБудущихПериодов> ДоходыБудущихПериодов { get; set; }
        public DbSet<Models.Enums.ЗарплатныеПроекты> ЗарплатныеПроекты { get; set; }
        public DbSet<Models.Enums.ЗаявкаНаЗакрытиеЛицевыхСчетовСотрудниковПрисоединенныеФайлы> ЗаявкаНаЗакрытиеЛицевыхСчетовСотрудниковПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ЗаявкаНаОткрытиеЛицевыхСчетовСотрудниковПрисоединенныеФайлы> ЗаявкаНаОткрытиеЛицевыхСчетовСотрудниковПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ЗванияГражданскогоВоинскогоУчета> ЗванияГражданскогоВоинскогоУчета { get; set; }
        public DbSet<Models.Enums.ЗначенияСвойствОбъектов> ЗначенияСвойствОбъектов { get; set; }
        public DbSet<Models.Enums.ЗначенияСвойствОбъектовИерархия> ЗначенияСвойствОбъектовИерархия { get; set; }
        public DbSet<Models.Enums.ИдентификаторыОбъектовМетаданных> ИдентификаторыОбъектовМетаданных { get; set; }
        public DbSet<Models.Enums.ИдентификаторыОбъектовРасширений> ИдентификаторыОбъектовРасширений { get; set; }
        public DbSet<Models.Enums.ИдентификаторыСервисовСопровождения> ИдентификаторыСервисовСопровождения { get; set; }
        public DbSet<Models.Enums.ИзменениеКвалификационногоРазрядаПрисоединенныеФайлы> ИзменениеКвалификационногоРазрядаПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ИзменениеУсловийДоговораЗаймаСотрудникуПрисоединенныеФайлы> ИзменениеУсловийДоговораЗаймаСотрудникуПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенкомПрисоединенныеФайлы> ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенкомПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ИнвентаризацияТоваровНаСкладеПрисоединенныеФайлы> ИнвентаризацияТоваровНаСкладеПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ИнформационныеСсылкиДляФорм> ИнформационныеСсылкиДляФорм { get; set; }
        public DbSet<Models.Enums.КадровыйПереводПрисоединенныеФайлы> КадровыйПереводПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.КадровыйПереводСпискомПрисоединенныеФайлы> КадровыйПереводСпискомПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.Календари> Календари { get; set; }
        public DbSet<Models.Enums.КатегорииДолжностей> КатегорииДолжностей { get; set; }
        public DbSet<Models.Enums.КатегорииЗастрахованныхЛицЕСВ> КатегорииЗастрахованныхЛицЕСВ { get; set; }
        public DbSet<Models.Enums.КлассификаторЕдиницИзмерения> КлассификаторЕдиницИзмерения { get; set; }
        public DbSet<Models.Enums.КлассификаторКОАТУУ> КлассификаторКОАТУУ { get; set; }
        public DbSet<Models.Enums.КлассификаторСпециальностейПоОбразованию> КлассификаторСпециальностейПоОбразованию { get; set; }
        public DbSet<Models.Enums.КлассификаторУКТВЭД> КлассификаторУКТВЭД { get; set; }
        public DbSet<Models.Enums.КлючевыеОперации> КлючевыеОперации { get; set; }
        public DbSet<Models.Enums.КлючиДоступа> КлючиДоступа { get; set; }
        public DbSet<Models.Enums.КомандировкаПрисоединенныеФайлы> КомандировкаПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.Комиссии> Комиссии { get; set; }
        public DbSet<Models.Enums.КонтактныеЛица> КонтактныеЛица { get; set; }
        public DbSet<Models.Enums.Контрагенты> Контрагенты { get; set; }
        public DbSet<Models.Enums.КонтрактныеОбязательства> КонтрактныеОбязательства { get; set; }
        public DbSet<Models.Enums.КорректировкаДолгаПрисоединенныеФайлы> КорректировкаДолгаПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.МатериальнаяПомощьПрисоединенныеФайлы> МатериальнаяПомощьПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.МестаРаботы> МестаРаботы { get; set; }
        public DbSet<Models.Enums.НаборыГруппДоступа> НаборыГруппДоступа { get; set; }
        public DbSet<Models.Enums.НаборыДополнительныхРеквизитовИСведений> НаборыДополнительныхРеквизитовИСведений { get; set; }
        public DbSet<Models.Enums.НаборыСтатейНалоговыхДеклараций> НаборыСтатейНалоговыхДеклараций { get; set; }
        public DbSet<Models.Enums.Награды> Награды { get; set; }
        public DbSet<Models.Enums.НазначениеЦелевыхСредств> НазначениеЦелевыхСредств { get; set; }
        public DbSet<Models.Enums.НазначенияИспользования> НазначенияИспользования { get; set; }
        public DbSet<Models.Enums.НазначенияНаличныхДенежныхСредств> НазначенияНаличныхДенежныхСредств { get; set; }
        public DbSet<Models.Enums.Налоги> Налоги { get; set; }
        public DbSet<Models.Enums.НалоговаяНакладнаяПрисоединенныеФайлы> НалоговаяНакладнаяПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.НалоговыеГруппыОсновныхСредств> НалоговыеГруппыОсновныхСредств { get; set; }
        public DbSet<Models.Enums.НалоговыеИнспекции> НалоговыеИнспекции { get; set; }
        public DbSet<Models.Enums.НалоговыеНазначенияАктивовИЗатрат> НалоговыеНазначенияАктивовИЗатрат { get; set; }
        public DbSet<Models.Enums.НематериальныеАктивы> НематериальныеАктивы { get; set; }
        public DbSet<Models.Enums.Номенклатура> Номенклатура { get; set; }
        public DbSet<Models.Enums.НоменклатураГТД> НоменклатураГТД { get; set; }
        public DbSet<Models.Enums.НоменклатурныеГруппы> НоменклатурныеГруппы { get; set; }
        public DbSet<Models.Enums.НомераГТД> НомераГТД { get; set; }
        public DbSet<Models.Enums.ОбособленныеПодразделенияОрганизаций> ОбособленныеПодразделенияОрганизаций { get; set; }
        public DbSet<Models.Enums.ОбразованиеФизическихЛиц> ОбразованиеФизическихЛиц { get; set; }
        public DbSet<Models.Enums.ОбщиеВнешниеКомпоненты> ОбщиеВнешниеКомпоненты { get; set; }
        public DbSet<Models.Enums.ОбщиеДанныеИнформационногоЦентра> ОбщиеДанныеИнформационногоЦентра { get; set; }
        public DbSet<Models.Enums.ОбъектыСтроительства> ОбъектыСтроительства { get; set; }
        public DbSet<Models.Enums.ОперацияБухПрисоединенныеФайлы> ОперацияБухПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ОплатаПоСреднемуЗаработкуПрисоединенныеФайлы> ОплатаПоСреднемуЗаработкуПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.Организации> Организации { get; set; }
        public DbSet<Models.Enums.ОрганизацииПрисоединенныеФайлы> ОрганизацииПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ОснованияЗаключенияСрочныхТрудовыхДоговоров> ОснованияЗаключенияСрочныхТрудовыхДоговоров { get; set; }
        public DbSet<Models.Enums.ОснованияСпециальногоСтажа> ОснованияСпециальногоСтажа { get; set; }
        public DbSet<Models.Enums.ОснованияУвольнения> ОснованияУвольнения { get; set; }
        public DbSet<Models.Enums.ОсновныеСредства> ОсновныеСредства { get; set; }
        public DbSet<Models.Enums.ОтменаСовмещенияПрисоединенныеФайлы> ОтменаСовмещенияПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ОтпускБезСохраненияОплатыПрисоединенныеФайлы> ОтпускБезСохраненияОплатыПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ОтпускПоУходуЗаРебенкомПрисоединенныеФайлы> ОтпускПоУходуЗаРебенкомПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ОтпускПрисоединенныеФайлы> ОтпускПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ОтчетКомиссионераОПродажахПрисоединенныеФайлы> ОтчетКомиссионераОПродажахПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ОтчетКомитентуОПродажахПрисоединенныеФайлы> ОтчетКомитентуОПродажахПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ОчередьЗаданий> ОчередьЗаданий { get; set; }
        public DbSet<Models.Enums.ОчередьЗаданийОбластейДанных> ОчередьЗаданийОбластейДанных { get; set; }
        public DbSet<Models.Enums.ПапкиФайлов> ПапкиФайлов { get; set; }
        public DbSet<Models.Enums.ПараметрыВыработкиОС> ПараметрыВыработкиОС { get; set; }
        public DbSet<Models.Enums.ПараметрыСинхронизацииV77> ПараметрыСинхронизацииV77 { get; set; }
        public DbSet<Models.Enums.ПараметрыТиповойОперации> ПараметрыТиповойОперации { get; set; }
        public DbSet<Models.Enums.ПереводКДругомуРаботодателюПрисоединенныеФайлы> ПереводКДругомуРаботодателюПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПередачаТоваровПрисоединенныеФайлы> ПередачаТоваровПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПеремещениеВДругоеПодразделениеПрисоединенныеФайлы> ПеремещениеВДругоеПодразделениеПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПереносОтпускаПрисоединенныеФайлы> ПереносОтпускаПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПереченьДолжностейДляБронированияГраждан> ПереченьДолжностейДляБронированияГраждан { get; set; }
        public DbSet<Models.Enums.ПлатежноеПоручениеПрисоединенныеФайлы> ПлатежноеПоручениеПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПодразделенияОрганизаций> ПодразделенияОрганизаций { get; set; }
        public DbSet<Models.Enums.ПодтверждениеЗачисленияЗарплатыПрисоединенныеФайлы> ПодтверждениеЗачисленияЗарплатыПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПодтверждениеОткрытияЛицевыхСчетовСотрудниковПрисоединенныеФайлы> ПодтверждениеОткрытияЛицевыхСчетовСотрудниковПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПоказателиРасчетаЗарплаты> ПоказателиРасчетаЗарплаты { get; set; }
        public DbSet<Models.Enums.ПолныеПутиКФормам> ПолныеПутиКФормам { get; set; }
        public DbSet<Models.Enums.Пользователи> Пользователи { get; set; }
        public DbSet<Models.Enums.ПользовательскиеНастройкиОтчетов> ПользовательскиеНастройкиОтчетов { get; set; }
        public DbSet<Models.Enums.ПоставляемыеДанные> ПоставляемыеДанные { get; set; }
        public DbSet<Models.Enums.ПоставляемыеДополнительныеОтчетыИОбработки> ПоставляемыеДополнительныеОтчетыИОбработки { get; set; }
        public DbSet<Models.Enums.ПоставляемыеРасширения> ПоставляемыеРасширения { get; set; }
        public DbSet<Models.Enums.ПоставщикиУслугСервиса> ПоставщикиУслугСервиса { get; set; }
        public DbSet<Models.Enums.ПоступлениеДопРасходовПрисоединенныеФайлы> ПоступлениеДопРасходовПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПоступлениеНаРасчетныйСчетПрисоединенныеФайлы> ПоступлениеНаРасчетныйСчетПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПоступлениеТоваровУслугПрисоединенныеФайлы> ПоступлениеТоваровУслугПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПредопределенныеВариантыОтчетов> ПредопределенныеВариантыОтчетов { get; set; }
        public DbSet<Models.Enums.ПредопределенныеВариантыОтчетовРасширений> ПредопределенныеВариантыОтчетовРасширений { get; set; }
        public DbSet<Models.Enums.ПриемНаРаботуПрисоединенныеФайлы> ПриемНаРаботуПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПриемНаРаботуСпискомПрисоединенныеФайлы> ПриемНаРаботуСпискомПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПризПодарокПрисоединенныеФайлы> ПризПодарокПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.Приложение2КНалоговойНакладнойПрисоединенныеФайлы> Приложение2КНалоговойНакладнойПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПриходныйКассовыйОрдерПрисоединенныеФайлы> ПриходныйКассовыйОрдерПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПричиныСписанияОС> ПричиныСписанияОС { get; set; }
        public DbSet<Models.Enums.ПрограммыЭлектроннойПодписиИШифрования> ПрограммыЭлектроннойПодписиИШифрования { get; set; }
        public DbSet<Models.Enums.ПроизводственныеКалендари> ПроизводственныеКалендари { get; set; }
        public DbSet<Models.Enums.ПростойСотрудниковПрисоединенныеФайлы> ПростойСотрудниковПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ПрофессииРабочих> ПрофессииРабочих { get; set; }
        public DbSet<Models.Enums.ПрофилиГруппДоступа> ПрофилиГруппДоступа { get; set; }
        public DbSet<Models.Enums.ПрофилиКлючевыхОпераций> ПрофилиКлючевыхОпераций { get; set; }
        public DbSet<Models.Enums.ПрочиеНеоборотныеАктивы> ПрочиеНеоборотныеАктивы { get; set; }
        public DbSet<Models.Enums.РаботаВВыходныеИПраздничныеДниПрисоединенныеФайлы> РаботаВВыходныеИПраздничныеДниПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.РаботаСверхурочноПрисоединенныеФайлы> РаботаСверхурочноПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.Работодатели> Работодатели { get; set; }
        public DbSet<Models.Enums.РазрядыКатегорииДолжностей> РазрядыКатегорииДолжностей { get; set; }
        public DbSet<Models.Enums.РассылкиОтчетов> РассылкиОтчетов { get; set; }
        public DbSet<Models.Enums.РасходныйКассовыйОрдерПрисоединенныеФайлы> РасходныйКассовыйОрдерПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.РасходыБудущихПериодов> РасходыБудущихПериодов { get; set; }
        public DbSet<Models.Enums.РеализацияТоваровУслугПрисоединенныеФайлы> РеализацияТоваровУслугПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.РеализацияУслугПоПереработкеПрисоединенныеФайлы> РеализацияУслугПоПереработкеПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.РегистрацияВходящегоНалоговогоДокументаПрисоединенныеФайлы> РегистрацияВходящегоНалоговогоДокументаПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.РегистрацияПрочихДоходовПрисоединенныеФайлы> РегистрацияПрочихДоходовПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.РегистрУчетаПрисоединенныеФайлы> РегистрУчетаПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.РегламентированныеОтчеты> РегламентированныеОтчеты { get; set; }
        public DbSet<Models.Enums.Резервы> Резервы { get; set; }
        public DbSet<Models.Enums.РодственникиФизическихЛиц> РодственникиФизическихЛиц { get; set; }
        public DbSet<Models.Enums.РолиКонтактныхЛиц> РолиКонтактныхЛиц { get; set; }
        public DbSet<Models.Enums.СертификатыКлючейЭлектроннойПодписиИШифрования> СертификатыКлючейЭлектроннойПодписиИШифрования { get; set; }
        public DbSet<Models.Enums.Склады> Склады { get; set; }
        public DbSet<Models.Enums.СобытияОС> СобытияОС { get; set; }
        public DbSet<Models.Enums.СовмещениеПрисоединенныеФайлы> СовмещениеПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.СообщенияОбластейДанных> СообщенияОбластейДанных { get; set; }
        public DbSet<Models.Enums.СообщенияСистемы> СообщенияСистемы { get; set; }
        public DbSet<Models.Enums.СоставыВоеннослужащих> СоставыВоеннослужащих { get; set; }
        public DbSet<Models.Enums.СостояниеВБраке> СостояниеВБраке { get; set; }
        public DbSet<Models.Enums.Сотрудники> Сотрудники { get; set; }
        public DbSet<Models.Enums.СпецификацииНоменклатуры> СпецификацииНоменклатуры { get; set; }
        public DbSet<Models.Enums.СписаниеСРасчетногоСчетаПрисоединенныеФайлы> СписаниеСРасчетногоСчетаПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.СписокСтатейЗатратВключенныхВБазуРаспределенияКосвенныхРасходов> СписокСтатейЗатратВключенныхВБазуРаспределенияКосвенныхРасходов { get; set; }
        public DbSet<Models.Enums.СпособыВыплатыЗарплаты> СпособыВыплатыЗарплаты { get; set; }
        public DbSet<Models.Enums.СпособыОкругленияПриРасчетеЗарплаты> СпособыОкругленияПриРасчетеЗарплаты { get; set; }
        public DbSet<Models.Enums.СпособыОтраженияЗарплатыВБухУчете> СпособыОтраженияЗарплатыВБухУчете { get; set; }
        public DbSet<Models.Enums.СпособыОтраженияРасходовПоАмортизации> СпособыОтраженияРасходовПоАмортизации { get; set; }
        public DbSet<Models.Enums.СтатьиДвиженияДенежныхСредств> СтатьиДвиженияДенежныхСредств { get; set; }
        public DbSet<Models.Enums.СтатьиДоходов> СтатьиДоходов { get; set; }
        public DbSet<Models.Enums.СтатьиЗатрат> СтатьиЗатрат { get; set; }
        public DbSet<Models.Enums.СтатьиНалоговыхДеклараций> СтатьиНалоговыхДеклараций { get; set; }
        public DbSet<Models.Enums.СтатьиНеоперационныхРасходов> СтатьиНеоперационныхРасходов { get; set; }
        public DbSet<Models.Enums.СтатьиОтсроченныхНалоговыхАктивовИОбязательств> СтатьиОтсроченныхНалоговыхАктивовИОбязательств { get; set; }
        public DbSet<Models.Enums.СтатьиРасходовЗарплата> СтатьиРасходовЗарплата { get; set; }
        public DbSet<Models.Enums.СтатьиФинансированияЗарплата> СтатьиФинансированияЗарплата { get; set; }
        public DbSet<Models.Enums.СтепениЗнанияЯзыка> СтепениЗнанияЯзыка { get; set; }
        public DbSet<Models.Enums.СтепениРодстваФизическихЛиц> СтепениРодстваФизическихЛиц { get; set; }
        public DbSet<Models.Enums.СтраныМира> СтраныМира { get; set; }
        public DbSet<Models.Enums.СтруктураПредприятия> СтруктураПредприятия { get; set; }
        public DbSet<Models.Enums.Субконто> Субконто { get; set; }
        public DbSet<Models.Enums.СхемыНалоговогоУчетаПоДоговорамКонтрагентов> СхемыНалоговогоУчетаПоДоговорамКонтрагентов { get; set; }
        public DbSet<Models.Enums.СхемыНалогообложения> СхемыНалогообложения { get; set; }
        public DbSet<Models.Enums.СхемыРеализации> СхемыРеализации { get; set; }
        public DbSet<Models.Enums.СценарииОбменовДанными> СценарииОбменовДанными { get; set; }
        public DbSet<Models.Enums.СчетНаОплатуПокупателюПрисоединенныеФайлы> СчетНаОплатуПокупателюПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.СчетНаОплатуПоставщикаПрисоединенныеФайлы> СчетНаОплатуПоставщикаПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.ТарифныеСетки> ТарифныеСетки { get; set; }
        public DbSet<Models.Enums.ТарифыПлатежныхАгентов> ТарифыПлатежныхАгентов { get; set; }
        public DbSet<Models.Enums.ТерриторииВыполненияРабот> ТерриторииВыполненияРабот { get; set; }
        public DbSet<Models.Enums.ТиповыеОперации> ТиповыеОперации { get; set; }
        public DbSet<Models.Enums.ТипыИнформацииИнформационногоЦентра> ТипыИнформацииИнформационногоЦентра { get; set; }
        public DbSet<Models.Enums.ТипыЦенНоменклатуры> ТипыЦенНоменклатуры { get; set; }
        public DbSet<Models.Enums.ТомаХраненияФайлов> ТомаХраненияФайлов { get; set; }
        public DbSet<Models.Enums.УвольнениеПрисоединенныеФайлы> УвольнениеПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.УвольнениеСпискомПрисоединенныеФайлы> УвольнениеСпискомПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.УдалитьВидыКонтактнойИнформации> УдалитьВидыКонтактнойИнформации { get; set; }
        public DbSet<Models.Enums.УдалитьВнешниеОбработки> УдалитьВнешниеОбработки { get; set; }
        public DbSet<Models.Enums.УдалитьДокументыУдостоверяющиеЛичность> УдалитьДокументыУдостоверяющиеЛичность { get; set; }
        public DbSet<Models.Enums.УдалитьЗначенияСвойствОбъектов> УдалитьЗначенияСвойствОбъектов { get; set; }
        public DbSet<Models.Enums.УдалитьНастройкиВыполненияОбмена> УдалитьНастройкиВыполненияОбмена { get; set; }
        public DbSet<Models.Enums.УдалитьНастройкиОбменаДанными> УдалитьНастройкиОбменаДанными { get; set; }
        public DbSet<Models.Enums.УсловияТруда> УсловияТруда { get; set; }
        public DbSet<Models.Enums.УслугиСервиса> УслугиСервиса { get; set; }
        public DbSet<Models.Enums.УстарелоВедомостьНаВыплатуЗарплатыВБанкПрисоединенныеФайлы> УстарелоВедомостьНаВыплатуЗарплатыВБанкПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.УстарелоВедомостьНаВыплатуЗарплатыВКассуПрисоединенныеФайлы> УстарелоВедомостьНаВыплатуЗарплатыВКассуПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.УстарелоВидыВыплат> УстарелоВидыВыплат { get; set; }
        public DbSet<Models.Enums.УстарелоВидыДоходовНДФЛ> УстарелоВидыДоходовНДФЛ { get; set; }
        public DbSet<Models.Enums.УстарелоВидыЛьготПоНДФЛ> УстарелоВидыЛьготПоНДФЛ { get; set; }
        public DbSet<Models.Enums.УстарелоДолжности> УстарелоДолжности { get; set; }
        public DbSet<Models.Enums.УстарелоЗарплатныеПроекты> УстарелоЗарплатныеПроекты { get; set; }
        public DbSet<Models.Enums.УстарелоКадровыйПереводПрисоединенныеФайлы> УстарелоКадровыйПереводПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.УстарелоНачислениеЗарплатыПрисоединенныеФайлы> УстарелоНачислениеЗарплатыПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.УстарелоОснованияУвольнения> УстарелоОснованияУвольнения { get; set; }
        public DbSet<Models.Enums.УстарелоОтражениеЗарплатыВБухучетеПрисоединенныеФайлы> УстарелоОтражениеЗарплатыВБухучетеПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.УстарелоПриемНаРаботуПрисоединенныеФайлы> УстарелоПриемНаРаботуПрисоединенныеФайлы { get; set; }
        public DbSet<Models.Enums.УстарелоСпособыОкругленияПриВыплатеЗарплаты> УстарелоСпособыОкругленияПриВыплатеЗарплаты { get; set; }
        public DbSet<Models.Enums.УстарелоСпособыОтраженияЗарплатыВРеглУчете> УстарелоСпособыОтраженияЗарплатыВРеглУчете { get; set; }
        public DbSet<Models.Enums.УстарелоСтепениРодстваФизЛиц> УстарелоСтепениРодстваФизЛиц { get; set; }
        public DbSet<Models.Enums.УчебныеЗаведения> УчебныеЗаведения { get; set; }
        public DbSet<Models.Enums.УченыеЗвания> УченыеЗвания { get; set; }
        public DbSet<Models.Enums.УченыеСтепени> УченыеСтепени { get; set; }
        public DbSet<Models.Enums.УчетныеЗаписиСинхронизацииФайлов> УчетныеЗаписиСинхронизацииФайлов { get; set; }
        public DbSet<Models.Enums.УчетныеЗаписиЭлектроннойПочты> УчетныеЗаписиЭлектроннойПочты { get; set; }
        public DbSet<Models.Enums.Файлы> Файлы { get; set; }
        public DbSet<Models.Enums.ФизическиеЛица> ФизическиеЛица { get; set; }
        public DbSet<Models.Enums.ФинансовыеИнвестиции> ФинансовыеИнвестиции { get; set; }
        public DbSet<Models.Enums.ЦенныеБумаги> ЦенныеБумаги { get; set; }
        public DbSet<Models.Enums.ШаблоныЗаданийОчереди> ШаблоныЗаданийОчереди { get; set; }
        public DbSet<Models.Enums.ШтатноеРасписание> ШтатноеРасписание { get; set; }
        public DbSet<Models.Enums.ЯзыкиНародовМира> ЯзыкиНародовМира { get; set; }
