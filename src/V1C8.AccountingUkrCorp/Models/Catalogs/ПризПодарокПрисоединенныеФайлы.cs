...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public List<ПризПодарокПрисоединенныеФайлы_ЭлектронныеПодписи> ПризПодарокПрисоединенныеФайлыЭлектронныеПодписи
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    public List<ПризПодарокПрисоединенныеФайлы_СертификатыШифрования> ПризПодарокПрисоединенныеФайлыСертификатыШифрования
    #endregion tables
    }
}
