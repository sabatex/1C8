...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class АктПриемкиВыполненныхРаботОказанныхУслугПрисоединенныеФайлы:CatalogItem
    {
        ...
        public Documents.АктПриемкиВыполненныхРаботОказанныхУслуг ВладелецФайла {get; set;}
        ...
        public List<АктПриемкиВыполненныхРаботОказанныхУслугПрисоединенныеФайлы_ЭлектронныеПодписи> АктПриемкиВыполненныхРаботОказанныхУслугПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<АктПриемкиВыполненныхРаботОказанныхУслугПрисоединенныеФайлы_СертификатыШифрования> АктПриемкиВыполненныхРаботОказанныхУслугПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("AktPryemkyVypolnennykhRabotOkazannykhUsluhPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class АктПриемкиВыполненныхРаботОказанныхУслугПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("AktPryemkyVypolnennykhRabotOkazannykhUsluhPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class АктПриемкиВыполненныхРаботОказанныхУслугПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
