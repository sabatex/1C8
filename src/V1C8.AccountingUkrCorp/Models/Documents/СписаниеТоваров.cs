...
{
    [Table("SpysanyeTovarov")]
    [Description1C8(Name = "СписаниеТоваров", Comment = "(Общ)", Synonym = "Списание товаров")]
    public class СписаниеТоваров:DocumentItem
    {
        #region реквізити
        [Description1C8(Name = "ВидОперации", Comment = "", Synonym = "Вид операции")]
        public Enums.ВидыОперацийСписаниеТоваров ВидОперации {get; set;}
        ...
        public Documents.ИнвентаризацияТоваровНаСкладе ИнвентаризацияТоваровНаСкладе {get; set;}
        [Description1C8(Name = "Основание", Comment = "(Общ) Основание (статья) списания", Synonym = "Основание")]
        [StringLength(250)]
        ...
        public List<СписаниеТоваров_Товары> СписаниеТоваровТовары {get;set;}
        [Description1C8(Name = "ВозвратнаяТара", Comment = "(Общ)", Synonym = "Возвратная тара")]
        public List<СписаниеТоваров_ВозвратнаяТара> СписаниеТоваровВозвратнаяТара {get;set;}
        [Description1C8(Name = "БланкиСтрогогоУчета", Comment = "(Общ)", Synonym = "Бланки строгого учета")]
        public List<СписаниеТоваров_БланкиСтрогогоУчета> СписаниеТоваровБланкиСтрогогоУчета {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "Товары", Comment = "(Общ)", Synonym = "Товары")]
    [Table("SpysanyeTovarov_Tovary")]
    public class СписаниеТоваров_Товары
    {
    ...
    [Description1C8(Name = "ВозвратнаяТара", Comment = "(Общ)", Synonym = "Возвратная тара")]
    [Table("SpysanyeTovarov_VozvratnaiaTara")]
    public class СписаниеТоваров_ВозвратнаяТара
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Номенклатура", Comment = "(Общ)", Synonym = "Номенклатура")]
    ...
    [Description1C8(Name = "БланкиСтрогогоУчета", Comment = "(Общ)", Synonym = "Бланки строгого учета")]
    [Table("SpysanyeTovarov_BlankyStrohohoUcheta")]
    public class СписаниеТоваров_БланкиСтрогогоУчета
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Номенклатура", Comment = "(Общ)", Synonym = "Номенклатура")]
