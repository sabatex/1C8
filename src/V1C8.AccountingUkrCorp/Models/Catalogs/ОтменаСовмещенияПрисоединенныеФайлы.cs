...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class ОтменаСовмещенияПрисоединенныеФайлы:CatalogItem
    {
        ...
        public Documents.ОтменаСовмещения ВладелецФайла {get; set;}
        ...
        public List<ОтменаСовмещенияПрисоединенныеФайлы_ЭлектронныеПодписи> ОтменаСовмещенияПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<ОтменаСовмещенияПрисоединенныеФайлы_СертификатыШифрования> ОтменаСовмещенияПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("OtmenaSovmeshchenyiaPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class ОтменаСовмещенияПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("OtmenaSovmeshchenyiaPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class ОтменаСовмещенияПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
