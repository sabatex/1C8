...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Documents
{
    ...
    public class ОтпускБезСохраненияОплаты:DocumentItem
    {
        ...
        [Description1C8(Name = "ЧасовОтпуска", Comment = "", Synonym = "Часов отпуска")]
        // Format 4.2
        public decimal ЧасовОтпуска {get; set;}
        ...
        public Documents.ОтпускБезСохраненияОплаты ИсправленныйДокумент {get; set;}
        ...
        public List<ОтпускБезСохраненияОплаты_Начисления> ОтпускБезСохраненияОплатыНачисления {get;set;}
        [Description1C8(Name = "НачисленияПерерасчет", Comment = "", Synonym = "Начисления перерасчет")]
        public List<ОтпускБезСохраненияОплаты_НачисленияПерерасчет> ОтпускБезСохраненияОплатыНачисленияПерерасчет {get;set;}
        [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
        public List<ОтпускБезСохраненияОплаты_Показатели> ОтпускБезСохраненияОплатыПоказатели {get;set;}
        [Description1C8(Name = "РаспределениеРезультатовНачислений", Comment = "", Synonym = "Распределение результатов начислений")]
        public List<ОтпускБезСохраненияОплаты_РаспределениеРезультатовНачислений> ОтпускБезСохраненияОплатыРаспределениеРезультатовНачислений {get;set;}
        ...
        public List<ОтпускБезСохраненияОплаты_РаспределениеПоТерриториямУсловиямТруда> ОтпускБезСохраненияОплатыРаспределениеПоТерриториямУсловиямТруда {get;set;}
        [Description1C8(Name = "ДополнительныеРеквизиты", Comment = "", Synonym = "Дополнительные реквизиты")]
        public List<ОтпускБезСохраненияОплаты_ДополнительныеРеквизиты> ОтпускБезСохраненияОплатыДополнительныеРеквизиты {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "Начисления", Comment = "", Synonym = "Начисления")]
    [Table("OtpuskBezSokhranenyiaOplaty_Nachyslenyia")]
    public class ОтпускБезСохраненияОплаты_Начисления
    {
    ...
    [Description1C8(Name = "НачисленияПерерасчет", Comment = "", Synonym = "Начисления перерасчет")]
    [Table("OtpuskBezSokhranenyiaOplaty_NachyslenyiaPereraschet")]
    public class ОтпускБезСохраненияОплаты_НачисленияПерерасчет
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Подразделение", Comment = "", Synonym = "Подразделение")]
    ...
    [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
    [Table("OtpuskBezSokhranenyiaOplaty_Pokazately")]
    public class ОтпускБезСохраненияОплаты_Показатели
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "РаспределениеРезультатовНачислений", Comment = "", Synonym = "Распределение результатов начислений")]
    [Table("OtpuskBezSokhranenyiaOplaty_RaspredelenyeRezultatovNachyslenyi")]
    public class ОтпускБезСохраненияОплаты_РаспределениеРезультатовНачислений
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "РаспределениеПоТерриториямУсловиямТруда", Comment = "", Synonym = "Распределение по территориям и условиям труда")]
    [Table("OtpuskBezSokhranenyiaOplaty_RaspredelenyePoTerrytoryiamUslovyiamTruda")]
    public class ОтпускБезСохраненияОплаты_РаспределениеПоТерриториямУсловиямТруда
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтроки", Comment = "", Synonym = "Идентификатор строки")]
    ...
    [Description1C8(Name = "ДополнительныеРеквизиты", Comment = "", Synonym = "Дополнительные реквизиты")]
    [Table("OtpuskBezSokhranenyiaOplaty_DopolnytelnyeRekvyzyty")]
    public class ОтпускБезСохраненияОплаты_ДополнительныеРеквизиты
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
