...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Documents
{
    ...
    public class МатериальнаяПомощь:DocumentItem
    {
        ...
        [Description1C8(Name = "ВидРасчета", Comment = "", Synonym = "Вид матпомощи")]
        ...
        [Description1C8(Name = "Начислено", Comment = "", Synonym = "Размер")]
        // Format 13.2
        public decimal Начислено {get; set;}
        [Description1C8(Name = "Удержано", Comment = "", Synonym = "Удержано")]
        // Format 13.2
        public decimal Удержано {get; set;}
        [Description1C8(Name = "ОснованиеВыплаты", Comment = "", Synonym = "Основание выплаты")]
        public string ОснованиеВыплаты {get; set;}
        ...
        public Documents.МатериальнаяПомощь ИсправленныйДокумент {get; set;}
        ...
        public List<МатериальнаяПомощь_Начисления> МатериальнаяПомощьНачисления {get;set;}
        [Description1C8(Name = "НачисленияПерерасчет", Comment = "", Synonym = "Начисления перерасчет")]
        public List<МатериальнаяПомощь_НачисленияПерерасчет> МатериальнаяПомощьНачисленияПерерасчет {get;set;}
        [Description1C8(Name = "НДФЛ", Comment = "", Synonym = "НДФЛ")]
        public List<МатериальнаяПомощь_НДФЛ> МатериальнаяПомощьНДФЛ {get;set;}
        [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
        public List<МатериальнаяПомощь_Показатели> МатериальнаяПомощьПоказатели {get;set;}
        [Description1C8(Name = "Удержания", Comment = "", Synonym = "Удержания")]
        public List<МатериальнаяПомощь_Удержания> МатериальнаяПомощьУдержания {get;set;}
        [Description1C8(Name = "ФизическиеЛица", Comment = "", Synonym = "Физические лица")]
        public List<МатериальнаяПомощь_ФизическиеЛица> МатериальнаяПомощьФизическиеЛица {get;set;}
        [Description1C8(Name = "РаспределениеРезультатовНачислений", Comment = "", Synonym = "Распределение результатов начислений")]
        public List<МатериальнаяПомощь_РаспределениеРезультатовНачислений> МатериальнаяПомощьРаспределениеРезультатовНачислений {get;set;}
        [Description1C8(Name = "РаспределениеРезультатовУдержаний", Comment = "", Synonym = "Распределение результатов удержаний")]
        public List<МатериальнаяПомощь_РаспределениеРезультатовУдержаний> МатериальнаяПомощьРаспределениеРезультатовУдержаний {get;set;}
        ...
        public List<МатериальнаяПомощь_РаспределениеПоТерриториямУсловиямТруда> МатериальнаяПомощьРаспределениеПоТерриториямУсловиямТруда {get;set;}
        [Description1C8(Name = "ВзносыФОТ", Comment = "", Synonym = "Взносы ФОТ")]
        public List<МатериальнаяПомощь_ВзносыФОТ> МатериальнаяПомощьВзносыФОТ {get;set;}
        [Description1C8(Name = "Взносы", Comment = "", Synonym = "Взносы")]
        public List<МатериальнаяПомощь_Взносы> МатериальнаяПомощьВзносы {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "Начисления", Comment = "", Synonym = "Начисления")]
    [Table("MateryalnaiaPomoshch_Nachyslenyia")]
    public class МатериальнаяПомощь_Начисления
    {
    ...
    [Description1C8(Name = "НачисленияПерерасчет", Comment = "", Synonym = "Начисления перерасчет")]
    [Table("MateryalnaiaPomoshch_NachyslenyiaPereraschet")]
    public class МатериальнаяПомощь_НачисленияПерерасчет
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Подразделение", Comment = "", Synonym = "Подразделение")]
    ...
    [Description1C8(Name = "НДФЛ", Comment = "", Synonym = "НДФЛ")]
    [Table("MateryalnaiaPomoshch_NDFL")]
    public class МатериальнаяПомощь_НДФЛ
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
    [Table("MateryalnaiaPomoshch_Pokazately")]
    public class МатериальнаяПомощь_Показатели
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "Удержания", Comment = "", Synonym = "Удержания")]
    [Table("MateryalnaiaPomoshch_Uderzhanyia")]
    public class МатериальнаяПомощь_Удержания
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "ФизическиеЛица", Comment = "", Synonym = "Физические лица")]
    [Table("MateryalnaiaPomoshch_FyzycheskyeLytsa")]
    public class МатериальнаяПомощь_ФизическиеЛица
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "РаспределениеРезультатовНачислений", Comment = "", Synonym = "Распределение результатов начислений")]
    [Table("MateryalnaiaPomoshch_RaspredelenyeRezultatovNachyslenyi")]
    public class МатериальнаяПомощь_РаспределениеРезультатовНачислений
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "РаспределениеРезультатовУдержаний", Comment = "", Synonym = "Распределение результатов удержаний")]
    [Table("MateryalnaiaPomoshch_RaspredelenyeRezultatovUderzhanyi")]
    public class МатериальнаяПомощь_РаспределениеРезультатовУдержаний
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтроки", Comment = "", Synonym = "Идентификатор строки")]
    ...
    [Description1C8(Name = "РаспределениеПоТерриториямУсловиямТруда", Comment = "", Synonym = "Распределение по территориям и условиям труда")]
    [Table("MateryalnaiaPomoshch_RaspredelenyePoTerrytoryiamUslovyiamTruda")]
    public class МатериальнаяПомощь_РаспределениеПоТерриториямУсловиямТруда
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтроки", Comment = "", Synonym = "Идентификатор строки")]
    ...
    [Description1C8(Name = "ВзносыФОТ", Comment = "", Synonym = "Взносы ФОТ")]
    [Table("MateryalnaiaPomoshch_VznosyFOT")]
    public class МатериальнаяПомощь_ВзносыФОТ
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "Взносы", Comment = "", Synonym = "Взносы")]
    [Table("MateryalnaiaPomoshch_Vznosy")]
    public class МатериальнаяПомощь_Взносы
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Сотрудник")]
