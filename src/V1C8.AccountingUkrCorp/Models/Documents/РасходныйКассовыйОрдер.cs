...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Documents
{
    ...
    public class РасходныйКассовыйОрдер:DocumentItem
    {
        #region реквізити
        ...
        public Documents.ВедомостьНаВыплатуЗарплатыВКассу ПлатежнаяВедомость {get; set;}
        ...
        public Documents.ДоговорЗаймаСотруднику ДоговорЗаймаСотруднику {get; set;}
        #endregion реквізити
        #region tables
    ...
    public class РасходныйКассовыйОрдер_ВыплатаЗаработнойПлаты
    {
        ...
        public Documents.ВедомостьНаВыплатуЗарплатыРаздатчиком Ведомость {get; set;}
