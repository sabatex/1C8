...
{
    [Table("YnventaryzatsyiaNMA")]
    [Description1C8(Name = "ИнвентаризацияНМА", Comment = "Инвентаризация НМА", Synonym = "Инвентаризация НМА")]
    public class ИнвентаризацияНМА:DocumentItem
    {
        #region реквізити
        ...
        public List<ИнвентаризацияНМА_НематериальныеАктивы> ИнвентаризацияНМАНематериальныеАктивы {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "НематериальныеАктивы", Comment = "(Общ)", Synonym = "Нематериальные активы")]
    [Table("YnventaryzatsyiaNMA_NemateryalnyeAktyvy")]
    public class ИнвентаризацияНМА_НематериальныеАктивы
    {
