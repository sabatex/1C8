...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public List<ОтпускБезСохраненияОплатыПрисоединенныеФайлы_ЭлектронныеПодписи> ОтпускБезСохраненияОплатыПрисоединенныеФайлыЭлектронныеПодписи
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    public List<ОтпускБезСохраненияОплатыПрисоединенныеФайлы_СертификатыШифрования> ОтпускБезСохраненияОплатыПрисоединенныеФайлыСертификатыШифрования
    #endregion tables
    }
}
