...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class РаботаВВыходныеИПраздничныеДниПрисоединенныеФайлы:CatalogItem
    {
        ...
        public Documents.РаботаВВыходныеИПраздничныеДни ВладелецФайла {get; set;}
        ...
        public List<РаботаВВыходныеИПраздничныеДниПрисоединенныеФайлы_ЭлектронныеПодписи> РаботаВВыходныеИПраздничныеДниПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<РаботаВВыходныеИПраздничныеДниПрисоединенныеФайлы_СертификатыШифрования> РаботаВВыходныеИПраздничныеДниПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
