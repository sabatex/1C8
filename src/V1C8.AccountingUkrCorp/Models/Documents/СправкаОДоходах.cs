...
{
    [Table("SpravkaODokhodakh")]
    [Description1C8(Name = "СправкаОДоходах", Comment = "", Synonym = "Справка о доходах")]
    public class СправкаОДоходах:DocumentItem
    {
        #region реквізити
        ...
        public List<СправкаОДоходах_Доходы> СправкаОДоходахДоходы {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "Доходы", Comment = "", Synonym = "Доходы")]
    [Table("SpravkaODokhodakh_Dokhody")]
    public class СправкаОДоходах_Доходы
    {
