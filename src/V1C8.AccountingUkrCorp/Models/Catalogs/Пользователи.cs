...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public List<Пользователи_ДополнительныеРеквизиты> ПользователиДополнительныеРеквизиты
    [Description1C8(Name = "КонтактнаяИнформация", Comment = "", Synonym = "Контактная информация")]
    public List<Пользователи_КонтактнаяИнформация> ПользователиКонтактнаяИнформация
    #endregion tables
    }
}
