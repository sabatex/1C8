...
{
    [Table("SovmeshchenyePrysoedynennyeFaily")]
    [Description1C8(Name = "СовмещениеПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Совмещение)")]
    public class СовмещениеПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.Совмещение ВладелецФайла {get; set;}
        ...
        public List<СовмещениеПрисоединенныеФайлы_ЭлектронныеПодписи> СовмещениеПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<СовмещениеПрисоединенныеФайлы_СертификатыШифрования> СовмещениеПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("SovmeshchenyePrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class СовмещениеПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("SovmeshchenyePrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class СовмещениеПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
