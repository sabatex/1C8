...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class МатериальнаяПомощьПрисоединенныеФайлы:CatalogItem
    {
        ...
        public Documents.МатериальнаяПомощь ВладелецФайла {get; set;}
        ...
        public List<МатериальнаяПомощьПрисоединенныеФайлы_ЭлектронныеПодписи> МатериальнаяПомощьПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<МатериальнаяПомощьПрисоединенныеФайлы_СертификатыШифрования> МатериальнаяПомощьПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("MateryalnaiaPomoshchPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class МатериальнаяПомощьПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("MateryalnaiaPomoshchPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class МатериальнаяПомощьПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
