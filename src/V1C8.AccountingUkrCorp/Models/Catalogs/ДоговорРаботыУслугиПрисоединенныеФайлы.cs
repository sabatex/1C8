...
{
    [Table("DohovorRabotyUsluhyPrysoedynennyeFaily")]
    [Description1C8(Name = "ДоговорРаботыУслугиПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Договор (работы, услуги))")]
    public class ДоговорРаботыУслугиПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.ДоговорРаботыУслуги ВладелецФайла {get; set;}
        ...
        public List<ДоговорРаботыУслугиПрисоединенныеФайлы_ЭлектронныеПодписи> ДоговорРаботыУслугиПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<ДоговорРаботыУслугиПрисоединенныеФайлы_СертификатыШифрования> ДоговорРаботыУслугиПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("DohovorRabotyUsluhyPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class ДоговорРаботыУслугиПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("DohovorRabotyUsluhyPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class ДоговорРаботыУслугиПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
