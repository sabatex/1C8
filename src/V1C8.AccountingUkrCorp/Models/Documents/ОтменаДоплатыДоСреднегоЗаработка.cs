...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Documents
{
    ...
    public class ОтменаДоплатыДоСреднегоЗаработка:DocumentItem
    {
        #region реквізити
        ...
        public Documents.ПриказНаДоплатуДоСреднегоЗаработка ДокументОснование {get; set;}
        ...
        public Documents.ОтменаДоплатыДоСреднегоЗаработка ИсправленныйДокумент {get; set;}
