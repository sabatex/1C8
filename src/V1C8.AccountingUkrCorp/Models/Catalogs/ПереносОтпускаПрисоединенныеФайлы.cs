...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public List<ПереносОтпускаПрисоединенныеФайлы_ЭлектронныеПодписи> ПереносОтпускаПрисоединенныеФайлыЭлектронныеПодписи
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    public List<ПереносОтпускаПрисоединенныеФайлы_СертификатыШифрования> ПереносОтпускаПрисоединенныеФайлыСертификатыШифрования
    #endregion tables
    }
}
