...
{
    [Table("UtverzhdenyeShtatnohoRaspysanyia")]
    [Description1C8(Name = "УтверждениеШтатногоРасписания", Comment = "", Synonym = "Утверждение штатного расписания")]
    public class УтверждениеШтатногоРасписания:DocumentItem
    {
        #region реквізити
        [Description1C8(Name = "МесяцВступленияВСилу", Comment = "", Synonym = "Месяц")]
        public DateTime МесяцВступленияВСилу {get; set;}
        ...
        public List<УтверждениеШтатногоРасписания_Позиции> УтверждениеШтатногоРасписанияПозиции {get;set;}
        [Description1C8(Name = "Начисления", Comment = "", Synonym = "Начисления")]
        public List<УтверждениеШтатногоРасписания_Начисления> УтверждениеШтатногоРасписанияНачисления {get;set;}
        [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
        public List<УтверждениеШтатногоРасписания_Показатели> УтверждениеШтатногоРасписанияПоказатели {get;set;}
        [Description1C8(Name = "ЕжегодныеОтпуска", Comment = "", Synonym = "Ежегодные отпуска")]
        public List<УтверждениеШтатногоРасписания_ЕжегодныеОтпуска> УтверждениеШтатногоРасписанияЕжегодныеОтпуска {get;set;}
        [Description1C8(Name = "Специальности", Comment = "", Synonym = "Специальности")]
        public List<УтверждениеШтатногоРасписания_Специальности> УтверждениеШтатногоРасписанияСпециальности {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "Позиции", Comment = "", Synonym = "Позиции")]
    [Table("UtverzhdenyeShtatnohoRaspysanyia_Pozytsyy")]
    public class УтверждениеШтатногоРасписания_Позиции
    {
    ...
    [Description1C8(Name = "Начисления", Comment = "", Synonym = "Начисления")]
    [Table("UtverzhdenyeShtatnohoRaspysanyia_Nachyslenyia")]
    public class УтверждениеШтатногоРасписания_Начисления
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтрокиПозиции", Comment = "", Synonym = "Идентификатор строки позиции")]
    ...
    [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
    [Table("UtverzhdenyeShtatnohoRaspysanyia_Pokazately")]
    public class УтверждениеШтатногоРасписания_Показатели
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтрокиВидаРасчета", Comment = "", Synonym = "Идентификатор строки вида расчета")]
    ...
    [Description1C8(Name = "ЕжегодныеОтпуска", Comment = "", Synonym = "Ежегодные отпуска")]
    [Table("UtverzhdenyeShtatnohoRaspysanyia_EzhehodnyeOtpuska")]
    public class УтверждениеШтатногоРасписания_ЕжегодныеОтпуска
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтрокиПозиции", Comment = "", Synonym = "Идентификатор строки позиции")]
    ...
    [Description1C8(Name = "Специальности", Comment = "", Synonym = "Специальности")]
    [Table("UtverzhdenyeShtatnohoRaspysanyia_Spetsyalnosty")]
    public class УтверждениеШтатногоРасписания_Специальности
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтрокиПозиции", Comment = "", Synonym = "Идентификатор строки позиции")]
