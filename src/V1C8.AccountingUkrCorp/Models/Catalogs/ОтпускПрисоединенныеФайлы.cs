...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public List<ОтпускПрисоединенныеФайлы_ЭлектронныеПодписи> ОтпускПрисоединенныеФайлыЭлектронныеПодписи
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    public List<ОтпускПрисоединенныеФайлы_СертификатыШифрования> ОтпускПрисоединенныеФайлыСертификатыШифрования
    #endregion tables
    }
}
