...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public List<ИзменениеУсловийДоговораЗаймаСотрудникуПрисоединенныеФайлы_ЭлектронныеПодписи> ИзменениеУсловийДоговораЗаймаСотрудникуПрисоединенныеФайлыЭлектронныеПодписи
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    public List<ИзменениеУсловийДоговораЗаймаСотрудникуПрисоединенныеФайлы_СертификатыШифрования> ИзменениеУсловийДоговораЗаймаСотрудникуПрисоединенныеФайлыСертификатыШифрования
    #endregion tables
    }
}
