...
{
    [Table("DohovorZaimaSotrudnykuPrysoedynennyeFaily")]
    [Description1C8(Name = "ДоговорЗаймаСотрудникуПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Договор займа сотруднику)")]
    public class ДоговорЗаймаСотрудникуПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.ДоговорЗаймаСотруднику ВладелецФайла {get; set;}
        ...
        public List<ДоговорЗаймаСотрудникуПрисоединенныеФайлы_ЭлектронныеПодписи> ДоговорЗаймаСотрудникуПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<ДоговорЗаймаСотрудникуПрисоединенныеФайлы_СертификатыШифрования> ДоговорЗаймаСотрудникуПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("DohovorZaimaSotrudnykuPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class ДоговорЗаймаСотрудникуПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("DohovorZaimaSotrudnykuPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class ДоговорЗаймаСотрудникуПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
