...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class ПодразделенияОрганизаций:CatalogItem
    {
        ...
        public List<ПодразделенияОрганизаций_ДополнительныеРеквизиты> ПодразделенияОрганизацийДополнительныеРеквизиты {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ДополнительныеРеквизиты", Comment = "", Synonym = "Дополнительные реквизиты")]
    [Table("PodrazdelenyiaOrhanyzatsyi_DopolnytelnyeRekvyzyty")]
    public class ПодразделенияОрганизаций_ДополнительныеРеквизиты
    {
