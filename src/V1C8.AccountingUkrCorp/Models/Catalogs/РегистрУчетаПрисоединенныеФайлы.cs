...
{
    [Table("RehystrUchetaPrysoedynennyeFaily")]
    ...
    public class РегистрУчетаПрисоединенныеФайлы:CatalogItem
    {
        ...
        public List<РегистрУчетаПрисоединенныеФайлы_УдалитьЭлектронныеПодписи> РегистрУчетаПрисоединенныеФайлыУдалитьЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "УдалитьСертификатыШифрования", Comment = "", Synonym = "(не используется) Сертификаты шифрования")]
        public List<РегистрУчетаПрисоединенныеФайлы_УдалитьСертификатыШифрования> РегистрУчетаПрисоединенныеФайлыУдалитьСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "УдалитьЭлектронныеПодписи", Comment = "", Synonym = "(не используется) Электронные подписи")]
