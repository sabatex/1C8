...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Documents
{
    ...
    public class ПростойСотрудников:DocumentItem
    {
        ...
        [Description1C8(Name = "ВидПростоя", Comment = "", Synonym = "Вид простоя")]
        public Enums.СостоянияСотрудника ВидПростоя {get; set;}
        [Description1C8(Name = "УдалитьВидПростоя", Comment = "", Synonym = "Удалить вид простоя")]
        public Enums.КатегорииНачисленийИНеоплаченногоВремени УдалитьВидПростоя {get; set;}
        [Description1C8(Name = "ВнутрисменныйПростой", Comment = "", Synonym = "Внутрисменный простой")]
        public bool ВнутрисменныйПростой {get; set;}
        ...
        [Description1C8(Name = "ДатаПростоя", Comment = "", Synonym = "Дата простоя")]
        public DateTime ДатаПростоя {get; set;}
        [Description1C8(Name = "ЧасыПростоя", Comment = "", Synonym = "Часы простоя")]
        // Format 7.2
        public decimal ЧасыПростоя {get; set;}
        [Description1C8(Name = "ПричиныПростоя", Comment = "", Synonym = "Причины простоя")]
        public string ПричиныПростоя {get; set;}
        [Description1C8(Name = "НаходитьсяНаРабочихМестах", Comment = "", Synonym = "Находиться на рабочих местах")]
        public bool НаходитьсяНаРабочихМестах {get; set;}
        [Description1C8(Name = "ИсправленныйДокумент", Comment = "", Synonym = "Исправленный документ")]
        public Documents.ПростойСотрудников ИсправленныйДокумент {get; set;}
        ...
        public List<ПростойСотрудников_Начисления> ПростойСотрудниковНачисления {get;set;}
        [Description1C8(Name = "НачисленияПерерасчет", Comment = "", Synonym = "Начисления перерасчет")]
        public List<ПростойСотрудников_НачисленияПерерасчет> ПростойСотрудниковНачисленияПерерасчет {get;set;}
        [Description1C8(Name = "НДФЛ", Comment = "", Synonym = "НДФЛ")]
        public List<ПростойСотрудников_НДФЛ> ПростойСотрудниковНДФЛ {get;set;}
        [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
        public List<ПростойСотрудников_Показатели> ПростойСотрудниковПоказатели {get;set;}
        [Description1C8(Name = "ПримененныеВычетыНаДетейИИмущественные", Comment = "", Synonym = "Примененные вычеты на детей и имущественные")]
        public List<ПростойСотрудников_ПримененныеВычетыНаДетейИИмущественные> ПростойСотрудниковПримененныеВычетыНаДетейИИмущественные {get;set;}
        [Description1C8(Name = "Удержания", Comment = "", Synonym = "Удержания")]
        public List<ПростойСотрудников_Удержания> ПростойСотрудниковУдержания {get;set;}
        [Description1C8(Name = "ФизическиеЛица", Comment = "", Synonym = "Физические лица")]
        public List<ПростойСотрудников_ФизическиеЛица> ПростойСотрудниковФизическиеЛица {get;set;}
        [Description1C8(Name = "РаспределениеРезультатовНачислений", Comment = "", Synonym = "Распределение результатов начислений")]
        public List<ПростойСотрудников_РаспределениеРезультатовНачислений> ПростойСотрудниковРаспределениеРезультатовНачислений {get;set;}
        [Description1C8(Name = "РаспределениеРезультатовУдержаний", Comment = "", Synonym = "Распределение результатов удержаний")]
        public List<ПростойСотрудников_РаспределениеРезультатовУдержаний> ПростойСотрудниковРаспределениеРезультатовУдержаний {get;set;}
        ...
        public List<ПростойСотрудников_РаспределениеПоТерриториямУсловиямТруда> ПростойСотрудниковРаспределениеПоТерриториямУсловиямТруда {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "Начисления", Comment = "", Synonym = "Начисления")]
    [Table("ProstoiSotrudnykov_Nachyslenyia")]
    public class ПростойСотрудников_Начисления
    {
    ...
    [Description1C8(Name = "НачисленияПерерасчет", Comment = "", Synonym = "Начисления перерасчет")]
    [Table("ProstoiSotrudnykov_NachyslenyiaPereraschet")]
    public class ПростойСотрудников_НачисленияПерерасчет
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "НДФЛ", Comment = "", Synonym = "НДФЛ")]
    [Table("ProstoiSotrudnykov_NDFL")]
    public class ПростойСотрудников_НДФЛ
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
    [Table("ProstoiSotrudnykov_Pokazately")]
    public class ПростойСотрудников_Показатели
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "ПримененныеВычетыНаДетейИИмущественные", Comment = "", Synonym = "Примененные вычеты на детей и имущественные")]
    [Table("ProstoiSotrudnykov_PrymenennyeVychetyNaDeteiYYmushchestvennye")]
    public class ПростойСотрудников_ПримененныеВычетыНаДетейИИмущественные
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "КодВычета", Comment = "", Synonym = "Код вычета")]
    ...
    [Description1C8(Name = "Удержания", Comment = "", Synonym = "Удержания")]
    [Table("ProstoiSotrudnykov_Uderzhanyia")]
    public class ПростойСотрудников_Удержания
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "ФизическиеЛица", Comment = "", Synonym = "Физические лица")]
    [Table("ProstoiSotrudnykov_FyzycheskyeLytsa")]
    public class ПростойСотрудников_ФизическиеЛица
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "РаспределениеРезультатовНачислений", Comment = "", Synonym = "Распределение результатов начислений")]
    [Table("ProstoiSotrudnykov_RaspredelenyeRezultatovNachyslenyi")]
    public class ПростойСотрудников_РаспределениеРезультатовНачислений
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "РаспределениеРезультатовУдержаний", Comment = "", Synonym = "Распределение результатов удержаний")]
    [Table("ProstoiSotrudnykov_RaspredelenyeRezultatovUderzhanyi")]
    public class ПростойСотрудников_РаспределениеРезультатовУдержаний
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтроки", Comment = "", Synonym = "Идентификатор строки")]
    ...
    [Description1C8(Name = "РаспределениеПоТерриториямУсловиямТруда", Comment = "", Synonym = "Распределение по территориям и условиям труда")]
    [Table("ProstoiSotrudnykov_RaspredelenyePoTerrytoryiamUslovyiamTruda")]
    public class ПростойСотрудников_РаспределениеПоТерриториямУсловиямТруда
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтроки", Comment = "", Synonym = "Идентификатор строки")]
