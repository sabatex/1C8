...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Documents
{
    ...
    public class ДоходВНатуральнойФорме:DocumentItem
    {
        ...
        [Description1C8(Name = "Начисление", Comment = "", Synonym = "Вид дохода")]
        ...
        public Documents.ДоходВНатуральнойФорме ИсправленныйДокумент {get; set;}
        ...
        [Description1C8(Name = "ДолжностьИсполнителя", Comment = "", Synonym = "Должность исполнителя")]
        ...
        public List<ДоходВНатуральнойФорме_Начисления> ДоходВНатуральнойФормеНачисления {get;set;}
        [Description1C8(Name = "ФизическиеЛица", Comment = "", Synonym = "Физические лица")]
        public List<ДоходВНатуральнойФорме_ФизическиеЛица> ДоходВНатуральнойФормеФизическиеЛица {get;set;}
        [Description1C8(Name = "НачисленияПерерасчет", Comment = "", Synonym = "Начисления перерасчет")]
        public List<ДоходВНатуральнойФорме_НачисленияПерерасчет> ДоходВНатуральнойФормеНачисленияПерерасчет {get;set;}
        [Description1C8(Name = "НДФЛ", Comment = "", Synonym = "НДФЛ")]
        public List<ДоходВНатуральнойФорме_НДФЛ> ДоходВНатуральнойФормеНДФЛ {get;set;}
        [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
        public List<ДоходВНатуральнойФорме_Показатели> ДоходВНатуральнойФормеПоказатели {get;set;}
        [Description1C8(Name = "РаспределениеРезультатовНачислений", Comment = "", Synonym = "Распределение результатов начислений")]
        public List<ДоходВНатуральнойФорме_РаспределениеРезультатовНачислений> ДоходВНатуральнойФормеРаспределениеРезультатовНачислений {get;set;}
        [Description1C8(Name = "РаспределениеРезультатовУдержаний", Comment = "", Synonym = "Распределение результатов удержаний")]
        public List<ДоходВНатуральнойФорме_РаспределениеРезультатовУдержаний> ДоходВНатуральнойФормеРаспределениеРезультатовУдержаний {get;set;}
        ...
        public List<ДоходВНатуральнойФорме_РаспределениеПоТерриториямУсловиямТруда> ДоходВНатуральнойФормеРаспределениеПоТерриториямУсловиямТруда {get;set;}
        [Description1C8(Name = "ВзносыФОТ", Comment = "", Synonym = "Взносы ФОТ")]
        public List<ДоходВНатуральнойФорме_ВзносыФОТ> ДоходВНатуральнойФормеВзносыФОТ {get;set;}
        [Description1C8(Name = "Взносы", Comment = "", Synonym = "Взносы")]
        public List<ДоходВНатуральнойФорме_Взносы> ДоходВНатуральнойФормеВзносы {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "Начисления", Comment = "", Synonym = "Начисления")]
    [Table("DokhodVNaturalnoiForme_Nachyslenyia")]
    public class ДоходВНатуральнойФорме_Начисления
    {
    ...
    [Description1C8(Name = "ФизическиеЛица", Comment = "", Synonym = "Физические лица")]
    [Table("DokhodVNaturalnoiForme_FyzycheskyeLytsa")]
    public class ДоходВНатуральнойФорме_ФизическиеЛица
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "НачисленияПерерасчет", Comment = "", Synonym = "Начисления перерасчет")]
    [Table("DokhodVNaturalnoiForme_NachyslenyiaPereraschet")]
    public class ДоходВНатуральнойФорме_НачисленияПерерасчет
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "НДФЛ", Comment = "", Synonym = "НДФЛ")]
    [Table("DokhodVNaturalnoiForme_NDFL")]
    public class ДоходВНатуральнойФорме_НДФЛ
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
    [Table("DokhodVNaturalnoiForme_Pokazately")]
    public class ДоходВНатуральнойФорме_Показатели
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "РаспределениеРезультатовНачислений", Comment = "", Synonym = "Распределение результатов начислений")]
    [Table("DokhodVNaturalnoiForme_RaspredelenyeRezultatovNachyslenyi")]
    public class ДоходВНатуральнойФорме_РаспределениеРезультатовНачислений
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "РаспределениеРезультатовУдержаний", Comment = "", Synonym = "Распределение результатов удержаний")]
    [Table("DokhodVNaturalnoiForme_RaspredelenyeRezultatovUderzhanyi")]
    public class ДоходВНатуральнойФорме_РаспределениеРезультатовУдержаний
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтроки", Comment = "", Synonym = "Идентификатор строки")]
    ...
    [Description1C8(Name = "РаспределениеПоТерриториямУсловиямТруда", Comment = "", Synonym = "Распределение по территориям и условиям труда")]
    [Table("DokhodVNaturalnoiForme_RaspredelenyePoTerrytoryiamUslovyiamTruda")]
    public class ДоходВНатуральнойФорме_РаспределениеПоТерриториямУсловиямТруда
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтроки", Comment = "", Synonym = "Идентификатор строки")]
    ...
    [Description1C8(Name = "ВзносыФОТ", Comment = "", Synonym = "Взносы ФОТ")]
    [Table("DokhodVNaturalnoiForme_VznosyFOT")]
    public class ДоходВНатуральнойФорме_ВзносыФОТ
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "Взносы", Comment = "", Synonym = "Взносы")]
    [Table("DokhodVNaturalnoiForme_Vznosy")]
    public class ДоходВНатуральнойФорме_Взносы
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Сотрудник")]
