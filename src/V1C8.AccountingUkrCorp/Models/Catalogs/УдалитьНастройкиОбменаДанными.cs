...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class УдалитьНастройкиОбменаДанными:CatalogItem
    {
        ...
        public List<УдалитьНастройкиОбменаДанными_УбратьСообщенияНеЯвляющиесяОшибками> УдалитьНастройкиОбменаДаннымиУбратьСообщенияНеЯвляющиесяОшибками {get;set;}
        [Description1C8(Name = "УбратьНастройкаВариантовПоискаОбъектов", Comment = "", Synonym = "Убрать настройка вариантов поиска объектов")]
        public List<УдалитьНастройкиОбменаДанными_УбратьНастройкаВариантовПоискаОбъектов> УдалитьНастройкиОбменаДаннымиУбратьНастройкаВариантовПоискаОбъектов {get;set;}
        [Description1C8(Name = "УбратьНастройкаВыгрузкиДанных", Comment = "", Synonym = "Убрать настройка выгрузки данных")]
        public List<УдалитьНастройкиОбменаДанными_УбратьНастройкаВыгрузкиДанных> УдалитьНастройкиОбменаДаннымиУбратьНастройкаВыгрузкиДанных {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "УбратьСообщенияНеЯвляющиесяОшибками", Comment = "", Synonym = "Убрать сообщения не являющиеся ошибками")]
    ...
    public Guid Owner {get;set;}
        ...
        [Description1C8(Name = "НаименованиеПравилаОбмена", Comment = "", Synonym = "Наименование правила обмена")]
        [StringLength(150)]
        public string НаименованиеПравилаОбмена {get; set;}
        [Description1C8(Name = "ИмяНастройкиДляАлгоритма", Comment = "", Synonym = "Имя настройки для алгоритма")]
        [StringLength(150)]
        public string ИмяНастройкиДляАлгоритма {get; set;}
        [Description1C8(Name = "ИмяНастройкиДляПользователя", Comment = "", Synonym = "Имя настройки для пользователя")]
        public string ИмяНастройкиДляПользователя {get; set;}
        [Description1C8(Name = "ОписаниеНастройкиДляПользователя", Comment = "", Synonym = "Описание настройки для пользователя")]
        public string ОписаниеНастройкиДляПользователя {get; set;}
        [Description1C8(Name = "ЭтоНастройкаДляВыгрузки", Comment = "", Synonym = "Это настройка для выгрузки")]
        public bool ЭтоНастройкаДляВыгрузки {get; set;}
        [Description1C8(Name = "НастройкаНеПоддерживается", Comment = "", Synonym = "Настройка не поддерживается")]
        public bool НастройкаНеПоддерживается {get; set;}
        [Description1C8(Name = "ВариантПоискаНеПоддерживается", Comment = "", Synonym = "Вариант поиска не поддерживается")]
        public bool ВариантПоискаНеПоддерживается {get; set;}
    }
    [Description1C8(Name = "УбратьНастройкаВыгрузкиДанных", Comment = "", Synonym = "Убрать настройка выгрузки данных")]
    ...
    public Guid Owner {get;set;}
        ...
        [Description1C8(Name = "НаименованиеПравилаВыгрузки", Comment = "", Synonym = "Наименование правила выгрузки")]
        [StringLength(150)]
        public string НаименованиеПравилаВыгрузки {get; set;}
        [Description1C8(Name = "КодПравилаОбмена", Comment = "", Synonym = "Код правила обмена")]
        [StringLength(150)]
        public string КодПравилаОбмена {get; set;}
        [Description1C8(Name = "ЭтоНастройкаДляВыгрузки", Comment = "", Synonym = "Это настройка для выгрузки")]
        ...
        [Description1C8(Name = "НастройкаНеПоддерживается", Comment = "", Synonym = "Настройка не поддерживается")]
        public bool НастройкаНеПоддерживается {get; set;}
        [Description1C8(Name = "ВыгружатьДанные", Comment = "", Synonym = "Выгружать данные")]
        public bool ВыгружатьДанные {get; set;}
        [Description1C8(Name = "ВыгружатьПоСсылке", Comment = "", Synonym = "Выгружать по ссылке")]
        public bool ВыгружатьПоСсылке {get; set;}
    }
}
