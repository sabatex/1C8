...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class КомандировкаПрисоединенныеФайлы:CatalogItem
    {
        ...
        public Documents.Командировка ВладелецФайла {get; set;}
        ...
        public List<КомандировкаПрисоединенныеФайлы_ЭлектронныеПодписи> КомандировкаПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<КомандировкаПрисоединенныеФайлы_СертификатыШифрования> КомандировкаПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("KomandyrovkaPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class КомандировкаПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("KomandyrovkaPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class КомандировкаПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
