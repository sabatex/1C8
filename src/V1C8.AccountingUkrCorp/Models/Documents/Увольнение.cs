...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Documents
{
    ...
    public class Увольнение:DocumentItem
    {
        #region реквізити
        ...
        public Documents.Увольнение ИсправленныйДокумент {get; set;}
        ...
        [Description1C8(Name = "ПериодРасчетаСреднегоЗаработкаВыходногоПособияНачало", Comment = "Дата начала расчетного периода для выходного пособия", Synonym = "Период расчета среднего заработка выходного пособия начало")]
        public DateTime ПериодРасчетаСреднегоЗаработкаВыходногоПособияНачало {get; set;}
        [Description1C8(Name = "ПериодРасчетаСреднегоЗаработкаВыходногоПособияОкончание", Comment = "Дата окончания расчетного периода выходного пособия", Synonym = "Период расчета среднего заработка выходного пособия окончание")]
        public DateTime ПериодРасчетаСреднегоЗаработкаВыходногоПособияОкончание {get; set;}
        ...
        public List<Увольнение_ДанныеОбИндексации> УвольнениеДанныеОбИндексации {get;set;}
        [Description1C8(Name = "ДополнительныеОтпуска", Comment = "", Synonym = "Дополнительные отпуска")]
        public List<Увольнение_ДополнительныеОтпуска> УвольнениеДополнительныеОтпуска {get;set;}
        [Description1C8(Name = "Взносы", Comment = "", Synonym = "Взносы")]
        public List<Увольнение_Взносы> УвольнениеВзносы {get;set;}
        [Description1C8(Name = "НДФЛ", Comment = "", Synonym = "НДФЛ")]
        public List<Увольнение_НДФЛ> УвольнениеНДФЛ {get;set;}
        [Description1C8(Name = "Начисления", Comment = "", Synonym = "Начисления")]
        public List<Увольнение_Начисления> УвольнениеНачисления {get;set;}
        [Description1C8(Name = "НачисленияПерерасчет", Comment = "", Synonym = "Начисления перерасчет")]
        public List<Увольнение_НачисленияПерерасчет> УвольнениеНачисленияПерерасчет {get;set;}
        [Description1C8(Name = "ОтработанноеВремяДляСреднегоОбщий", Comment = "", Synonym = "Отработанное время для среднего общий")]
        public List<Увольнение_ОтработанноеВремяДляСреднегоОбщий> УвольнениеОтработанноеВремяДляСреднегоОбщий {get;set;}
        [Description1C8(Name = "ПогашениеЗаймов", Comment = "", Synonym = "Погашение займов")]
        public List<Увольнение_ПогашениеЗаймов> УвольнениеПогашениеЗаймов {get;set;}
        [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
        public List<Увольнение_Показатели> УвольнениеПоказатели {get;set;}
        [Description1C8(Name = "Пособия", Comment = "", Synonym = "Пособия")]
        public List<Увольнение_Пособия> УвольнениеПособия {get;set;}
        [Description1C8(Name = "ПособияПерерасчет", Comment = "", Synonym = "Пособия перерасчет")]
        public List<Увольнение_ПособияПерерасчет> УвольнениеПособияПерерасчет {get;set;}
        [Description1C8(Name = "СреднийЗаработокОбщий", Comment = "", Synonym = "Средний заработок общий")]
        public List<Увольнение_СреднийЗаработокОбщий> УвольнениеСреднийЗаработокОбщий {get;set;}
        [Description1C8(Name = "Удержания", Comment = "", Synonym = "Удержания")]
        public List<Увольнение_Удержания> УвольнениеУдержания {get;set;}
        [Description1C8(Name = "РаспределениеРезультатовНачислений", Comment = "", Synonym = "Распределение результатов начислений")]
        public List<Увольнение_РаспределениеРезультатовНачислений> УвольнениеРаспределениеРезультатовНачислений {get;set;}
        [Description1C8(Name = "РаспределениеРезультатовУдержаний", Comment = "", Synonym = "Распределение результатов удержаний")]
        public List<Увольнение_РаспределениеРезультатовУдержаний> УвольнениеРаспределениеРезультатовУдержаний {get;set;}
        [Description1C8(Name = "ДенежноеСодержание", Comment = "", Synonym = "Денежное содержание")]
        public List<Увольнение_ДенежноеСодержание> УвольнениеДенежноеСодержание {get;set;}
        [Description1C8(Name = "ДенежноеСодержаниеФактическиеНачисления", Comment = "", Synonym = "Денежное содержание фактические начисления")]
        public List<Увольнение_ДенежноеСодержаниеФактическиеНачисления> УвольнениеДенежноеСодержаниеФактическиеНачисления {get;set;}
        [Description1C8(Name = "Льготы", Comment = "", Synonym = "Льготы")]
        public List<Увольнение_Льготы> УвольнениеЛьготы {get;set;}
        [Description1C8(Name = "КадровыйРезерв", Comment = "", Synonym = "Кадровый резерв")]
        public List<Увольнение_КадровыйРезерв> УвольнениеКадровыйРезерв {get;set;}
        ...
        public List<Увольнение_РаспределениеПоТерриториямУсловиямТруда> УвольнениеРаспределениеПоТерриториямУсловиямТруда {get;set;}
        [Description1C8(Name = "ДополнительныеРеквизиты", Comment = "", Synonym = "Дополнительные реквизиты")]
        public List<Увольнение_ДополнительныеРеквизиты> УвольнениеДополнительныеРеквизиты {get;set;}
        ...
        public List<Увольнение_ОтработанноеВремяДляСреднегоДляВыходногоПособия> УвольнениеОтработанноеВремяДляСреднегоДляВыходногоПособия {get;set;}
        [Description1C8(Name = "СреднийЗаработокДляВыходногоПособия", Comment = "", Synonym = "Средний заработок для выходного пособия")]
        public List<Увольнение_СреднийЗаработокДляВыходногоПособия> УвольнениеСреднийЗаработокДляВыходногоПособия {get;set;}
        [Description1C8(Name = "ДанныеОбИндексацииДляВыходногоПособия", Comment = "", Synonym = "Данные об индексации для выходного пособия")]
        public List<Увольнение_ДанныеОбИндексацииДляВыходногоПособия> УвольнениеДанныеОбИндексацииДляВыходногоПособия {get;set;}
        [Description1C8(Name = "ВзносыФОТ", Comment = "", Synonym = "Взносы ФОТ")]
        public List<Увольнение_ВзносыФОТ> УвольнениеВзносыФОТ {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ДанныеОбИндексации", Comment = "", Synonym = "Данные об индексации")]
    [Table("Uvolnenye_DannyeObYndeksatsyy")]
    public class Увольнение_ДанныеОбИндексации
    {
    ...
    [Description1C8(Name = "ДополнительныеОтпуска", Comment = "", Synonym = "Дополнительные отпуска")]
    [Table("Uvolnenye_DopolnytelnyeOtpuska")]
    public class Увольнение_ДополнительныеОтпуска
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "Взносы", Comment = "", Synonym = "Взносы")]
    [Table("Uvolnenye_Vznosy")]
    public class Увольнение_Взносы
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "НДФЛ", Comment = "", Synonym = "НДФЛ")]
    [Table("Uvolnenye_NDFL")]
    public class Увольнение_НДФЛ
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "Начисления", Comment = "", Synonym = "Начисления")]
    [Table("Uvolnenye_Nachyslenyia")]
    public class Увольнение_Начисления
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "НачисленияПерерасчет", Comment = "", Synonym = "Начисления перерасчет")]
    [Table("Uvolnenye_NachyslenyiaPereraschet")]
    public class Увольнение_НачисленияПерерасчет
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "ОтработанноеВремяДляСреднегоОбщий", Comment = "", Synonym = "Отработанное время для среднего общий")]
    [Table("Uvolnenye_OtrabotannoeVremiaDliaSrednehoObshchyi")]
    public class Увольнение_ОтработанноеВремяДляСреднегоОбщий
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "ПогашениеЗаймов", Comment = "", Synonym = "Погашение займов")]
    [Table("Uvolnenye_PohashenyeZaimov")]
    public class Увольнение_ПогашениеЗаймов
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
    [Table("Uvolnenye_Pokazately")]
    public class Увольнение_Показатели
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "Пособия", Comment = "", Synonym = "Пособия")]
    [Table("Uvolnenye_Posobyia")]
    public class Увольнение_Пособия
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "ПособияПерерасчет", Comment = "", Synonym = "Пособия перерасчет")]
    [Table("Uvolnenye_PosobyiaPereraschet")]
    public class Увольнение_ПособияПерерасчет
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "СреднийЗаработокОбщий", Comment = "", Synonym = "Средний заработок общий")]
    [Table("Uvolnenye_SrednyiZarabotokObshchyi")]
    public class Увольнение_СреднийЗаработокОбщий
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "Удержания", Comment = "", Synonym = "Удержания")]
    [Table("Uvolnenye_Uderzhanyia")]
    public class Увольнение_Удержания
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Физическое лицо")]
    ...
    [Description1C8(Name = "РаспределениеРезультатовНачислений", Comment = "", Synonym = "Распределение результатов начислений")]
    [Table("Uvolnenye_RaspredelenyeRezultatovNachyslenyi")]
    public class Увольнение_РаспределениеРезультатовНачислений
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтроки", Comment = "", Synonym = "Идентификатор строки")]
    ...
    [Description1C8(Name = "РаспределениеРезультатовУдержаний", Comment = "", Synonym = "Распределение результатов удержаний")]
    [Table("Uvolnenye_RaspredelenyeRezultatovUderzhanyi")]
    public class Увольнение_РаспределениеРезультатовУдержаний
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтроки", Comment = "", Synonym = "Идентификатор строки")]
    ...
    [Description1C8(Name = "ДенежноеСодержание", Comment = "", Synonym = "Денежное содержание")]
    [Table("Uvolnenye_DenezhnoeSoderzhanye")]
    public class Увольнение_ДенежноеСодержание
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "ДенежноеСодержаниеФактическиеНачисления", Comment = "", Synonym = "Денежное содержание фактические начисления")]
    [Table("Uvolnenye_DenezhnoeSoderzhanyeFaktycheskyeNachyslenyia")]
    public class Увольнение_ДенежноеСодержаниеФактическиеНачисления
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "Льготы", Comment = "", Synonym = "Льготы")]
    [Table("Uvolnenye_Lhoty")]
    public class Увольнение_Льготы
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "КадровыйРезерв", Comment = "", Synonym = "Кадровый резерв")]
    [Table("Uvolnenye_KadrovyiRezerv")]
    public class Увольнение_КадровыйРезерв
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "РаспределениеПоТерриториямУсловиямТруда", Comment = "", Synonym = "Распределение по территориям и условиям труда")]
    [Table("Uvolnenye_RaspredelenyePoTerrytoryiamUslovyiamTruda")]
    public class Увольнение_РаспределениеПоТерриториямУсловиямТруда
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтроки", Comment = "", Synonym = "Идентификатор строки")]
    ...
    [Description1C8(Name = "ДополнительныеРеквизиты", Comment = "", Synonym = "Дополнительные реквизиты")]
    [Table("Uvolnenye_DopolnytelnyeRekvyzyty")]
    public class Увольнение_ДополнительныеРеквизиты
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "ОтработанноеВремяДляСреднегоДляВыходногоПособия", Comment = "", Synonym = "Отработанное время для среднего для выходного пособия")]
    [Table("Uvolnenye_OtrabotannoeVremiaDliaSrednehoDliaVykhodnohoPosobyia")]
    public class Увольнение_ОтработанноеВремяДляСреднегоДляВыходногоПособия
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "СреднийЗаработокДляВыходногоПособия", Comment = "", Synonym = "Средний заработок для выходного пособия")]
    [Table("Uvolnenye_SrednyiZarabotokDliaVykhodnohoPosobyia")]
    public class Увольнение_СреднийЗаработокДляВыходногоПособия
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "ДанныеОбИндексацииДляВыходногоПособия", Comment = "", Synonym = "Данные об индексации для выходного пособия")]
    [Table("Uvolnenye_DannyeObYndeksatsyyDliaVykhodnohoPosobyia")]
    public class Увольнение_ДанныеОбИндексацииДляВыходногоПособия
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "ВзносыФОТ", Comment = "", Synonym = "Взносы ФОТ")]
    [Table("Uvolnenye_VznosyFOT")]
    public class Увольнение_ВзносыФОТ
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Сотрудник")]
