...
{
    [Table("UvolnenyePrysoedynennyeFaily")]
    [Description1C8(Name = "УвольнениеПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Увольнение)")]
    public class УвольнениеПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.Увольнение ВладелецФайла {get; set;}
        ...
        public List<УвольнениеПрисоединенныеФайлы_ЭлектронныеПодписи> УвольнениеПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<УвольнениеПрисоединенныеФайлы_СертификатыШифрования> УвольнениеПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("UvolnenyePrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class УвольнениеПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("UvolnenyePrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class УвольнениеПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
