...
{
    [Table("KadrovyiPerevodSpyskomPrysoedynennyeFaily")]
    [Description1C8(Name = "КадровыйПереводСпискомПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Кадровый перевод списком)")]
    public class КадровыйПереводСпискомПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.КадровыйПереводСписком ВладелецФайла {get; set;}
        ...
        public List<КадровыйПереводСпискомПрисоединенныеФайлы_ЭлектронныеПодписи> КадровыйПереводСпискомПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<КадровыйПереводСпискомПрисоединенныеФайлы_СертификатыШифрования> КадровыйПереводСпискомПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("KadrovyiPerevodSpyskomPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class КадровыйПереводСпискомПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("KadrovyiPerevodSpyskomPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class КадровыйПереводСпискомПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
