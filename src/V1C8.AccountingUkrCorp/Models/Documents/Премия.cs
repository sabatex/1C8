...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Documents
{
    ...
    public class Премия:DocumentItem
    {
        #region реквізити
        ...
        [Description1C8(Name = "ВидПремии", Comment = "", Synonym = "Вид премии")]
        public ПланВидовРасчета.Начисления ВидПремии {get; set;}
        [Description1C8(Name = "ФиксБазовыйПериод", Comment = "", Synonym = "Фикс базовый период")]
        public bool ФиксБазовыйПериод {get; set;}
        ...
        [Description1C8(Name = "ДатаОкончанияБазовогоПериода", Comment = "", Synonym = "Дата окончания базового периода")]
        public DateTime ДатаОкончанияБазовогоПериода {get; set;}
        ...
        public Documents.Премия ИсправленныйДокумент {get; set;}
        ...
        public List<Премия_Начисления> ПремияНачисления {get;set;}
        [Description1C8(Name = "НачисленияПерерасчет", Comment = "", Synonym = "Начисления перерасчет")]
        public List<Премия_НачисленияПерерасчет> ПремияНачисленияПерерасчет {get;set;}
        [Description1C8(Name = "НДФЛ", Comment = "", Synonym = "НДФЛ")]
        public List<Премия_НДФЛ> ПремияНДФЛ {get;set;}
        [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
        public List<Премия_Показатели> ПремияПоказатели {get;set;}
        [Description1C8(Name = "Удержания", Comment = "", Synonym = "Удержания")]
        public List<Премия_Удержания> ПремияУдержания {get;set;}
        [Description1C8(Name = "ФизическиеЛица", Comment = "", Synonym = "Физические лица")]
        public List<Премия_ФизическиеЛица> ПремияФизическиеЛица {get;set;}
        [Description1C8(Name = "РаспределениеРезультатовНачислений", Comment = "", Synonym = "Распределение результатов начислений")]
        public List<Премия_РаспределениеРезультатовНачислений> ПремияРаспределениеРезультатовНачислений {get;set;}
        [Description1C8(Name = "РаспределениеРезультатовУдержаний", Comment = "", Synonym = "Распределение результатов удержаний")]
        public List<Премия_РаспределениеРезультатовУдержаний> ПремияРаспределениеРезультатовУдержаний {get;set;}
        ...
        public List<Премия_РаспределениеПоТерриториямУсловиямТруда> ПремияРаспределениеПоТерриториямУсловиямТруда {get;set;}
        [Description1C8(Name = "ВзносыФОТ", Comment = "", Synonym = "Взносы ФОТ")]
        public List<Премия_ВзносыФОТ> ПремияВзносыФОТ {get;set;}
        [Description1C8(Name = "Взносы", Comment = "", Synonym = "Взносы")]
        public List<Премия_Взносы> ПремияВзносы {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "Начисления", Comment = "", Synonym = "Начисления")]
    [Table("Premyia_Nachyslenyia")]
    public class Премия_Начисления
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
        public Catalogs.Сотрудники Сотрудник {get; set;}
        [Description1C8(Name = "Результат", Comment = "", Synonym = "Премия")]
        // Format 13.2
    ...
    [Description1C8(Name = "НачисленияПерерасчет", Comment = "", Synonym = "Начисления перерасчет")]
    [Table("Premyia_NachyslenyiaPereraschet")]
    public class Премия_НачисленияПерерасчет
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Подразделение", Comment = "", Synonym = "Подразделение")]
    ...
    [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
    [Table("Premyia_Pokazately")]
    public class Премия_Показатели
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "Удержания", Comment = "", Synonym = "Удержания")]
    [Table("Premyia_Uderzhanyia")]
    public class Премия_Удержания
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "ФизическиеЛица", Comment = "", Synonym = "Физические лица")]
    [Table("Premyia_FyzycheskyeLytsa")]
    public class Премия_ФизическиеЛица
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "РаспределениеРезультатовНачислений", Comment = "", Synonym = "Распределение результатов начислений")]
    [Table("Premyia_RaspredelenyeRezultatovNachyslenyi")]
    public class Премия_РаспределениеРезультатовНачислений
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
    ...
    [Description1C8(Name = "РаспределениеРезультатовУдержаний", Comment = "", Synonym = "Распределение результатов удержаний")]
    [Table("Premyia_RaspredelenyeRezultatovUderzhanyi")]
    public class Премия_РаспределениеРезультатовУдержаний
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтроки", Comment = "", Synonym = "Идентификатор строки")]
    ...
    [Description1C8(Name = "РаспределениеПоТерриториямУсловиямТруда", Comment = "", Synonym = "Распределение по территориям и условиям труда")]
    [Table("Premyia_RaspredelenyePoTerrytoryiamUslovyiamTruda")]
    public class Премия_РаспределениеПоТерриториямУсловиямТруда
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ИдентификаторСтроки", Comment = "", Synonym = "Идентификатор строки")]
    ...
    [Description1C8(Name = "ВзносыФОТ", Comment = "", Synonym = "Взносы ФОТ")]
    [Table("Premyia_VznosyFOT")]
    public class Премия_ВзносыФОТ
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "Взносы", Comment = "", Synonym = "Взносы")]
    [Table("Premyia_Vznosy")]
    public class Премия_Взносы
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "ФизическоеЛицо", Comment = "", Synonym = "Сотрудник")]
