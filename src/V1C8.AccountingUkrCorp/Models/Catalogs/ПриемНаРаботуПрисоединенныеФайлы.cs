...
{
    [Table("PryemNaRabotuPrysoedynennyeFaily")]
    [Description1C8(Name = "ПриемНаРаботуПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Прием на работу)")]
    public class ПриемНаРаботуПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.ПриемНаРаботу ВладелецФайла {get; set;}
        ...
        public List<ПриемНаРаботуПрисоединенныеФайлы_ЭлектронныеПодписи> ПриемНаРаботуПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<ПриемНаРаботуПрисоединенныеФайлы_СертификатыШифрования> ПриемНаРаботуПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("PryemNaRabotuPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class ПриемНаРаботуПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("PryemNaRabotuPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class ПриемНаРаботуПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
