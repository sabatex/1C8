...
{
    [Table("OtchetKomytentuOProdazhakhPrysoedynennyeFaily")]
    [Description1C8(Name = "ОтчетКомитентуОПродажахПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Отчеты комитенту о продажах)")]
    public class ОтчетКомитентуОПродажахПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.ОтчетКомитентуОПродажах ВладелецФайла {get; set;}
