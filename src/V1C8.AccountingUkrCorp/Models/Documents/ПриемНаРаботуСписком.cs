...
{
    [Table("PryemNaRabotuSpyskom")]
    [Description1C8(Name = "ПриемНаРаботуСписком", Comment = "", Synonym = "Прием на работу списком")]
    public class ПриемНаРаботуСписком:DocumentItem
    {
        #region реквізити
        ...
        public Documents.ПриемНаРаботуСписком ИсправленныйДокумент {get; set;}
        ...
        public List<ПриемНаРаботуСписком_Сотрудники> ПриемНаРаботуСпискомСотрудники {get;set;}
        [Description1C8(Name = "Начисления", Comment = "", Synonym = "Начисления")]
        public List<ПриемНаРаботуСписком_Начисления> ПриемНаРаботуСпискомНачисления {get;set;}
        [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
        public List<ПриемНаРаботуСписком_Показатели> ПриемНаРаботуСпискомПоказатели {get;set;}
        [Description1C8(Name = "ЕжегодныеОтпуска", Comment = "", Synonym = "Ежегодные отпуска")]
        public List<ПриемНаРаботуСписком_ЕжегодныеОтпуска> ПриемНаРаботуСпискомЕжегодныеОтпуска {get;set;}
        [Description1C8(Name = "Льготы", Comment = "", Synonym = "Льготы")]
        public List<ПриемНаРаботуСписком_Льготы> ПриемНаРаботуСпискомЛьготы {get;set;}
        [Description1C8(Name = "ДополнительныеРеквизиты", Comment = "", Synonym = "Дополнительные реквизиты")]
        public List<ПриемНаРаботуСписком_ДополнительныеРеквизиты> ПриемНаРаботуСпискомДополнительныеРеквизиты {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "Сотрудники", Comment = "", Synonym = "Сотрудники")]
    [Table("PryemNaRabotuSpyskom_Sotrudnyky")]
    public class ПриемНаРаботуСписком_Сотрудники
    {
    ...
    [Description1C8(Name = "Начисления", Comment = "", Synonym = "Начисления")]
    [Table("PryemNaRabotuSpyskom_Nachyslenyia")]
    public class ПриемНаРаботуСписком_Начисления
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "Показатели", Comment = "", Synonym = "Показатели")]
    [Table("PryemNaRabotuSpyskom_Pokazately")]
    public class ПриемНаРаботуСписком_Показатели
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "ЕжегодныеОтпуска", Comment = "", Synonym = "Ежегодные отпуска")]
    [Table("PryemNaRabotuSpyskom_EzhehodnyeOtpuska")]
    public class ПриемНаРаботуСписком_ЕжегодныеОтпуска
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "Льготы", Comment = "", Synonym = "Льготы")]
    [Table("PryemNaRabotuSpyskom_Lhoty")]
    public class ПриемНаРаботуСписком_Льготы
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Сотрудник", Comment = "", Synonym = "Сотрудник")]
    ...
    [Description1C8(Name = "ДополнительныеРеквизиты", Comment = "", Synonym = "Дополнительные реквизиты")]
    [Table("PryemNaRabotuSpyskom_DopolnytelnyeRekvyzyty")]
    public class ПриемНаРаботуСписком_ДополнительныеРеквизиты
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
