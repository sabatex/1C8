...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Documents
{
    ...
    public class ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком:DocumentItem
    {
        #region реквізити
        ...
        public Documents.ОтпускПоУходуЗаРебенком ДокументОснование {get; set;}
        ...
        public Documents.ИзменениеУсловийОплатыОтпускаПоУходуЗаРебенком ИсправленныйДокумент {get; set;}
