...
{
    [Table("OrhanyzatsyyPrysoedynennyeFaily")]
    [Description1C8(Name = "ОрганизацииПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Организации)")]
    public class ОрганизацииПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Catalogs.Организации ВладелецФайла {get; set;}
        ...
        #endregion реквізити
        #region tables
        [Description1C8(Name = "УдалитьЭлектронныеЦифровыеПодписи", Comment = "", Synonym = "(не используется) Электронные цифровые подписи")]
        public List<ОрганизацииПрисоединенныеФайлы_УдалитьЭлектронныеЦифровыеПодписи> ОрганизацииПрисоединенныеФайлыУдалитьЭлектронныеЦифровыеПодписи {get;set;}
        [Description1C8(Name = "УдалитьСертификатыШифрования", Comment = "", Synonym = "(не используется) Сертификаты шифрования")]
        public List<ОрганизацииПрисоединенныеФайлы_УдалитьСертификатыШифрования> ОрганизацииПрисоединенныеФайлыУдалитьСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "УдалитьЭлектронныеЦифровыеПодписи", Comment = "", Synonym = "(не используется) Электронные цифровые подписи")]
    [Table("OrhanyzatsyyPrysoedynennyeFaily_UdalytЕlektronnyeTsyfrovyePodpysy")]
    public class ОрганизацииПрисоединенныеФайлы_УдалитьЭлектронныеЦифровыеПодписи
    {
    ...
    [Description1C8(Name = "УдалитьСертификатыШифрования", Comment = "", Synonym = "(не используется) Сертификаты шифрования")]
    [Table("OrhanyzatsyyPrysoedynennyeFaily_UdalytSertyfykatyShyfrovanyia")]
    public class ОрганизацииПрисоединенныеФайлы_УдалитьСертификатыШифрования
    {
    public long Id {get;set;}
    public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
