...
{
    [Table("ProstoiSotrudnykovPrysoedynennyeFaily")]
    [Description1C8(Name = "ПростойСотрудниковПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Простой сотрудников)")]
    public class ПростойСотрудниковПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.ПростойСотрудников ВладелецФайла {get; set;}
        ...
        public List<ПростойСотрудниковПрисоединенныеФайлы_ЭлектронныеПодписи> ПростойСотрудниковПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<ПростойСотрудниковПрисоединенныеФайлы_СертификатыШифрования> ПростойСотрудниковПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("ProstoiSotrudnykovPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class ПростойСотрудниковПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("ProstoiSotrudnykovPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class ПростойСотрудниковПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
