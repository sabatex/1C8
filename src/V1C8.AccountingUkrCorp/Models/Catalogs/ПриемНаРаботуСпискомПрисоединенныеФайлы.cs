...
{
    [Table("PryemNaRabotuSpyskomPrysoedynennyeFaily")]
    [Description1C8(Name = "ПриемНаРаботуСпискомПрисоединенныеФайлы", Comment = "", Synonym = "Присоединенные файлы (Прием на работу списком)")]
    public class ПриемНаРаботуСпискомПрисоединенныеФайлы:CatalogItem
    {
        #region реквізити
        ...
        public Documents.ПриемНаРаботуСписком ВладелецФайла {get; set;}
        ...
        public List<ПриемНаРаботуСпискомПрисоединенныеФайлы_ЭлектронныеПодписи> ПриемНаРаботуСпискомПрисоединенныеФайлыЭлектронныеПодписи {get;set;}
        [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
        public List<ПриемНаРаботуСпискомПрисоединенныеФайлы_СертификатыШифрования> ПриемНаРаботуСпискомПрисоединенныеФайлыСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ЭлектронныеПодписи", Comment = "", Synonym = "Электронные подписи")]
    [Table("PryemNaRabotuSpyskomPrysoedynennyeFaily_ЕlektronnyePodpysy")]
    public class ПриемНаРаботуСпискомПрисоединенныеФайлы_ЭлектронныеПодписи
    {
    ...
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    [Table("PryemNaRabotuSpyskomPrysoedynennyeFaily_SertyfykatyShyfrovanyia")]
    public class ПриемНаРаботуСпискомПрисоединенныеФайлы_СертификатыШифрования
    {
        public long Id {get;set;}
        public Guid Owner {get;set;}
        [Description1C8(Name = "Отпечаток", Comment = "", Synonym = "Отпечаток")]
