...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public class Файлы:CatalogItem
    {
        ...
        public List<Файлы_ДополнительныеРеквизиты> ФайлыДополнительныеРеквизиты {get;set;}
        [Description1C8(Name = "УдалитьСертификатыШифрования", Comment = "", Synonym = "(не используется) Сертификаты шифрования")]
        public List<Файлы_УдалитьСертификатыШифрования> ФайлыУдалитьСертификатыШифрования {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "ДополнительныеРеквизиты", Comment = "", Synonym = "Дополнительные реквизиты")]
