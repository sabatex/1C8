...
{
    [Table("PeredachaMalotsennykhAktyvovVЕkspluatatsyiu")]
    [Description1C8(Name = "ПередачаМалоценныхАктивовВЭксплуатацию", Comment = "(Общ)", Synonym = "Передача малоценных активов в эксплуатацию")]
    public class ПередачаМалоценныхАктивовВЭксплуатацию:DocumentItem
    {
        #region реквізити
        ...
        public List<ПередачаМалоценныхАктивовВЭксплуатацию_МалоценныеАктивы> ПередачаМалоценныхАктивовВЭксплуатациюМалоценныеАктивы {get;set;}
        #endregion tables
    }
    [Description1C8(Name = "МалоценныеАктивы", Comment = "(Общ)", Synonym = "Малоценные активы")]
    [Table("PeredachaMalotsennykhAktyvovVЕkspluatatsyiu_MalotsennyeAktyvy")]
    public class ПередачаМалоценныхАктивовВЭксплуатацию_МалоценныеАктивы
    {
