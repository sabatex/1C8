...
namespace sabatex.V1C8.AccountingUkrCorp.Models.Catalogs
{
    ...
    public List<ИзменениеКвалификационногоРазрядаПрисоединенныеФайлы_ЭлектронныеПодписи> ИзменениеКвалификационногоРазрядаПрисоединенныеФайлыЭлектронныеПодписи
    [Description1C8(Name = "СертификатыШифрования", Comment = "", Synonym = "Сертификаты шифрования")]
    public List<ИзменениеКвалификационногоРазрядаПрисоединенныеФайлы_СертификатыШифрования> ИзменениеКвалификационногоРазрядаПрисоединенныеФайлыСертификатыШифрования
    #endregion tables
    }
}
